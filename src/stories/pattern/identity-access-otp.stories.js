...
export default {
    title: 'UX4G/Patterns/Identity & Access/OTP Verification',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'OTP verification patterns for secure identity confirmation in government services.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
        ...
        <div class="ux4g-identity-access-layout">
            ...
            <div
                ...
                <div class="ux4g-form-box">
                    <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Verify your mobile
                        number</h2>
                    <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl">OTP sent to +91 98765
                        XXXXX</p>
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                            ...
                            <div class="ux4g-otp-group">
                                <input class="ux4g-otp-source" type="hidden" id="otpVar1S1Value" value=""
                                    >
                            </div>
                            <div class="ux4g-otp-meta ux4g-body-s-default" id="otpVar1S1Meta">
                        ...
                        <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-mt-xl">
                            <button class="ux4g-btn-primary ux4g-btn-lg ux4g-w-100 ux4g-mb-m" type="submit">Verify
                                OTP</button>
                            <div class="ux4g-text-center">
                                <a href="#" class="ux4g-text-link ux4g-label-l-medium">Change mobile number</a>
                            </div>
                        </div>
                    </form>
                ...
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                            role="group">
                            <div class="ux4g-otp-group">
                                <input class="ux4g-otp-source" type="hidden" id="otpVar1S2Value" value=""
                                    >
                            </div>
                            <div class="ux4g-otp-meta ux4g-body-s-default" id="otpVar1S2Meta">
                                <span class="ux4g-otp-helper" data-ux-otp-helper>Didn't receive OTP?</span>
                                <a href="#" class="ux4g-text-link ux4g-body-s-medium">Resend OTP</a>
                            </div>
                        </div>

                        <!-- Actions -->
                        <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-mt-xl">
                            <button class="ux4g-btn-primary ux4g-btn-lg ux4g-w-100 ux4g-mb-s" type="submit">Verify
                                OTP</button>
                            <button
                                class="ux4g-btn-outline-primary ux4g-btn-lg ux4g-w-100 ux4g-d-flex ux4g-ai-center ux4g-jc-center"
                                type="button">
                                <span class="ux4g-icon-outlined ux4g-mr-xs">phone</span> Get OTP via voice call
                            </button>
                        </div>
                    </form>
            ...
            <div
                ...
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-error" data-ux-otp data-ux-state="error" data-ux-count="6"
                            role="group">
                            <div class="ux4g-otp-group">
                                <input class="ux4g-otp-source" type="hidden" id="otpVar1S3Value" value="12345"
                                    >
                            </div>
                        </div>
                ...
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-error" data-ux-otp data-ux-state="error" data-ux-count="6"
                            role="group">
                            <div class="ux4g-otp-group">
                                <input class="ux4g-otp-source" type="hidden" id="otpVar1S4Value" value="54321"
                                    >
                            </div>
                        </div>
                        ...
                        <div class="ux4g-alert ux4g-alert-warning ux4g-form-alert ux4g-mb-m">
                            ...
                            <div class="ux4g-form-alert-body">
                                <span class="ux4g-alert-message ux4g-body-s-strong">Incorrect OTP</span>
                                <div class="ux4g-form-alert-footer">
                                    <span class="ux4g-body-s-default ux4g-text-warning">This is your last attempt
                                        before a 30-min lockout</span>
                                    <span class="ux4g-alert-counter ux4g-text-warning ux4g-label-m-default">Attempt
                                        2 of 3</span>
                                </div>
                            </div>
            ...
            <div
                ...
                <div class="ux4g-form-box">
                    ...
                    <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-jc-center">
                        ...
                        <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-2xl">
                            Too many incorrect attempts</h2>

                        <!-- OTP Input Block Component (6 slots, disabled state) -->
                        <div class="ux4g-otp ux4g-otp-locked ux4g-w-100" data-ux-otp data-ux-state="locked-out"
                            data-ux-count="6" role="group">
                            <div class="ux4g-otp-group" aria-disabled="true">
                                <input class="ux4g-otp-source" type="hidden" id="otpVar1S5Value" value=""
                                     disabled>
                            </div>
                            <div
                                class="ux4g-otp-meta ux4g-body-s-default ux4g-d-flex ux4g-jc-between ux4g-w-100 ux4g-mt-xs">
                                <span class="ux4g-otp-status ux4g-d-flex ux4g-ai-center ux4g-gap-2xs ux4g-text-error"
                                    data-ux-otp-status>
                                    <span class="ux4g-icon-outlined ux4g-fs-16" aria-hidden="true">lock</span>
                                    <span data-ux-otp-timer data-ux-otp-prefix="Locked for "
                                        data-ux-otp-seconds="1723">Locked for 28:43</span>
                                </span>
                                <span class="ux4g-otp-resend ux4g-otp-resend-disabled" data-ux-otp-timer
                                    data-ux-otp-prefix="Resend OTP " data-ux-otp-seconds="0">Resend OTP</span>
                            </div>
                        </div>

                        <!-- Error Alert Block -->
                        <div class="ux4g-alert ux4g-alert-error ux4g-form-alert ux4g-mb-m ux4g-w-100 ux4g-mt-xl">
                            <i class="ux4g-icon-outlined ux4g-alert-icon">error</i>
                            <div class="ux4g-form-alert-body">
                                <span class="ux4g-alert-message ux4g-body-s-default">Account locked. Please wait for
                                    the countdown to complete</span>
                            </div>
                        </div>

                        <!-- Help Link -->
                        <div class="ux4g-text-center ux4g-mt-xl">
                            <span class="ux4g-body-s-default ux4g-text-neutral-secondary">Need help? </span>
                            <a href="tel:1800XXXXXX" class="ux4g-text-link ux4g-label-s-strong">Call
                                1800-XXX-XXXX</a>
                        </div>
                    </div>
...
const COLUMN_6_HTML = `    <section class="ux4g-identity-access-container">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
                    <!-- Logo & Brand -->
            ...
            <div
                ...
                <div class="ux4g-form-box">
                    <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-jc-center">
                        ...
                        <div class="ux4g-success-badge-outer ux4g-mb-xl">
                            <div class="ux4g-success-badge-inner">
                                <span class="ux4g-icon-outlined ux4g-text-white">done</span>
                            </div>
                        </div>
                        ...
                        <div class="ux4g-otp ux4g-otp-success ux4g-ai-center ux4g-jc-between" data-ux-otp
                            data-ux-state="success" data-ux-count="6" role="group">
                            <div class="ux4g-otp-group">
                                <input class="ux4g-otp-source" type="hidden" id="otpVar1S6Value" value="555555"
                                    >
                            </div>
                            <div class="ux4g-otp-meta ux4g-body-s-default ux4g-w-100 ux4g-mt-xs ux4g-d-flex">
                ...
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                            role="group">
                            <div class="ux4g-otp-group">
                                <input class="ux4g-otp-source" type="hidden" id="otpVar2S1Value" value=""
                                    >
                            </div>
                            <div class="ux4g-otp-meta ux4g-body-s-default" id="otpVar2S1Meta">
                                <span class="ux4g-otp-helper" data-ux-otp-helper>Didn't receive OTP?</span>
                                <span class="ux4g-otp-resend ux4g-otp-resend-disabled" data-ux-otp-timer
                                    data-ux-otp-prefix="Resend in " data-ux-otp-seconds="17">Resend in 00:17</span>
                            </div>
                ...
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                            role="group">
                            <div class="ux4g-otp-group">
                                <input class="ux4g-otp-source" type="hidden" id="otpVar2S2Value" value=""
                                    >
                            </div>
                            <div class="ux4g-otp-meta ux4g-body-s-default" id="otpVar2S2Meta">
                                <span class="ux4g-otp-helper" data-ux-otp-helper>Didn't receive OTP?</span>
                                <a href="#" class="ux4g-text-link ux4g-body-s-medium">Resend OTP</a>
                            </div>
                        </div>
                ...
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-error" data-ux-otp data-ux-state="error" data-ux-count="6"
                            role="group">
                            <div class="ux4g-otp-group">
                                <input class="ux4g-otp-source" type="hidden" id="otpVar2S3Value" value="12345"
                                    >
                            </div>
                        </div>
                ...
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-error" data-ux-otp data-ux-state="error" data-ux-count="6"
                            role="group">
                            <div class="ux4g-otp-group">
                                <input class="ux4g-otp-source" type="hidden" id="otpVar2S4Value" value="54321"
                                    >
                            </div>
                        </div>
            ...
            <div class="ux4g-identity-access-full ux4g-bg-neutral">
                <div class="ux4g-form-box">
                    ...
                    <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-jc-center">
                        ...
                        <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-2xl ux4g-text-center">
                            Too many incorrect attempts</h2>

                        <!-- OTP Input Block Component (6 slots, disabled state) -->
                        <div class="ux4g-otp ux4g-otp-locked" data-ux-otp data-ux-state="locked-out" data-ux-count="6"
                            role="group">
                            <div class="ux4g-otp-group" aria-disabled="true">
                                <input class="ux4g-otp-source" type="hidden" id="otpVar2S5Value" value=""
                                     disabled>
                            </div>
                            <div
                                class="ux4g-otp-meta ux4g-body-s-default ux4g-d-flex ux4g-jc-between ux4g-w-100 ux4g-mt-xs">
...
const FULL_6_HTML = `    <section class="ux4g-identity-access-container">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
                    <!-- Logo & Brand -->
                ...
                <div class="ux4g-form-box">
                    <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-jc-center">
                        ...
                        <div class="ux4g-otp ux4g-otp-success ux4g-ai-center ux4g-jc-between" data-ux-otp
                            data-ux-state="success" data-ux-count="6" role="group">
                            <div class="ux4g-otp-group">
                                <input class="ux4g-otp-source" type="hidden" id="otpVar2S6Value" value="555555"
                                    >
                            </div>
                            <div class="ux4g-otp-meta ux4g-body-s-default ux4g-w-100 ux4g-mt-xs ux4g-d-flex">
                                <span class="ux4g-otp-status" data-ux-otp-status>
...
const CARD_6_HTML = `    <section class="ux4g-identity-access-container">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            ...
            <div class="ux4g-form-box">
                <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Verify your mobile number
                </h2>
                <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl">OTP sent to +91 98765 XXXXX
                </p>
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    ...
                    <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                        role="group">
                        <div class="ux4g-otp-group">
                            <input class="ux4g-otp-source" type="hidden" id="otpVar3S1Value" value="" >
                        </div>
                        <div class="ux4g-otp-meta ux4g-body-s-default" id="otpVar3S1Meta">
                            <span class="ux4g-otp-helper" data-ux-otp-helper>Didn't receive OTP?</span>
                            <span class="ux4g-otp-resend ux4g-otp-resend-disabled" data-ux-otp-timer
                                data-ux-otp-prefix="Resend in " data-ux-otp-seconds="17">Resend in 00:17</span>
                        </div>
            ...
            <div class="ux4g-form-box">
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    ...
                    <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                        role="group">
                        <div class="ux4g-otp-group">
                            <input class="ux4g-otp-source" type="hidden" id="otpVar3S2Value" value="" >
                        </div>
                        <div class="ux4g-otp-meta ux4g-body-s-default" id="otpVar3S2Meta">
                            <span class="ux4g-otp-helper" data-ux-otp-helper>Didn't receive OTP?</span>
                            <a href="#" class="ux4g-text-link ux4g-body-s-medium">Resend OTP</a>
                        </div>
                    </div>
            ...
            <div class="ux4g-form-box">
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    ...
                    <div class="ux4g-otp ux4g-otp-error" data-ux-otp data-ux-state="error" data-ux-count="6"
                        role="group">
                        <div class="ux4g-otp-group">
                            <input class="ux4g-otp-source" type="hidden" id="otpVar3S3Value" value="12345"
                                >
                        </div>
                    </div>
                    ...
                    <div class="ux4g-alert ux4g-alert-warning ux4g-form-alert ux4g-mb-m">
                        ...
                        <div class="ux4g-form-alert-body">
                            <span class="ux4g-alert-message ux4g-body-s-strong">Incorrect OTP</span>
                            <div class="ux4g-form-alert-footer">
                                <span class="ux4g-body-s-default ux4g-text-warning">1 more incorrect entry before
                                    30-min lockout</span>
            ...
            <div class="ux4g-form-box">
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    ...
                    <div class="ux4g-otp ux4g-otp-error" data-ux-otp data-ux-state="error" data-ux-count="6"
                        role="group">
                        <div class="ux4g-otp-group">
                            <input class="ux4g-otp-source" type="hidden" id="otpVar3S4Value" value="54321"
                                >
                        </div>
                    </div>
                    ...
                    <div class="ux4g-alert ux4g-alert-warning ux4g-form-alert ux4g-mb-m">
                        ...
                        <div class="ux4g-form-alert-body">
                            <span class="ux4g-alert-message ux4g-body-s-strong">Incorrect OTP</span>
                            <div class="ux4g-form-alert-footer">
                                <span class="ux4g-body-s-default ux4g-text-warning">This is your last attempt before
                                    a 30-min lockout</span>
                                <span class="ux4g-alert-counter ux4g-text-warning ux4g-label-m-default">Attempt 2 of
                                    3</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            ...
            <div class="ux4g-form-box">
                ...
                <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-jc-center">
                    ...
                    <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-2xl ux4g-text-center">Too
                        many incorrect attempts</h2>

                    <!-- OTP Input Block Component (6 slots, disabled state) -->
                    <div class="ux4g-otp ux4g-otp-locked ux4g-w-100" data-ux-otp data-ux-state="locked-out"
                        data-ux-count="6" role="group">
                        <div class="ux4g-otp-group" aria-disabled="true">
                            <input class="ux4g-otp-source" type="hidden" id="otpVar3S5Value" value="" 
                                disabled>
                        </div>
                        <div
                            class="ux4g-otp-meta ux4g-body-s-default ux4g-d-flex ux4g-jc-between ux4g-w-100 ux4g-mt-xs">
                    ...
                    <div class="ux4g-alert ux4g-alert-error ux4g-form-alert ux4g-mb-m ux4g-w-100 ux4g-mt-xl">
                        <i class="ux4g-icon-outlined ux4g-alert-icon">error</i>
                        <div class="ux4g-form-alert-body">
                            <span class="ux4g-alert-message ux4g-body-s-default">Account locked. Please wait for the
                                countdown to complete</span>
                        </div>
                    </div>
                    ...
                    <div class="ux4g-text-center ux4g-mt-xl">
                        <span class="ux4g-body-s-default ux4g-text-neutral-secondary">Need help? </span>
                        <a href="tel:1800XXXXXX" class="ux4g-text-link ux4g-label-s-strong">Call 1800-XXX-XXXX</a>
                    </div>
                </div>
...
const CARD_11_HTML = `    <section class="ux4g-identity-access-container">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
                    <!-- Logo & Brand -->
            ...
            <div class="ux4g-form-box">
                <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-jc-center">
                    ...
                    <div class="ux4g-otp ux4g-otp-success ux4g-ai-center ux4g-jc-between" data-ux-otp
                        data-ux-state="success" data-ux-count="6" role="group">
                        <div class="ux4g-otp-group">
                            <input class="ux4g-otp-source" type="hidden" id="otpVar3S6Value" value="555555"
                                >
                        </div>
                        <div class="ux4g-otp-meta ux4g-body-s-default ux4g-w-100 ux4g-mt-xs ux4g-d-flex">
                            <span class="ux4g-otp-status" data-ux-otp-status>
...
export const Column = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('OTP Verification - Column', 'Column layout variants for otp verification patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('otp-col-1', 'OTP Entry - Active Timer', '', COLUMN_1_HTML)}
                ${renderDemoCodeBlock('otp-col-2', 'OTP Expired - Resend Available', '', COLUMN_2_HTML)}
                ${renderDemoCodeBlock('otp-col-3', 'Error - Incorrect OTP (Attempt 1)', '', COLUMN_3_HTML)}
                ${renderDemoCodeBlock('otp-col-4', 'Error - Incorrect OTP (Last Attempt)', '', COLUMN_4_HTML)}
                ${renderDemoCodeBlock('otp-col-5', 'Locked - Too Many Attempts', '', COLUMN_5_HTML)}
                ${renderDemoCodeBlock('otp-col-6', 'Success - Verified', '', COLUMN_6_HTML)}
            </div>
        </div>
    `,
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('OTP Verification - Full Screen', 'Full screen layout variants for otp verification patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('otp-full-1', 'OTP Entry - Active Timer', '', FULL_1_HTML)}
                ${renderDemoCodeBlock('otp-full-2', 'OTP Expired - Resend Available', '', FULL_2_HTML)}
                ${renderDemoCodeBlock('otp-full-3', 'Error - Incorrect OTP (Attempt 1)', '', FULL_3_HTML)}
                ${renderDemoCodeBlock('otp-full-4', 'Error - Incorrect OTP (Last Attempt)', '', FULL_4_HTML)}
                ${renderDemoCodeBlock('otp-full-5', 'Locked - Too Many Attempts', '', FULL_5_HTML)}
                ${renderDemoCodeBlock('otp-full-6', 'Success - Verified', '', FULL_6_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
...
export const Card = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('OTP Verification - Card', 'Card layout variants for otp verification patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('otp-card-1', 'Reset Password - Mobile Number', '', CARD_1_HTML)}
                ${renderDemoCodeBlock('otp-card-2', 'Reset Password - OTP Entry', '', CARD_2_HTML)}
                ${renderDemoCodeBlock('otp-card-3', 'Reset Password - Create New Password', '', CARD_3_HTML)}
                ${renderDemoCodeBlock('otp-card-4', 'Success - Password Reset', '', CARD_4_HTML)}
                ${renderDemoCodeBlock('otp-card-5', 'Account Recovery - Email', '', CARD_5_HTML)}
                ${renderDemoCodeBlock('otp-card-6', 'OTP Entry - Active Timer', '', CARD_6_HTML)}
                ${renderDemoCodeBlock('otp-card-7', 'OTP Expired - Resend Available', '', CARD_7_HTML)}
                ${renderDemoCodeBlock('otp-card-8', 'Error - Incorrect OTP (Attempt 1)', '', CARD_8_HTML)}
                ${renderDemoCodeBlock('otp-card-9', 'Error - Incorrect OTP (Last Attempt)', '', CARD_9_HTML)}
                ${renderDemoCodeBlock('otp-card-10', 'Locked - Too Many Attempts', '', CARD_10_HTML)}
                ${renderDemoCodeBlock('otp-card-11', 'Success - Verified', '', CARD_11_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
