/**
 * Search No Results — Empty state for search with no matching results, offering suggestions and alternative paths.
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Search & Discovery/Search No Results',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Empty state for search with no matching results, offering suggestions and alternative paths.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
const FULLSCREEN_1_HTML = `    <section>
        ...
        <div class="ux4g-search-hero-container ux4g-bg-neutral ux4g-pt-xl ">
            <div class="ux4g-container">
                <div class="ux4g-sb-search-browse-75 ux4g-m-auto ux4g-text-center ux4g-mt-2xl">
            ...
            <div class="ux4g-py-2xl ux4g-sb-search-discovery-main-4">
                <div class="ux4g-empty-state">
                        <span class="ux4g-icon-outlined ux4g-empty-state-icon ux4g-text-primary" data-ux4g-init="true">search</span>
                        <div class="ux4g-empty-state-content">
                            ...
                            <div>
                                <a href="" class="ux4g-text-link-md">Income Certificate,</a> <a href="" class="ux4g-text-link-md">Income & Asset Certificate</a>
                            </div>
                        </div>
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Search No Results - Full Screen', 'Full Screen layout variant for search and discovery patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('search-no-results', 'Search No Results - Full Page', '', FULLSCREEN_1_HTML)}
            </div>
        </div>
    `,
...
export const Column = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Search No Results - Full Screen', 'Full Screen layout variant for search and discovery patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('search-no-results-column', 'Search No Results - Full Page', '', COLUMN_1_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
...
export const DesktopWorkspace = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Search No Results - Full Screen', 'Full Screen layout variant for search and discovery patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('search-no-results-desktopworkspace', 'Search No Results - Full Page', '', DESKTOPWORKSPACE_1_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
