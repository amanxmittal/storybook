...
export default {
    title: 'UX4G/Patterns/Feedback & Communication/FAQ Article',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'FAQ article page with breadcrumb navigation and accordion-style answers.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'FaqArticle');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('FAQ Article', 'FAQ article page with breadcrumb navigation and accordion-style answers.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            <span class="ux4g-icon-outlined ux4g-fs-24 ux4g-text-primary">quiz</span>
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">FAQ Article</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">FAQ article page with breadcrumb navigation and accordion-style answers.</p>
                    </div>
                </div>
            </div>
        </div>
...
export const FaqArticle = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('FAQ Article', 'FAQ article page with breadcrumb navigation and accordion-style answers.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('faq-article', 'FAQ Article', 'FAQ article page with breadcrumb navigation and accordion-style questions.', `<section>
    ...
    <section class="ux4g-feedback-completion-section">
        <div class="ux4g-container ux4g-d-flex ux4g-flex-column ux4g-ai-center">
            <div class="ux4g-feedback-completion-card">
                <div class="ux4g-feedback-header-wrapper ux4g-stack-gap-l">
                    <nav aria-label="Breadcrumb" class="ux4g-breadcrumb ux4g-breadcrumb-divider">
                        <ul class="ux4g-breadcrumb-list ux4g-d-flex">
                            <li class="ux4g-breadcrumb-item">
                                <a href="../../contact-n-support-1.html" class="ux4g-breadcrumb-link">
                                    <span class="ux4g-icon-outlined ux4g-fs-16 ux4g-mr-3xs">home</span>
                                    Home
                                </a>
                            </li>
                            <li class="ux4g-breadcrumb-item">
                                <a href="../../contact-n-support-1.html" class="ux4g-breadcrumb-link">Help</a>
                            </li>
                            <li class="ux4g-breadcrumb-item active" aria-current="page">Application Issues</li>
                        </ul>
                    </nav>
                    <h1 class="ux4g-heading-m-default">How do I track my application?</h1>
                    <p class="ux4g-body-s-default ux4g-text-neutral-secondary ux4g-feedback-subtitle">
                        Sign in to the portal, open My Applications, and tap your active application. The Status Tracker
                        shows every milestone — Submitted, Documents Verified, Under Review, Decision. SLA timer shows
                        ...
                        <h3 class="ux4g-accordion__header">
                            <button aria-controls="simpleRightOne" aria-expanded="false"
                                ...
                                <span class="ux4g-accordion__button-content">
                                    <span class="ux4g-accordion__title">My application was rejected — what next?</span>
                                </span>
                            </button>
                        </h3>
                    ...
                    <div class="ux4g-accordion__item">
                        <h3 class="ux4g-accordion__header">
                            <button aria-controls="simpleRightTwo" aria-expanded="false"
                                ...
                                ux4g-toggle="collapse">
                                <span class="ux4g-accordion__button-content">
                                    <span class="ux4g-accordion__title">How do I upload missing documents?</span>
                                </span>
                            </button>
                        </h3>
                    ...
                    <div class="ux4g-accordion__item">
                        <h3 class="ux4g-accordion__header">
                            <button aria-controls="simpleRightThree" aria-expanded="false"
                                ...
                                ux4g-toggle="collapse">
                                <span class="ux4g-accordion__button-content">
                                    <span class="ux4g-accordion__title">When will I receive my certificate?</span>
                                </span>
                            </button>
                        </h3>
                    ...
                    <div class="ux4g-accordion__item">
                        <h3 class="ux4g-accordion__header">
                            <button aria-controls="simpleRightFour" aria-expanded="false"
                                ...
                                ux4g-toggle="collapse">
                                <span class="ux4g-accordion__button-content">
                                    <span class="ux4g-accordion__title">How do I contact a Revenue officer?</span>
                                </span>
                            </button>
                        </h3>
