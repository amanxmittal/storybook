...
export default {
    title: 'UX4G/Patterns/Consent & Declaration/Declaration',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Declaration patterns for government service submission, including scroll-to-accept declaration boxes, attestation checkboxes, and full-screen and card-style layouts.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
const getReactCodeLocal = (html) => htmlToJsx(html, 'Declaration');
...
const FULLSCREEN_1_HTML = `<section class="ux4g-consent-capture-container ux4g-mb-xl">
    ...
    <div class="ux4g-consent-capture ux4g-consent-capture-full">
        <div class="ux4g-consent-capture-wrapper">
            <div class="ux4g-consent-header ux4g-consent-header-left">
                <h2 class="ux4g-heading-m-default">Declaration</h2>
                <p class="ux4g-body-s-default ux4g-text-neutral-primary">Please read the declaration below in full.
                    You must scroll to the end before you can agree and submit.</p>
            </div>

            <div class="ux4g-declaration-scroll-box ux4g-mb-l">
                <div class="ux4g-declaration-content ux4g-body-s-default ux4g-text-neutral-primary">
                    <p class="ux4g-mb-m">I, the applicant, do hereby solemnly declare and affirm that:</p>
                    <ol class="ux4g-consent-list">
                        <li>All the information and particulars furnished in this application are true, complete and
                            correct to the best of my knowledge and belief.</li>
                        <li>I have not concealed, suppressed or misrepresented any material fact relevant to this
                            application.</li>
                        <li>All documents uploaded in support of this application are genuine, valid and have not
                            been altered, tampered with or forged in any manner.</li>
                        <li>I understand that the Income Certificate applied for shall be used only for lawful
                            purposes as stated in this application.</li>
                        <li>I authorise the Revenue Department and its officers to verify the particulars furnished
                            herein from any source or record they deem necessary.</li>
                        <li>I am fully aware that furnishing false information or suppressing material facts is a
                            punishable offence under the law.</li>
                        <li>In the event any information furnished is later found to be false or incorrect, I
                            understand that the certificate issued is liable to be cancelled and appropriate legal
                            action may be initiated against me.</li>
                    </ol>
                    <p class="ux4g-mt-m">I make this declaration believing the contents to be true and correct.</p>
                </div>

                <div class="ux4g-declaration-scroll-hint" id="scrollHint1">
                    <span class="ux4g-tag-tonal-primary ux4g-radius-full ">
            ...
            <div class="ux4g-d-flex ux4g-flex-column ux4g-gap-xs">
                <label class="ux4g-checkbox ux4g-checkbox-md">
                    <input id="declarationCheckbox1" class="ux4g-checkbox-input" type="checkbox" />
                    ...
                    <div class="ux4g-checkbox-content">
                        <div class="ux4g-checkbox-header">
                            <span class="ux4g-checkbox-label">I have read and agree to the above declaration. <sup
                                    class="ux4g-text-error-default">*</sup></span>
                        </div>
                    </div>
                </label>

                <div class="ux4g-input-container ux4g-input-md ux4g-input-default ux4g-d-none" id="nameInputGroup1">
                    <label class="ux4g-label-m-default" for="applicantName1">Enter your full name to attest this
                        declaration. <sup class="ux4g-text-error-default">*</sup></label>
                    <div class="ux4g-input">
                        <input class="ux4g-input-input" id="applicantName1" placeholder="Enter your full name"
                            type="text" />
                    ...
                    <div class="ux4g-input-helper">
                        ...
                        <span class="ux4g-input-helper-text">Your name will be matched against your aadhaar
                            records.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="ux4g-alert ux4g-alert-warning ux4g-form-alert ux4g-mt-l ux4g-mb-l">
                ...
                <div class="ux4g-form-alert-body">
                    <span class="ux4g-alert-message ux4g-body-s-default">Furnishing false information is a
                        punishable offence under Section 193 of the IPC &mdash; up to 7 years imprisonment.</span>
                </div>
            </div>

            <hr class="ux4g-divider-horizontal ux4g-mb-l" />

            <div class="ux4g-consent-decl-btn-wrap">
                <button id="submitBtn1" class="ux4g-btn-primary" type="button" disabled>Submit application</button>
            </div>
        </div>
...
export const FULLSCREEN_1 = {
    name: 'Declaration Before Submission - Full Screen',
    render: () => renderDemoCodeBlock('declaration-full-screen', 'Declaration Before Submission - Full Screen', 'Declaration with scroll-to-accept box and attestation checkbox.', FULLSCREEN_1_HTML, false, 'ux4g-grid-cols-1'),
    parameters: { docs: { disable: true } },
};

const CARD_1_HTML = `<section class="ux4g-consent-capture-container ux4g-mb-xl">
    <nav class="ux4g-navbar">
        <div class="ux4g-container">
            <div class="ux4g-navbar-wrap">
                <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-s">
    ...
    <div class="ux4g-consent-capture ux4g-consent-capture-card">
        <div class="ux4g-consent-capture-wrapper">
            ...
            <div class="ux4g-declaration-scroll-box ux4g-mb-l">
                ...
                <div class="ux4g-declaration-scroll-hint" id="scrollHint2">
                    <span class="ux4g-tag-tonal-primary ux4g-radius-full ">
                        Scroll to read the full declaration
                    </span>
                </div>
            ...
            <div class="ux4g-d-flex ux4g-flex-column ux4g-gap-xs">
                <label class="ux4g-checkbox ux4g-checkbox-md">
                    <input id="declarationCheckbox2" class="ux4g-checkbox-input" type="checkbox" />
                    <div class="ux4g-checkbox-control">
                        <span class="ux4g-checkmark"></span>
                    </div>
                    <div class="ux4g-checkbox-content">
                ...
                <div class="ux4g-input-container ux4g-input-md ux4g-input-default ux4g-d-none" id="nameInputGroup2">
                    <label class="ux4g-label-m-default" for="applicantName2">Enter your full name to attest this
                        declaration. <sup class="ux4g-text-error-default">*</sup></label>
                    <div class="ux4g-input">
                        <input class="ux4g-input-input" id="applicantName2" placeholder="Enter your full name"
                            type="text" />
                        <div class="ux4g-input-actions">
                            <button aria-label="Clear input" class="ux4g-input-action-btn" type="button">
                                <span class="ux4g-icon-outlined">close</span>
            ...
            <div class="ux4g-consent-decl-btn-wrap">
                <button id="submitBtn2" class="ux4g-btn-primary" type="button" disabled>Submit application</button>
            </div>
        </div>
        <div class="ux4g-consent-footer">
            <span class="ux4g-label-m-default">Powered by -</span>
...
export const CARD_1 = {
    name: 'Declaration Before Submission - Card',
    render: () => renderDemoCodeBlock('declaration-card', 'Declaration Before Submission - Card', 'Card-style declaration with scroll-to-accept layout.', CARD_1_HTML, false, 'ux4g-grid-cols-1'),
    parameters: { docs: { disable: true } },
};
