...
export default {
    title: 'UX4G/Patterns/Feedback & Communication/Language Context',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Contextual language suggestion alert informing users of available regional language content.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'LanguageContext');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Language Context', 'Contextual language suggestion alert informing users of available regional language content.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            <span class="ux4g-icon-outlined ux4g-fs-24 ux4g-text-primary">translate</span>
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">Language Context</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Contextual banner suggesting available regional language content to users.</p>
                    </div>
                </div>
            </div>
        </div>
...
export const LanguageContext = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Language Context', 'Contextual language suggestion alert informing users of available regional language content.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('language-context', 'Language Context', 'Contextual banner suggesting available regional language content to users.', `<section>
        ...
        <div class="ux4g-container ux4g-d-flex ux4g-flex-column ux4g-ai-center">
            <div class="ux4g-feedback-completion-card">
                <div class="ux4g-language-header ux4g-stack-gap-xs">
                    <h1 class="ux4g-heading-l-default ux4g-mb-none">Apply for Income Certificate</h1>
                    <p class="ux4g-body-s-default ux4g-text-neutral-secondary">
                        Switch the inline toggle to change form labels &mdash; your entered data is preserved.
                    </p>
                </div>
                <div class="ux4g-d-flex ux4g-inline-gap-s">
                    <button type="button" class="ux4g-btn-primary ux4g-btn-sm">English</button>
                    <button type="button" class="ux4g-btn-outline-neutral ux4g-btn-sm">\u0939\u093f\u0928\u094d\u0926\u0940</button>
                    <button type="button" class="ux4g-btn-outline-neutral ux4g-btn-sm">\u0ba4\u0bae\u0bbf\u0bb4\u0bcd</button>
                    <button type="button" class="ux4g-btn-outline-neutral ux4g-btn-sm">\u0c24\u0c46\u0c32\u0c41\u0c17\u0c41</button>
                </div>
            </div>
