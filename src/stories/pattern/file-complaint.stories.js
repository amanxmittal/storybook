/**
 * File Complaint Pattern
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Feedback & Communication/File Complaint',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'File a complaint form with category selection, description, and optional file upload.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'FileComplaint');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('File Complaint', 'File a complaint form with category selection, description, and optional file upload.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            ...
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">File Complaint</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Complaint filing form with service selection, description, and document attachment.</p>
                    </div>
                </div>
            </div>
        </div>
...
export const FileComplaint = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('File Complaint', 'File a complaint form with category selection, description, and optional file upload.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('file-complaint', 'File Complaint', 'Complaint filing form with service selection, description, and document attachment.', `<section>
    ...
    <section class="ux4g-feedback-completion-section">
        <div class="ux4g-container ux4g-d-flex ux4g-flex-column ux4g-ai-center">
            <div class="ux4g-feedback-completion-card ux4g-chat-support-card">

                <!-- Header -->
                <div class="ux4g-feedback-header-wrapper ux4g-stack-gap-xs">
                    <h1 class="ux4g-heading-l-default ux4g-feedback-title ux4g-mb-none">File a complaint</h1>
                ...
                <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m">
                    ...
                    <div class="ux4g-form-group">
                        <label class="ux4g-label-m-default ux4g-d-block ux4g-mb-2xs" for="subject-field">Subject</label>
                        <div class="ux4g-input-container ux4g-input-md">
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="subject-field"
                                    placeholder="Briefly describe the issue" type="text" />
                            </div>
                        </div>
                    </div>

                    <!-- Category field -->
                    <div class="ux4g-form-group ux4g-w-100 ux4g-custom-list-dropdown">
                        <label class="ux4g-label-m-default ux4g-d-block ux4g-mb-2xs">Category</label>

                        <!-- Trigger Button -->
                        <button class="ux4g-custom-dropdown-btn ux4g-w-100" type="button" aria-haspopup="listbox">
                            <span>Select Category</span>
                            <span class="ux4g-icon-outlined">expand_more</span>
                        </button>
                        <!-- Custom List Menu -->
                        <ul class="ux4g-custom-dropdown-menu" role="listbox">
                            <li class="ux4g-custom-dropdown-item" role="option" data-value="technical">
                                <span class="ux4g-custom-dropdown-text">Technical Issue</span>
                                <span aria-hidden="true" class="ux4g-icon-outlined ux4g-dropdown-single-check">check</span>
                            </li>
                            <li class="ux4g-custom-dropdown-item" role="option" data-value="payment">
                                <span class="ux4g-custom-dropdown-text">Payment Problem</span>
                                <span aria-hidden="true" class="ux4g-icon-outlined ux4g-dropdown-single-check">check</span>
                            </li>
                            <li class="ux4g-custom-dropdown-item" role="option" data-value="service">
                                <span class="ux4g-custom-dropdown-text">Service Delay</span>
                                <span aria-hidden="true" class="ux4g-icon-outlined ux4g-dropdown-single-check">check</span>
                            </li>
                            <li class="ux4g-custom-dropdown-item" role="option" data-value="other">
                                <span class="ux4g-custom-dropdown-text">Other</span>
                                <span aria-hidden="true" class="ux4g-icon-outlined ux4g-dropdown-single-check">check</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <!-- Description field -->
                    <div class="ux4g-form-group">
                        <label class="ux4g-label-m-default ux4g-d-block ux4g-mb-2xs"
                            for="description-field">Description</label>
                        <div class="ux4g-textarea-container">
                            <div class="ux4g-textarea">
                                <textarea class="ux4g-textarea-input" id="description-field"
                                    placeholder="Tell us what happened, when, and what you expected..."
                                    rows="3"></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Action Buttons -->
                <div class="ux4g-form-action-footer ux4g-d-flex ux4g-flex-column ux4g-stack-gap-xs ux4g-mt-m">
                    <button class="ux4g-btn ux4g-btn-primary ux4g-btn-md" type="button">Submit complaint</button>
                    <button class="ux4g-btn ux4g-btn-outline-primary ux4g-btn-md" type="button">Cancel</button>
                </div>
            </div>
