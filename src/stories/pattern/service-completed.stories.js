/**
 * Service Completed Pattern
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Feedback & Communication/Service Completed',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Service completion confirmation with appointment summary and feedback prompt.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'ServiceCompleted');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Service Completed', 'Service completion confirmation with appointment summary and feedback prompt.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            <span class="ux4g-icon-outlined ux4g-fs-24 ux4g-text-primary">check_circle</span>
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">Service Completed</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Service completion confirmation screen with summary details and feedback prompt.</p>
                    </div>
                </div>
            </div>
        </div>
...
export const ServiceCompleted = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Service Completed', 'Service completion confirmation with appointment summary and feedback prompt.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('service-completed', 'Service Completed', 'Service completion confirmation screen with summary details and feedback prompt.', `<section>
        ...
        <div class="ux4g-container ux4g-d-flex ux4g-flex-column ux4g-ai-center">
            <div class="ux4g-feedback-completion-card">
                ...
                <div class="ux4g-feedback-back-wrapper">
                    <a href="../../feedback-communication-6.html" class="ux4g-text-link-sm ux4g-feedback-back-link">
                ...
                <div class="ux4g-feedback-header-wrapper">
                    <h2 class="ux4g-heading-s-strong ux4g-feedback-title">Service Completed</h2>
                ...
                <div class="ux4g-alert ux4g-alert-success ux4g-radius-s ux4g-border ux4g-border-success ux4g-feedback-alert">
                    ...
                    <div class="ux4g-alert-content ux4g-d-flex ux4g-flex-column ux4g-stack-gap-3xs">
                        <span class="ux4g-alert-title ux4g-text-success ux4g-body-m-strong">Income Certificate Downloaded.</span>
                        <span class="ux4g-alert-message ux4g-text-success ux4g-body-s-default">Your certificate has been saved to your device.</span>
                        <a href="#" class="ux4g-text-success ux4g-body-s-strong">View</a>
                    </div>
                </div>

                <!-- Gray Document Info Badge -->
                <div class="ux4g-feedback-doc-box">
                    <span class="ux4g-feedback-doc-name">income_certificate_2026.pdf</span>
                    <span class="ux4g-feedback-doc-meta">28 KB &middot; PDF</span>
                </div>

                <!-- Action Buttons -->
                <div class="ux4g-feedback-completion-btn-row">
                    <button class="ux4g-btn-outline-primary ux4g-btn-lg">Save to DigiLocker</button>
                    <button class="ux4g-btn-primary ux4g-btn-lg">Download Again</button>
                </div>
            </div>
