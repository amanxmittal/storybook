/**
 * ConsentHistory Pattern
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Consent & Declaration/Consent History',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Consent history patterns showing audit trail data, timeline views, and scrollable card layouts for reviewing past consents.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
const getReactCodeLocal = (html) => htmlToJsx(html, 'ConsentHistory');
...
const FULLSCREEN_1_HTML = `<section class="ux4g-consent-capture-container">
    ...
    <div class="ux4g-consent-capture ux4g-consent-capture-full">
        <div class="ux4g-consent-capture-wrapper">
            <div class="ux4g-consent-header">
                <button class="ux4g-icon-btn ux4g-icon-btn-primary ux4g-icon-btn-pill ux4g-bg-primary-soft">
                    <i class="ux4g-icon-outlined ux4g-text-primary ">shield</i>
                </button>
                <h2 class="ux4g-heading-m-default ">Your Data, Your Control</h2>
                <p class="ux4g-body-s-default ux4g-text-neutral-secondary">A complete record of all consents you
                    have given, including date, time, IP address, and policy version. You can withdraw any active
                    consent below.</p>
            </div>
            <div class="ux4g-table-responsive ux4g-table-rounded">
                <table class="ux4g-table ux4g-table-m  ux4g-table-header-brand">
                    <thead>
                        <tr>
                            <th>
                                <div class="ux4g-table-th-content">Data Type</div>
                            </th>
                            <th>
                                <div class="ux4g-table-th-content">Date & Time</div>
                            </th>
                            <th>
                                <div class="ux4g-table-th-content">Version</div>
                            </th>
                            <th>
                                <div class="ux4g-table-th-content">Status</div>
                            </th>
                            <th>
                                <div class="ux4g-table-th-content">Action</div>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>
                                <div class="ux4g-table-cell-avatar">
                                    <span class="ux4g-fw-semibold">Aadhaar Number</span>
                                </div>
                            </td>
                            <td>10 Apr 2026, 14:34</td>
                            <td>v2.1</td>
                            <td>
                                <span class="ux4g-tag-tonal-success ux4g-tag-s ux4g-radius-full">Active</span>
                            </td>
                            <td>
                                <a class="ux4g-body-s-default ux4g-text-neutral-secondary ">Withdraw</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="ux4g-table-cell-avatar">
                                    <span class="ux4g-fw-semibold">Address</span>
                                </div>
                            </td>
                            <td>02 Jan 2026, 09:15</td>
                            <td>v1.8</td>
                            <td>
                                <span class="ux4g-tag-tonal-success ux4g-tag-s ux4g-radius-full">Active</span>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="ux4g-table-cell-avatar">
                                    <span class="ux4g-fw-semibold">Email</span>
                                </div>
                            </td>
                            <td>15 Sep 2025, 11:02</td>
                            <td>v1.6</td>
                            <td>
                                <span class="ux4g-tag-tonal-error ux4g-tag-s ux4g-radius-full">Withdrawn</span>
                            </td>
                            <td>
                                <a class="ux4g-body-s-default ux4g-text-primary ">Restore</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="ux4g-my-m">
                <a class="ux4g-text-link-sm" href="#" target="_blank">Download consent history (PDF)</a>
            </div>
            <div class="ux4g-divider-horizontal ux4g-my-m"></div>
            <div class="ux4g-consent-button ux4g-my-m">
                <button class="ux4g-btn-primary ux4g-w-100" type="submit">Confirm</button>
                <a class="ux4g-btn-text-neutral ux4g-w-100">Cancel</a>
            </div>
        </div>
...
export const FULLSCREEN_1 = {
    ...
    render: () => renderDemoCodeBlock('consent-audit-trail', 'Consent Audit Trail', 'Full audit trail of all consents given, including date, time, version, and status.', FULLSCREEN_1_HTML, false, 'ux4g-grid-cols-1'),
    parameters: { docs: { disable: true } },
};

const FULLSCREEN_2_HTML = `<section class="ux4g-consent-capture-container">
    <nav class="ux4g-navbar">
        <div class="ux4g-container">
            <div class="ux4g-navbar-wrap">
                <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-s">
    ...
    <div class="ux4g-consent-capture ux4g-consent-capture-full">
        <div class="ux4g-consent-capture-wrapper">
            <div class="ux4g-consent-header ux4g-consent-header-left">
                <h2 class="ux4g-heading-m-default">Consent History</h2>
                <p class="ux4g-body-s-default ux4g-text-neutral-secondary">A complete audit trail of all your data
                    sharing consents for government schemes.</p>
            </div>
            <div class="ux4g-consent-tabs">
                <button class="ux4g-filter-chip-md  ux4g-inline-gap-xs">All</button>
                <button class="ux4g-filter-chip-md  ux4g-inline-gap-xs active">PM-Kisan</button>
                <button class="ux4g-filter-chip-md  ux4g-inline-gap-xs">PM-MKSSY</button>
                <button class="ux4g-filter-chip-md  ux4g-inline-gap-xs active">PMAY</button>
                <button class="ux4g-filter-chip-md  ux4g-inline-gap-xs">PM-Ajay</button>
            </div>
            <div class="ux4g-table-responsive ux4g-table-rounded">
                <table class="ux4g-table ux4g-table-m  ux4g-table-header-brand ux4g-consent-table-hist">
                    <thead>
                        <tr>
                            <th>Scheme</th>
                            <th>Third Party</th>
                    ...
                    <tbody>
                        <tr>
                            <td><span class="ux4g-fw-semibold">PM Kisan</span></td>
                            <td>Bank of India</td>
                            <td>Aadhaar, Name</td>
                            <td>12 Jan 2024</td>
                            <td><span class="ux4g-tag-tonal-success ux4g-tag-s ux4g-radius-full">Active</span></td>
                            <td><a class="ux4g-text-primary ux4g-label-m-default ux4g-cursor-pointer">View</a></td>
                        </tr>
                        <tr>
                            <td><span class="ux4g-fw-semibold">PM Kisan</span></td>
                            <td>Payment Corp</td>
                        ...
                        <tr>
                            ...
                            <td>Mobile Number</td>
                            <td>15 Jan 2024</td>
                            <td><span class="ux4g-tag-tonal-error ux4g-tag-s ux4g-radius-full">Withdrawn</span></td>
                            <td><a class="ux4g-text-primary ux4g-label-m-default ux4g-cursor-pointer">View</a></td>
                        </tr>
                        <tr>
                            <td><span class="ux4g-fw-semibold">PMAY</span></td>
                            <td>Housing Board</td>
                            <td>Address, Income</td>
                            <td>03 Mar 2023</td>
                            <td><span class="ux4g-tag-tonal-neutral ux4g-tag-s ux4g-radius-full">Expired</span></td>
                            <td><a class="ux4g-text-primary ux4g-label-m-default ux4g-cursor-pointer">View</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div class="ux4g-consent-history-footer">
                <span class="ux4g-body-s-default ux4g-text-neutral-secondary">Showing 4 of 4 consents</span>
                <a class="ux4g-text-primary ux4g-label-l-default">Download Consent History (PDF)</a>
            </div>
            <div class="ux4g-consent-button ux4g-my-l">
                <button class="ux4g-btn-text-primary ux4g-w-100" type="button">Back</button>
            </div>
        </div>
        <div class="ux4g-consent-footer">
            <span class="ux4g-label-m-default">Powered by -</span>
...
export const FULLSCREEN_2 = {
    name: 'Consent History - Full Screen',
    render: () => renderDemoCodeBlock('consent-history-full-screen', 'Consent History - Full Screen', 'Full-screen consent history view with download option.', FULLSCREEN_2_HTML, false, 'ux4g-grid-cols-1'),
    parameters: { docs: { disable: true } },
};
...
const CARD_1_HTML = `<section class="ux4g-consent-capture-container">
    ...
    <div class="ux4g-consent-capture ux4g-consent-capture-card">
        <div class="ux4g-consent-capture-wrapper">
            ...
            <div class="ux4g-consent-history-footer">
                <span class="ux4g-body-s-default ux4g-text-neutral-secondary">Showing 4 of 4 consents</span>
                <a class="ux4g-text-primary ux4g-label-m-default">Download Consent History (PDF)</a>
            </div>
            <div class="ux4g-consent-button ux4g-my-l">
                <button class="ux4g-btn-text-primary ux4g-w-100" type="button">Back</button>
            </div>
...
export const CARD_1 = {
    name: 'Consent History - Card',
    render: () => renderDemoCodeBlock('consent-history-card', 'Consent History - Card', 'Card-style consent history with filter chips and tab navigation.', CARD_1_HTML, false, 'ux4g-grid-cols-1'),
    parameters: { docs: { disable: true } },
};
