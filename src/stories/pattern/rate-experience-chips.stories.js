/**
 * Rate Experience Chips Pattern
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Feedback & Communication/Rate Experience Chips',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Quick experience rating using emotion chips with smiley icons for fast feedback.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'RateExperienceChips');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Rate Experience', 'Quick experience rating using emotion chips with smiley icons for fast feedback.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            <span class="ux4g-icon-outlined ux4g-fs-24 ux4g-text-primary">mood</span>
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">Rate Experience Chips</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Quick service rating using emotion chip buttons with smiley face icons.</p>
                    </div>
                </div>
            </div>
        </div>
...
export const RateExperienceChips = {
    name: 'Rate Experience Chips',
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Rate Experience', 'Quick experience rating using emotion chips with smiley icons for fast feedback.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('rate-experience-chips', 'Rate Experience Chips', 'Quick service rating using emotion chip buttons with smiley face icons.', `<section>
    ...
    <section class="ux4g-feedback-completion-section">
        <div class="ux4g-container ux4g-d-flex ux4g-flex-column ux4g-ai-center">
            <div class="ux4g-feedback ux4g-shadow-l0 ux4g-border-none">
                ...
                <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m">
                    <label class="ux4g-body-s-strong ux4g-text-neutral-secondary">What can we improve?</label>
                    ...
                    <div class="ux4g-textarea-container">
                        <div class="ux4g-textarea">
                            <textarea class="ux4g-textarea-input" placeholder="Please provide your valuable feedback on how we can improve our portal for you." rows="4" maxlength="200"></textarea>
                            <div class="ux4g-textarea-counter">0 / 200</div>
                        </div>
                    </div>
                    <button onclick="window.location.href='../../global-service-discovery.html';" class="ux4g-btn-primary" disabled="">Submit</button>
                    <button onclick="window.location.href='../../global-service-discovery.html';" class="ux4g-btn-text-primary ux4g-text-neutral-primary">Skip</button>
                </div>
            </div>
