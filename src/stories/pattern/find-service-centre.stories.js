/**
 * Find Service Centre Pattern
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Feedback & Communication/Find Service Centre',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Locate nearby government service centres with map view and contact details.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'FindServiceCentre');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Find Service Centre', 'Locate nearby government service centres with map view and contact details.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            <span class="ux4g-icon-outlined ux4g-fs-24 ux4g-text-primary">location_on</span>
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">Find Service Centre</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Find nearby service centres with location details, contact info, and operating hours.</p>
                    </div>
                </div>
            </div>
        </div>
...
// ==================== FIND SERVICE CENTRE ====================
export const FindServiceCentre = {
    name: 'Find Service Centre',
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Find Service Centre', 'Locate nearby government service centres with map view and contact details.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('find-service-centre', 'Find Service Centre', 'Find nearby service centres with location details, contact info, and operating hours.', `<section>
    ...
    <section class="ux4g-feedback-completion-section">
        <div class="ux4g-container ux4g-d-flex ux4g-flex-column ux4g-ai-center">
            <div class="ux4g-feedback-completion-card ux4g-nearest-csc-card">
                <!-- Header -->
                <div class="ux4g-nearest-csc-header ux4g-stack-gap-xs">
                    <h1 class="ux4g-heading-l-default ux4g-mb-none">Find your nearest Service Centre</h1>
                ...
                <div class="ux4g-search-container ux4g-search-lg ux4g-csc-search-container">
                    <div class="ux4g-search">
                        ...
                        <input class="ux4g-search-input" id="ux4g-searchContain"
                            placeholder="Enter PIN code or city" type="text">
                ...
                <div class="ux4g-nearest-csc-info-box">
                    <h3 class="ux4g-heading-s-default">CSC Sector 12 — Pune City</h3>
                    <p class="ux4g-body-m-default ux4g-text-neutral-secondary">45 Patel Nagar, Sector 12, Pune 411001</p>
                    <p class="ux4g-body-s-default ux4g-text-neutral-secondary">1.2 km away &middot; Open Mon-Sat 9 AM - 6 PM</p>
                </div>

                <!-- Action Buttons -->
                <div class="ux4g-csc-actions">
                    <button class="ux4g-btn ux4g-btn-primary ux4g-btn-md ux4g-w-100" type="button">Get directions</button>
                    <button class="ux4g-btn ux4g-btn-outline-primary ux4g-btn-md ux4g-w-100" type="button">View all centres</button>
                </div>
            </div>
