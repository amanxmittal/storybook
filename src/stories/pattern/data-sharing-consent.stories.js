/**
 * DataSharingConsent Pattern
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Consent & Declaration/Data Sharing Consent',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Data sharing consent patterns for inter-agency data sharing with partner details and consent management.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
const getReactCodeLocal = (html) => htmlToJsx(html, 'DataSharingConsent');
    ...
    <div class="ux4g-consent-capture ux4g-consent-capture-full">
        <div class="ux4g-consent-capture-wrapper">
            <div class="ux4g-consent-header ux4g-consent-header-left">
                <div class="ux4g-consent-title-wrap ux4g-d-flex ux4g-jc-between ux4g-w-100 ux4g-ai-center">
                    <h2 class="ux4g-heading-m-default">Data Sharing Consent</h2>
                    <span class="ux4g-tag-tonal-primary ux4g-radius-full">
                        DPDP Act 2023
                    </span>
                </div>
                <p class="ux4g-label-m-strong ux4g-text-primary">Scheme: PM Kisan</p>
                <p class="ux4g-body-s-default ux4g-text-neutral-secondary">To enable Direct Benefit Transfer for PM
                    Kisan, the Agriculture Department will share your details with the following third parties.
                    Please review and confirm your consent.</p>
            </div>
            <div class="ux4g-table-responsive ux4g-table-rounded">
                <table class="ux4g-table ux4g-table-m  ux4g-table-header-brand ux4g-consent-table-share">
                    <thead>
                        <tr>
                            <th>Third Party</th>
                            <th>Data Shared</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="ux4g-tag-tonal-neutral ux4g-tag-s ux4g-radius-full">Optional</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="ux4g-consent-button-row ux4g-my-l">
                <button class="ux4g-btn-outline-primary ux4g-w-100" type="button"><i
                        class="ux4g-icon-outlined">edit</i> Manage</button>
                <button class="ux4g-btn-outline-neutral ux4g-w-100" type="button">Cancel</button>
            </div>
        </div>
...
export const FULLSCREEN_1 = {
    name: 'Data Sharing Consent - Full Screen',
    render: () => renderDemoCodeBlock('data-sharing-consent-full-screen', 'Data Sharing Consent - Full Screen', 'Full-screen data sharing consent with partner agency details.', FULLSCREEN_1_HTML, false, 'ux4g-grid-cols-1'),
...
export const CARD_1 = {
    name: 'Data Sharing Consent - Card',
    render: () => renderDemoCodeBlock('data-sharing-consent-card', 'Data Sharing Consent - Card', 'Card-style data sharing consent for compact display.', CARD_1_HTML, false, 'ux4g-grid-cols-1'),
    parameters: { docs: { disable: true } },
};
