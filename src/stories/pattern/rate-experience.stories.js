/**
 * Rate Experience Pattern
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Feedback & Communication/Rate Experience',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Rate your service experience with a 5-star rating scale and optional detailed feedback.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'RateExperience');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Rate Experience', 'Rate your service experience with a 5-star rating scale and optional detailed feedback.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            <span class="ux4g-icon-outlined ux4g-fs-24 ux4g-text-primary">star</span>
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">Rate Experience</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Service experience rating with 5-star scale and optional detailed feedback.</p>
                    </div>
                </div>
            </div>
        </div>
...
export const RateExperience = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Rate Experience', 'Rate your service experience with a 5-star rating scale and optional detailed feedback.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('rate-experience', 'Rate Experience', 'Service experience rating with 5-star scale and optional detailed feedback.', `<section>
