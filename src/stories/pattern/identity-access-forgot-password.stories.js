...
export default {
    title: 'UX4G/Patterns/Identity & Access/Forgot Password',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Forgot password and account recovery patterns for government services.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
                ...
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="mobileNumberFP_col_0">Mobile
                                Number</label>
                            <div class="ux4g-input">
                                <span class="ux4g-input-prefix">+91</span>
                                <input class="ux4g-input-input" id="mobileNumberFP_col_0"
                        ...
                        <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-stack-gap-s">
                            ...
                            <div class="ux4g-alert ux4g-alert-warning ux4g-form-alert ux4g-mt-m">
                                ...
                                <div class="ux4g-form-alert-body">
                                    <span class="ux4g-alert-message ux4g-body-s-default ux4g-text-warning">Most services
                                        use OTP login so you may not need a password.</span>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                            ...
                            <div class="ux4g-otp-meta ux4g-body-s-default" id="ux4g-otp-meta-col_1">
            ...
            <div class="ux4g-identity-access-column ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-flex-column">
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        onsubmit="return false;">
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="newPwd_col_2">Password</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="newPwd_col_2" placeholder="************"
                                    type="password">
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="confirmPwd_col_2">Confirm
                                Password</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="confirmPwd_col_2" placeholder="************"
                                    type="password">
                                <span class="ux4g-input-suffix ux4g-icon-outlined ux4g-cursor-pointer"
                                    onclick="const input = this.closest('.ux4g-input').querySelector('input'); const isPass = input.type === 'password'; input.type = isPass ? 'text' : 'password'; this.textContent = isPass ? 'visibility_off' : 'visibility';">visibility</span>
                            </div>
                        ...
                        <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-mt-xl">
                            <button class="ux4g-btn-primary ux4g-btn-lg ux4g-w-100" type="submit">Reset
                                Password</button>
                        </div>
                    </form>
            ...
            <div class="ux4g-identity-access-column ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-flex-column">
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        onsubmit="return false;">
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="recoveryEmail_col_4">Email
                                Address</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="recoveryEmail_col_4"
            ...
            <div class="ux4g-identity-access-full ux4g-bg-neutral">
                <div class="ux4g-form-box ">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        onsubmit="return false;">
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="mobileNumberFP_full_0">Mobile
                                Number</label>
                            <div class="ux4g-input">
                                <span class="ux4g-input-prefix">+91</span>
                                <input class="ux4g-input-input" id="mobileNumberFP_full_0"
                                    placeholder="Enter mobile number" type="text" inputmode="numeric" maxlength="10"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                            </div>
                        </div>
            ...
            <div class="ux4g-identity-access-full ux4g-bg-neutral">
                <div class="ux4g-form-box ">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        onsubmit="return false;">
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="newPwd_full_2">Password</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="newPwd_full_2" placeholder="************"
                                    type="password">
                                <span class="ux4g-input-suffix ux4g-icon-outlined ux4g-cursor-pointer"
                                    onclick="const input = this.closest('.ux4g-input').querySelector('input'); const isPass = input.type === 'password'; input.type = isPass ? 'text' : 'password'; this.textContent = isPass ? 'visibility_off' : 'visibility';">visibility</span>
                            </div>
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="confirmPwd_full_2">Confirm
                                Password</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="confirmPwd_full_2" placeholder="************"
                                    type="password">
                                <span class="ux4g-input-suffix ux4g-icon-outlined ux4g-cursor-pointer"
                                    onclick="const input = this.closest('.ux4g-input').querySelector('input'); const isPass = input.type === 'password'; input.type = isPass ? 'text' : 'password'; this.textContent = isPass ? 'visibility_off' : 'visibility';">visibility</span>
                            </div>
            ...
            <div class="ux4g-identity-access-full ux4g-bg-neutral">
                <div class="ux4g-form-box ">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        onsubmit="return false;">
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="recoveryEmail_full_4">Email
                                Address</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="recoveryEmail_full_4"
                                    placeholder="Enter your email address" type="email">
                            </div>
                        </div>
...
export const Column = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Forgot Password - Column', 'Column layout variants for forgot password patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('forgot-col-1', 'Reset Password - Mobile Number', '', COLUMN_1_HTML)}
                ${renderDemoCodeBlock('forgot-col-2', 'Enter OTP - Active Timer', '', COLUMN_2_HTML)}
                ${renderDemoCodeBlock('forgot-col-3', 'Create New Password', '', COLUMN_3_HTML)}
                ${renderDemoCodeBlock('forgot-col-4', 'Success - Password Reset', '', COLUMN_4_HTML)}
                ${renderDemoCodeBlock('forgot-col-5', 'Account Recovery - Email', '', COLUMN_5_HTML)}
            </div>
        </div>
    `,
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Forgot Password - Full Screen', 'Full screen layout variants for forgot password patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('forgot-full-1', 'Reset Password - Mobile Number', '', FULL_1_HTML)}
                ${renderDemoCodeBlock('forgot-full-2', 'Enter OTP - Active Timer', '', FULL_2_HTML)}
                ${renderDemoCodeBlock('forgot-full-3', 'Create New Password', '', FULL_3_HTML)}
                ${renderDemoCodeBlock('forgot-full-4', 'Success - Password Reset', '', FULL_4_HTML)}
                ${renderDemoCodeBlock('forgot-full-5', 'Account Recovery - Email', '', FULL_5_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
...
export const Card = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Forgot Password - Card', 'Card layout variants for forgot password patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('forgot-card-1', 'Reset Password - Mobile Number', '', CARD_1_HTML)}
                ${renderDemoCodeBlock('forgot-card-2', 'Enter OTP - Active Timer', '', CARD_2_HTML)}
                ${renderDemoCodeBlock('forgot-card-3', 'Create New Password', '', CARD_3_HTML)}
                ${renderDemoCodeBlock('forgot-card-4', 'Success - Password Reset', '', CARD_4_HTML)}
                ${renderDemoCodeBlock('forgot-card-5', 'Account Recovery - Email', '', CARD_5_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
