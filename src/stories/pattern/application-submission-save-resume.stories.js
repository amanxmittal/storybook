...
export default {
    title: 'UX4G/Patterns/Application & Submission/Save & Resume',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Save draft and resume later pattern with draft status banners, skeleton loading states, and mobile-optimized resume actions.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
const FULLSCREEN_1_HTML = `    <section class="ux4g-identity-access-container ux4g-application-submission">
      ...
      <div class="ux4g-save-resume-body">
        <div class="ux4g-save-resume-content">
          <!-- Draft Status Banner: Desktop -->
          <div
            class="ux4g-draft-status-bar ux4g-bg-warning ux4g-d-none ux4g-md-d-flex"
          >
            <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-l">
              <button
                class="ux4g-icon-btn ux4g-bg-warning-subtle ux4g-icon-btn-pill"
              >
                <i class="ux4g-icon-outlined ux4g-text-warning">token</i>
              </button>
              <div class="ux4g-d-flex ux4g-flex-column">
                <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                  <span class="ux4g-title-s-default"
                    >Income Certificate Application</span
                  >
                  <span class="ux4g-tag-tonal-warning"
                    >Step 3 of 5 Document Upload</span
                  >
                </div>
                <span class="ux4g-body-s-default ux4g-text-neutral-secondary"
                  >Last saved: 10 Apr 2026</span
                >
              </div>
            </div>
            <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-s">
          ...
          <div
            class="ux4g-draft-status-bar-mobile ux4g-bg-warning ux4g-d-flex ux4g-md-d-none"
          >
            <div
              class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-s ux4g-flex-1"
            >
              <div class="ux4g-d-flex ux4g-ai-start ux4g-inline-gap-m">
                <div
                  class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-xs ux4g-flex-1"
                >
                  <span class="ux4g-title-s-default"
                    >Income Certificate Application</span
                  >
                ...
                <button class="ux4g-icon-btn" aria-label="Expand details">
          ...
          <div class="ux4g-save-resume-skeleton">
            <!-- Skeleton Header Area (Desktop Only) -->
            <div
              class="ux4g-d-none ux4g-md-d-flex ux4g-ai-center ux4g-jc-between ux4g-w-100"
            >
              <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-xs">
                <div class="ux4g-skeleton-block ux4g-skeleton-title"></div>
                <div class="ux4g-skeleton-block ux4g-skeleton-subtitle"></div>
              </div>
              <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                <div class="ux4g-skeleton-block ux4g-skeleton-circle"></div>
                <div class="ux4g-skeleton-block ux4g-skeleton-btn"></div>
              </div>
            </div>
            <!-- Skeleton Content Area (Desktop: grid, Mobile: stacked cards) -->
            <div
              class="ux4g-save-resume-skeleton-grid ux4g-d-none ux4g-md-d-grid"
            >
              <div class="ux4g-skeleton-block ux4g-skeleton-main"></div>
              <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m">
                <div
                  class="ux4g-skeleton-block ux4g-skeleton-sidebar-card"
                ></div>
                <div
                  class="ux4g-skeleton-block ux4g-skeleton-sidebar-card"
                ></div>
            ...
            <div
              class="ux4g-d-flex ux4g-md-d-none ux4g-flex-column ux4g-stack-gap-m"
            >
              <div class="ux4g-skeleton-block ux4g-skeleton-sidebar-card"></div>
              <div class="ux4g-skeleton-block ux4g-skeleton-sidebar-card"></div>
            </div>
          </div>
        </div>
        ...
        <div
          class="ux4g-save-resume-mobile-actions ux4g-d-flex ux4g-md-d-none ux4g-flex-column ux4g-stack-gap-xl"
        >
          <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-xs">
          ...
          <div
            class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-stack-gap-xs"
          >
            <span class="ux4g-label-m-default ux4g-text-neutral-tertiary"
              >Powered by -</span
            >
                        <svg xmlns="http://www.w3.org/2000/svg" width="61" height="24" fill="none" viewBox="0 0 61 24">
                <g clip-path="url(#di-save-resume-mob)">
                ...
                <defs>
                  <clipPath id="di-save-resume-mob">
...
const FULLSCREEN_2_HTML = `    <section class="ux4g-identity-access-container ux4g-application-submission">
      ...
      <!-- Body: Resume Screen -->
      <div class="ux4g-save-resume-body">
        <div class="ux4g-save-resume-form-column">
          <!-- Hero Section -->
          <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-xs">
            <h2 class="ux4g-heading-l-strong ux4g-text-neutral-primary">
          ...
          <!-- Your Progress -->
          <h3 class="ux4g-title-s-strong ux4g-text-neutral-primary">
            Your progress
          </h3>
          <!-- Steps List -->
          <div class="ux4g-save-resume-steps">
            <!-- Step 1: Completed -->
            <div class="ux4g-save-resume-step-row">
              <span
                class="ux4g-save-resume-step-icon ux4g-save-resume-step-done"
              >
                <i class="ux4g-icon-outlined">done</i>
              </span>
              <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-2xs">
                <span class="ux4g-body-m-strong ux4g-text-neutral-primary"
            ...
            <div class="ux4g-save-resume-step-row">
              <span
                class="ux4g-save-resume-step-icon ux4g-save-resume-step-pending"
              ></span>
              <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-2xs">
                <span class="ux4g-body-m-strong ux4g-text-neutral-primary"
                ...
                >
                <span class="ux4g-body-s-default ux4g-text-neutral-secondary"
                  >In progress · 1 of 4 uploaded</span
                >
              </div>
            </div>
            <!-- Step 4: Not started -->
          ...
          <!-- Actions -->
          <div class="ux4g-save-resume-actions">
            <button class="ux4g-btn-outline-primary ux4g-btn-md ux4g-flex-1">
              Start fresh
            </button>
            <button class="ux4g-btn-primary ux4g-btn-md ux4g-flex-1">
      ...
      <div class="ux4g-save-resume-body">
        <div class="ux4g-save-resume-form-column">
          ...
          <div class="ux4g-save-resume-steps">
            ...
            <div class="ux4g-save-resume-step-row">
              <span
                class="ux4g-save-resume-step-icon ux4g-save-resume-step-warning"
              >
                <i class="ux4g-icon-outlined">priority_high</i>
              </span>
              <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-2xs">
                <span class="ux4g-body-m-strong ux4g-text-neutral-primary"
                  >Upload documents</span
                >
                <span class="ux4g-body-s-default ux4g-text-neutral-secondary"
                  >1 required document missing</span
                >
              </div>
            </div>
            <!-- Step 3: Not started -->
      ...
      <div class="ux4g-save-resume-body">
        <div class="ux4g-save-resume-form-column">
          ...
          <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-2xs">
            ...
            <p class="ux4g-body-m-default ux4g-text-neutral-secondary">
              Provide the personal details below. We will use this to verify
              your application.
            </p>
          </div>
          <!-- Form Fields -->
          <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-2xs">
            <label class="ux4g-label-l-default ux4g-text-neutral-primary"
              >Full name</label
            >
            <input type="text" class="ux4g-input ux4g-input-md" />
          </div>
          <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-2xs">
            <label class="ux4g-label-l-default ux4g-text-neutral-primary"
              >Date of birth</label
          ...
          <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-2xs">
            <label class="ux4g-label-l-default ux4g-text-neutral-primary"
              >Mobile number</label
            >
            <input type="tel" class="ux4g-input ux4g-input-md" />
          </div>
          <!-- Actions -->
          <div class="ux4g-save-resume-actions">
            <button class="ux4g-btn-outline-primary ux4g-btn-md ux4g-flex-1">
      ...
      <div class="ux4g-save-resume-body">
        <div class="ux4g-save-resume-form-column">
          ...
          <div class="ux4g-draft-status-bar ux4g-bg-warning">
            <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-l">
              <button
                class="ux4g-icon-btn ux4g-bg-warning-subtle ux4g-icon-btn-pill ux4g-d-none ux4g-md-d-flex"
              >
                <i class="ux4g-icon-outlined ux4g-text-warning">token</i>
              </button>
              <div
                class="ux4g-d-flex ux4g-ai-center ux4g-flex-wrap ux4g-inline-gap-s"
              >
                <span class="ux4g-body-s-strong"
                  >Your draft expires in 5 days</span
                >
...
const FULLSCREEN_6_HTML = `    <section
      class="ux4g-identity-access-container ux4g-application-submission ux4g-relative"
    >
      <!-- Accessibility Bar -->
      <header class="ux4g-topbar ux4g-topbar-wide" role="banner">
        <div class="ux4g-container-fluid">
      ...
      <div
        class="ux4g-modal-backdrop ux4g-modal-backdrop-25 ux4g-modal-backdrop-blur is-open"
        aria-labelledby="unsaved-changes-title"
      >
        <div class="ux4g-modal" role="dialog" aria-modal="true">
          <div class="ux4g-modal-box ux4g-modal-m ux4g-modal-center-content">
            <div
              class="ux4g-modal-body ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-gap-m ux4g-p-xl"
            >
              <h3
                id="unsaved-changes-title"
                class="ux4g-heading-m-default ux4g-text-neutral-primary"
              >
                Unsaved changes
              </h3>
              <p
                class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-text-center"
              >
                If you leave now, changes since your last save will be lost.
              </p>
            </div>
            <div class="ux4g-d-flex ux4g-inline-gap-m ux4g-p-l ux4g-w-100">
              <button class="ux4g-btn-primary ux4g-btn-lg ux4g-flex-1">
                Save draft and leave
              </button>
              <button class="ux4g-btn-outline-danger ux4g-btn-lg ux4g-flex-1">
...
const FULLSCREEN_7_HTML = `    <section
      class="ux4g-identity-access-container ux4g-application-submission ux4g-relative"
    >
      <!-- Accessibility Bar -->
      <header class="ux4g-topbar ux4g-topbar-wide" role="banner">
      ...
      >
        <div class="ux4g-modal" role="dialog" aria-modal="true">
          <div class="ux4g-modal-box ux4g-modal-m ux4g-modal-center-content">
            ...
            <div class="ux4g-d-flex ux4g-inline-gap-m ux4g-p-l ux4g-w-100">
              <button class="ux4g-btn-danger ux4g-btn-lg ux4g-flex-1">
...
const CARD_1_HTML = `    <section class="ux4g-identity-access-container ux4g-application-submission">
      ...
      <div class="ux4g-save-resume-body ux4g-bg-primary-soft">
        <div class="ux4g-save-resume-content">
          <!-- Draft Status Banner: Desktop -->
          <div
            class="ux4g-draft-status-bar ux4g-bg-warning ux4g-d-none ux4g-md-d-flex"
        ...
        >
          ...
          >
            ...
            >
                        <svg xmlns="http://www.w3.org/2000/svg" width="61" height="24" fill="none" viewBox="0 0 61 24">
                <g clip-path="url(#di-card-banner-mob)">
                  <path fill="#0e6eb6" fill-rule="evenodd"
                    d="m1.353 12.184-.25-.26c.228-.238.5-.427.801-.556a2.4 2.4 0 0 1 1.898 0c.3.13.573.318.802.556l-.255.25a2.1 2.1 0 0 0-.684-.472 2.06 2.06 0 0 0-2.303.472m.882.867-.23-.236a1.2 1.2 0 0 1 .86-.372 1.17 1.17 0 0 1 .86.372l-.23.236a.88.88 0 0 0-.623-.264.85.85 0 0 0-.623.264m.623.631-.446-.447a.68.68 0 0 1 .446-.193.65.65 0 0 1 .44.193zm0-1.498a1.415 1.415 0 0 1 1.038.452l.278-.285a1.8 1.8 0 0 0-.603-.424 1.8 1.8 0 0 0-2.039.424l.276.288a1.408 1.408 0 0 1 1.048-.455M1.199 13.983h3.274c-2.348 6.09-2.757 9.659-.375 9.564-5.227.316-4.549-4.89-2.897-9.564"
                    clip-rule="evenodd" />
                  <path fill="#f26329" fill-rule="evenodd"
                ...
                <defs>
                  <clipPath id="di-card-banner-mob">
                    <path fill="#fff" d="M0 0h61v24H0z" />
                  </clipPath>
                </defs>
              </svg>
...
const CARD_2_HTML = `    <section class="ux4g-identity-access-container ux4g-application-submission">
      ...
      <div class="ux4g-save-resume-body ux4g-bg-primary-soft">
        <div
          class="ux4g-save-resume-form-column ux4g-bg-neutral-elevated ux4g-radius-m ux4g-p-xl"
        >
          <!-- Hero Section -->
          <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-xs">
            <h2 class="ux4g-heading-l-strong ux4g-text-neutral-primary">
...
const CARD_6_HTML = `    <section
    ...
    >
      ...
      <div
        class="ux4g-modal-backdrop ux4g-modal-backdrop-25 ux4g-modal-backdrop-blur is-open"
        aria-labelledby="unsaved-changes-card-title"
      >
        <div class="ux4g-modal" role="dialog" aria-modal="true">
          <div class="ux4g-modal-box ux4g-modal-m ux4g-modal-center-content">
            <div
...
const CARD_7_HTML = `    <section
    ...
    >
      ...
      <div
        class="ux4g-modal-backdrop ux4g-modal-backdrop-25 ux4g-modal-backdrop-blur is-open"
        aria-labelledby="discard-draft-card-title"
      >
        <div class="ux4g-modal" role="dialog" aria-modal="true">
          <div class="ux4g-modal-box ux4g-modal-m ux4g-modal-center-content">
            <div
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Save & Resume - Full Screen', 'Full Screen layout variants.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('save-fullscreen-1', 'Draft Status Banner - Landing', '', FULLSCREEN_1_HTML)}
                ${renderDemoCodeBlock('save-fullscreen-2', 'Resume Application Screen', '', FULLSCREEN_2_HTML)}
                ${renderDemoCodeBlock('save-fullscreen-3', 'Incomplete Application Resume', '', FULLSCREEN_3_HTML)}
                ${renderDemoCodeBlock('save-fullscreen-4', 'In-Form Auto-save Confirmation', '', FULLSCREEN_4_HTML)}
                ${renderDemoCodeBlock('save-fullscreen-5', 'In-Form Draft Expiry Warning', '', FULLSCREEN_5_HTML)}
                ${renderDemoCodeBlock('save-fullscreen-6', 'Unsaved Changes Modal', '', FULLSCREEN_6_HTML)}
                ${renderDemoCodeBlock('save-fullscreen-7', 'Discard Draft Confirmation Modal', '', FULLSCREEN_7_HTML)}
            </div>
        </div>
    `,
...
export const Card = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Save & Resume - Card', 'Card layout variants.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('save-card-1', 'Draft Status Banner - Landing', '', CARD_1_HTML)}
                ${renderDemoCodeBlock('save-card-2', 'Resume Application Screen', '', CARD_2_HTML)}
                ${renderDemoCodeBlock('save-card-3', 'Incomplete Application Resume', '', CARD_3_HTML)}
                ${renderDemoCodeBlock('save-card-4', 'In-Form Auto-save Confirmation', '', CARD_4_HTML)}
                ${renderDemoCodeBlock('save-card-5', 'In-Form Draft Expiry Warning', '', CARD_5_HTML)}
                ${renderDemoCodeBlock('save-card-6', 'Unsaved Changes Modal', '', CARD_6_HTML)}
                ${renderDemoCodeBlock('save-card-7', 'Discard Draft Confirmation Modal', '', CARD_7_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
