/**
 * Feedback & Communication — Track Application Help.
 * Pattern: How do I track my application? — FAQ + accordion for application issues.
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Feedback & Communication/Track Application',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Help-centre pattern that explains how to track an application, with a category accordion for related FAQs (rejection, document uploads, certificates, officer contact).',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
const getReactCode = (html) => htmlToJsx(html, 'TrackApplication');
...
/* ================================================================ */
/* How do I track my application? (Help Centre - FAQ accordion)     */
/* ================================================================ */
                        ...
                        <div class="ux4g-accordion__collapse collapse" id="simpleRightOne"
                            ...
                            <div class="ux4g-accordion__body">
                                <p>
                                    ...
                                    eget
                                    pretium posuere, massa nulla malesuada nibh, in dictum urna odio et tortor. Fusce
                                    suscipit
                                    nunc sed eros sollicitudin, ac feugiat risus aliquam. Nulla facilisi. Sed tempor
                                    luctus
                                    sem, vitae feugiat magna aliquet at. Mauris suscipit ligula sed est condimentum, at
                                    ullamcorper nunc dapibus. Vivamus non tortor id mauris commodo volutpat. Morbi in
                                    egestas
                                    justo, quis volutpat urna. Curabitur tincidunt, arcu vitae volutpat blandit, nibh
                                    justo
                                    tempor nisl, id pretium mauris lacus vel nisl. Pellentesque habitant morbi tristique
                                    senectus et netus et malesuada fames ac turpis egestas. Suspendisse id massa lorem.
                                    Integer hendrerit, sem et accumsan posuere, elit urna hendrerit ipsum, ut feugiat
                                    dui
                                    augue non dui. Nunc eleifend nibh id orci congue, non posuere orci tempor. In sit
                                    amet
                                    fermentum justo.
                                </p>
                            </div>
                        ...
                        <div class="ux4g-accordion__collapse collapse" id="simpleRightTwo"
                            ...
                            <div class="ux4g-accordion__body">
                                <p>
                                    ...
                                    ligula
                                    non arcu convallis, at interdum turpis tincidunt. Cras a turpis eu ipsum dictum
                                    lacinia.
                                    Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia
                                    curae;
                                    Donec congue lorem et mi pharetra, vitae condimentum risus dictum. Phasellus at
                                    justo
                                    malesuada, varius tortor non, commodo mauris. Duis pellentesque elementum elit, eu
                                    ultricies nisl sagittis in. Aliquam sed dolor a mi suscipit vulputate. Nunc volutpat
                                    mattis purus, vitae varius nibh tristique sit amet. Proin rutrum risus ac lacinia
                                    gravida.
                                    Integer sagittis, lorem non fringilla feugiat, nisl neque sodales massa, quis cursus
                                    lectus
                                    dui a justo. Quisque vitae nisi et ante pulvinar consequat. Sed congue accumsan
                                    orci, nec
                                    vestibulum neque. Curabitur luctus sem ut erat faucibus, non malesuada augue
                                    convallis.
                                    Duis efficitur, lectus eu iaculis ullamcorper, nulla velit dictum lacus, vitae
                                    tincidunt
                                    purus est vitae nisl. Etiam feugiat sapien non nibh dictum vitae vulputate erat
                                    posuere,
                                    sed pretium augue ultrices in semper, nibh justo magna.
                                </p>
                            </div>
                        </div>
                    </div>
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Track Application Help', 'Help-centre pattern guiding citizens to the Status Tracker, with an accordion of related FAQs.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('track-fullscreen-1', 'How do I track my application?', 'Explains the Status Tracker flow with an accordion of related questions.', FULLSCREEN_1_HTML)}
            </div>
        </div>
    `,
