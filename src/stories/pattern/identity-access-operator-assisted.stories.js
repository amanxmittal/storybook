...
export default {
    title: 'UX4G/Patterns/Identity & Access/Operator-Assisted Verification',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Operator-assisted Aadhaar verification flow where a certified VLE operator conducts authentication on behalf of the citizen.',
            },
            source: { code: null },
...
const COLUMN_1_HTML = `    <!-- Aadhaar Operator-Assisted Verification -->
...
const FULLSCREEN_1_HTML = `    <!-- Aadhaar Operator-Assisted Verification -->
    <section class="ux4g-identity-access-container ux4g-mb-4xl">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
...
const CARD_1_HTML = `    <!-- Aadhaar Operator-Assisted Verification -->
    <section class="ux4g-identity-access-container ux4g-mb-4xl">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
...
export const Column = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Operator-Assisted Verification - Column', 'Column layout for VLE operator-assisted Aadhaar authentication.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('operator-column-1', 'Operator-Assisted Authentication', '', COLUMN_1_HTML)}
            </div>
        </div>
    `,
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Operator-Assisted Verification - Full Screen', 'Full screen layout for VLE operator-assisted Aadhaar authentication.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('operator-full-1', 'Operator-Assisted Authentication', '', FULLSCREEN_1_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
...
export const Card = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Operator-Assisted Verification - Card', 'Card layout for VLE operator-assisted Aadhaar authentication.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('operator-card-1', 'Operator-Assisted Authentication', '', CARD_1_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
