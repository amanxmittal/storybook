...
export default {
    title: 'UX4G/Patterns/Feedback & Communication/Help Centre',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Search and browse help articles with accordion-based categories and support options.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'HelpCentre');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Help Centre', 'Search and browse help articles with accordion-based categories and support options.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            <span class="ux4g-icon-outlined ux4g-fs-24 ux4g-text-primary">help</span>
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">Help Centre</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Search and browse help articles with accordion-based categories and support options.</p>
                    </div>
                </div>
            </div>
        </div>
...
export const HelpCentre = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Help Centre', 'Search and browse help articles with accordion-based categories and support options.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('help-centre', 'Help Centre', 'Search and browse help articles with accordion-based categories.', `<section>
    ...
    <section class="ux4g-feedback-completion-section">
        <div class="ux4g-container ux4g-d-flex ux4g-flex-column ux4g-ai-center">
            <div class="ux4g-feedback-completion-card">
                <div class="ux4g-feedback-header-wrapper">
                    <h2 class="ux4g-heading-l-default">Help Centre</h2>
                    <p class="ux4g-body-m-default ux4g-text-neutral-secondary">
                        Find answers to common questions or contact our support team.
                    </p>
                </div>
                <div class="ux4g-search-container ux4g-search-lg ux4g-is-active" ux4g-search-filter="contains"
                    data-ux4g-init="true">
                    <div class="ux4g-search">
                        <span class="ux4g-icon-outlined ux4g-search-leading-icon" data-ux4g-init="true">search</span>
                        <input class="ux4g-search-input" id="ux4g-searchContain"
                            placeholder="Search for a service, scheme or certificate" type="text">
                        <div class="ux4g-search-actions">
                            <button aria-label="Voice search" class="ux4g-search-action-btn" type="button">
                                <span class="ux4g-icon-outlined" data-ux4g-init="true">mic</span>
                            </button>
                            <button aria-label="Clear search" class="ux4g-search-action-btn ux4g-search-clear"
                                type="button">
                                <span class="ux4g-icon-outlined" data-ux4g-init="true">close</span>
                            </button>
                        </div>
                        <button class="ux4g-search-btn" type="button">
                            <span class="ux4g-icon-outlined" data-ux4g-init="true">search</span>
                        </button>
                    </div>
                    <ul class="ux4g-list ux4g-list-default ux4g-list-m ux4g-search-list" style="display: none;">
                        <li class="ux4g-list-item" data-original-text="Apple" data-ux4g-init="true">
                            <div class="ux4g-list-item-row"><span class="ux4g-list-item-start"
                                    style="gap: 0px;">Apple</span></div>
                        </li>
                        <li class="ux4g-list-item" data-original-text="Pineapple" data-ux4g-init="true">
                            <div class="ux4g-list-item-row"><span class="ux4g-list-item-start"
                                    style="gap: 0px;">Pineapple</span></div>
                        </li>
                        <li class="ux4g-list-item" data-original-text="Banana" data-ux4g-init="true">
                            <div class="ux4g-list-item-row"><span class="ux4g-list-item-start"
                                    style="gap: 0px;">Banana</span></div>
                        </li>
                        <li class="ux4g-list-item" data-original-text="Grapefruit" data-ux4g-init="true">
                            <div class="ux4g-list-item-row"><span class="ux4g-list-item-start"
                                    style="gap: 0px;">Grapefruit</span></div>
                        </li>
                    </ul>
                </div>
                <div class="ux4g-feedback-support-label ux4g-label-m-strong ux4g-text-neutral-primary">
                    Browse by category
                </div>
                <div class="ux4g-accordion ux4g-accordion-arrow-right ux4g-mb-xl" id="accordionSimpleRight">
                    <div class="ux4g-accordion__item">
                        <h3 class="ux4g-accordion__header">
                            <button aria-controls="simpleRightOne" aria-expanded="false"
                                class="ux4g-accordion__button collapsed" type="button" ux4g-target="#simpleRightOne"
                        ...
                        <div class="ux4g-accordion__collapse collapse" id="simpleRightOne"
                            ux4g-parent="#accordionSimpleRight" style="">
                            <div class="ux4g-accordion__body">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer malesuada, justo
                                    eget pretium posuere, massa nulla malesuada nibh, in dictum urna odio et tortor. Fusce
                                    suscipit nunc sed eros sollicitudin, ac feugiat risus aliquam. Nulla facilisi. Sed
                                    tempor luctus sem, vitae feugiat magna aliquet at. Mauris suscipit ligula sed est
                                    condimentum, at ullamcorper nunc dapibus. Vivamus non tortor id mauris commodo
                                    volutpat. Morbi in egestas justo, quis volutpat urna. Curabitur tincidunt, arcu vitae
                                    volutpat blandit, nibh justo tempor nisl, id pretium mauris lacus vel nisl.
                                    Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis
                                    egestas. Suspendisse id massa lorem. Integer hendrerit, sem et accumsan posuere, elit
                                    urna hendrerit ipsum, ut feugiat dui augue non dui. Nunc eleifend nibh id orci
                                    congue, non posuere orci tempor. In sit amet fermentum justo.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="ux4g-accordion__item">
                        <h3 class="ux4g-accordion__header">
                            <button aria-controls="simpleRightTwo" aria-expanded="false"
                                class="ux4g-accordion__button collapsed" type="button" ux4g-target="#simpleRightTwo"
                                ux4g-toggle="collapse">
                                <span class="ux4g-accordion__button-content">
                                    <span class="ux4g-accordion__title">Accordion Item</span>
                                </span>
                        ...
                        <div class="ux4g-accordion__collapse collapse" id="simpleRightTwo"
                            ux4g-parent="#accordionSimpleRight">
                            <div class="ux4g-accordion__body">
                                <p>
                                    Donec porta turpis ut ipsum tincidunt, sit amet aliquam leo laoreet. Nunc suscipit
                                    ligula non arcu convallis, at interdum turpis tincidunt. Cras a turpis eu ipsum
                                    dictum lacinia. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices
                                    posuere cubilia curae; Donec congue lorem et mi pharetra, vitae condimentum risus
                                    dictum. Phasellus at justo malesuada, varius tortor non, commodo mauris. Duis
                                    pellentesque elementum elit, eu ultricies nisl sagittis in. Aliquam sed dolor a mi
                                    suscipit vulputate. Nunc volutpat mattis purus, vitae varius nibh tristique sit amet.
                                    Proin rutrum risus ac lacinia gravida. Integer sagittis, lorem non fringilla feugiat,
                                    nisl neque sodales massa, quis cursus lectus dui a justo. Quisque vitae nisi et ante
                                    pulvinar consequat. Sed congue accumsan orci, nec vestibulum neque. Curabitur luctus
                                    sem ut erat faucibus, non malesuada augue convallis. Duis efficitur, lectus eu
                                    iaculis ullamcorper, nulla velit dictum lacus, vitae tincidunt purus est vitae nisl.
                                    Etiam feugiat sapien non nibh dictum vitae vulputate erat posuere, sed pretium augue
                                    ultrices in semper, nibh justo magna.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="ux4g-accordion__item">
                        <h3 class="ux4g-accordion__header">
                            <button aria-controls="simpleRightThree" aria-expanded="false"
                                class="ux4g-accordion__button collapsed" type="button" ux4g-target="#simpleRightThree"
                                ux4g-toggle="collapse">
                                <span class="ux4g-accordion__button-content">
                                    <span class="ux4g-accordion__title">Accordion Item</span>
                                </span>
                        ...
                        <div class="ux4g-accordion__collapse collapse" id="simpleRightThree"
                            ux4g-parent="#accordionSimpleRight">
                            <div class="ux4g-accordion__body">
                                <p>
                                    Donec porta turpis ut ipsum tincidunt, sit amet aliquam leo laoreet. Nunc suscipit
                    ...
                    <div class="ux4g-accordion__item">
                        <h3 class="ux4g-accordion__header">
                            <button aria-controls="simpleRightFour" aria-expanded="false"
                                class="ux4g-accordion__button collapsed" type="button" ux4g-target="#simpleRightFour"
                                ux4g-toggle="collapse">
                                <span class="ux4g-accordion__button-content">
                                    <span class="ux4g-accordion__title">Accordion Item</span>
                                </span>
                        ...
                        <div class="ux4g-accordion__collapse collapse" id="simpleRightFour"
                            ux4g-parent="#accordionSimpleRight">
                            <div class="ux4g-accordion__body">
                                <p>
                                    Donec porta turpis ut ipsum tincidunt, sit amet aliquam leo laoreet. Nunc suscipit
