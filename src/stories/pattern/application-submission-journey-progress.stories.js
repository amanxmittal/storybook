/**
 * Journey Progress Patterns
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Application & Submission/Journey Progress',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Journey progress indicator showing multi-step application flow with completed, active, and upcoming steps in a column layout with sidebar context.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
      ...
      <div class="ux4g-identity-access-layout">
        ...
        >
          <div class="ux4g-sidebar-top">
            ...
            <h1 class="ux4g-heading-l-default ux4g-mb-m">
              Step 3 of 5 &mdash; Documents
            </h1>
            <p class="ux4g-body-l-default ux4g-text-neutral-inverse">
              Upload your identity and KYC documents. We accept PDF, JPG, or PNG
              up to 5 MB each.
            </p>
          </div>
        ...
        >
          <div class="ux4g-form-box">
            <!-- Stepper -->
            <ul
              class="ux4g-stepper ux4g-stepper-horizontal ux4g-stepper-center"
            >
              <!-- Completed -->
            ...
            <div class="ux4g-mt-l">
              ...
              >
                ...
                <div class="ux4g-form-group">
                  <label class="ux4g-label-m-default ux4g-mb-2xs ux4g-d-block"
                    >Full name (as per Aadhaar)</label
                  >
                  <input
                    type="text"
              ...
              <!-- Checkbox -->
              <label class="ux4g-checkbox ux4g-checkbox-md ux4g-mb-xl">
                <input
                  type="checkbox"
              ...
              >
                <button
                  class="ux4g-btn-outline-primary ux4g-btn-lg ux4g-flex-1"
                >
                  Back
                </button>
        ...
        >
          <div class="ux4g-form-box">
            ...
            <div class="ux4g-mt-l">
              <!-- Resume Alert Banner -->
              <div
                class="ux4g-draft-status-bar ux4g-bg-warning ux4g-mb-l"
                role="alert"
              >
                <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-l">
                  <span class="ux4g-icon-outlined ux4g-icon-warning ux4g-fs-20"
                    >error</span
                  >
                  <span class="ux4g-body-s-default ux4g-text-warning"
                    >Resuming from Step 3 — your previous answers are
                    pre-filled. Review before continuing.</span
                  >
                </div>
              </div>
              <!-- Form Header -->
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 61 24"
            >
              <g clip-path="url(#di-journey-resume)">
                <path
                  fill="#0e6eb6"
                  fill-rule="evenodd"
                  d="m1.353 12.184-.25-.26c.228-.238.5-.427.801-.556a2.4 2.4 0 0 1 1.898 0c.3.13.573.318.802.556l-.255.25a2.1 2.1 0 0 0-.684-.472 2.06 2.06 0 0 0-2.303.472m.882.867-.23-.236a1.2 1.2 0 0 1 .86-.372 1.17 1.17 0 0 1 .86.372l-.23.236a.88.88 0 0 0-.623-.264.85.85 0 0 0-.623.264m.623.631-.446-.447a.68.68 0 0 1 .446-.193.65.65 0 0 1 .44.193zm0-1.498a1.415 1.415 0 0 1 1.038.452l.278-.285a1.8 1.8 0 0 0-.603-.424 1.8 1.8 0 0 0-2.039.424l.276.288a1.408 1.408 0 0 1 1.048-.455M1.199 13.983h3.274c-2.348 6.09-2.757 9.659-.375 9.564-5.227.316-4.549-4.89-2.897-9.564"
        ...
        >
          <div class="ux4g-form-box">
            ...
            >
              ...
              <li class="ux4g-stepper-step ux4g-stepper-completed">
                <div class="ux4g-stepper-head">
                  <span
                    class="ux4g-stepper-head-icon ux4g-stepper-warning-icon"
                  >
                    <span class="ux4g-icon-outlined ux4g-icon-error"
                      >error</span
                    >
                  </span>
                </div>
            ...
            <div class="ux4g-mt-l">
                ...
                <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-l">
                  ...
                  <div class="ux4g-d-flex ux4g-flex-column">
                    <span class="ux4g-body-s-default ux4g-text-error"
                      >Documents — 1 error found. Jump to the error field to fix
                      it.</span
                    >
                    <a
                      href="#"
              ...
              >
                ...
                <div class="ux4g-input-md ux4g-input-error">
                  <label class="ux4g-label-m-default ux4g-mb-2xs ux4g-d-block"
                    >PAN number</label
                  >
                  ...
                  <div class="ux4g-input-helper">
                    ...
                    <span class="ux4g-input-helper-text"
                      >Enter a valid 10-character PAN (e.g. ABCDE1234F).</span
                    >
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 61 24"
            >
              <g clip-path="url(#di-journey-error)">
                <path
                  fill="#0e6eb6"
                  fill-rule="evenodd"
                  d="m1.353 12.184-.25-.26c.228-.238.5-.427.801-.556a2.4 2.4 0 0 1 1.898 0c.3.13.573.318.802.556l-.255.25a2.1 2.1 0 0 0-.684-.472 2.06 2.06 0 0 0-2.303.472m.882.867-.23-.236a1.2 1.2 0 0 1 .86-.372 1.17 1.17 0 0 1 .86.372l-.23.236a.88.88 0 0 0-.623-.264.85.85 0 0 0-.623.264m.623.631-.446-.447a.68.68 0 0 1 .446-.193.65.65 0 0 1 .44.193zm0-1.498a1.415 1.415 0 0 1 1.038.452l.278-.285a1.8 1.8 0 0 0-.603-.424 1.8 1.8 0 0 0-2.039.424l.276.288a1.408 1.408 0 0 1 1.048-.455M1.199 13.983h3.274c-2.348 6.09-2.757 9.659-.375 9.564-5.227.316-4.549-4.89-2.897-9.564"
          ...
          <div class="ux4g-mt-l">
            ...
            >
              <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-l">
                ...
                >
                <span class="ux4g-body-s-default ux4g-text-warning"
                  >Resuming from Step 3 — your previous answers are pre-filled.
                  Review before continuing.</span
                >
              </div>
            </div>
            <!-- Form Header -->
            ...
            <li class="ux4g-stepper-step ux4g-stepper-completed">
              <div class="ux4g-stepper-head">
                <span class="ux4g-stepper-head-icon ux4g-stepper-warning-icon">
                  <span class="ux4g-icon-outlined ux4g-icon-error">error</span>
                </span>
              </div>
              <span class="ux4g-stepper-label">Documents</span>
            </li>
      ...
      <div class="ux4g-identity-access-layout-card">
        ...
        >
          ...
          <svg
            ...
            viewBox="0 0 61 24"
          >
            <g clip-path="url(#di-card-jp-default)">
              <path
                fill="#0e6eb6"
                fill-rule="evenodd"
                d="m1.353 12.184-.25-.26c.228-.238.5-.427.801-.556a2.4 2.4 0 0 1 1.898 0c.3.13.573.318.802.556l-.255.25a2.1 2.1 0 0 0-.684-.472 2.06 2.06 0 0 0-2.303.472m.882.867-.23-.236a1.2 1.2 0 0 1 .86-.372 1.17 1.17 0 0 1 .86.372l-.23.236a.88.88 0 0 0-.623-.264.85.85 0 0 0-.623.264m.623.631-.446-.447a.68.68 0 0 1 .446-.193.65.65 0 0 1 .44.193zm0-1.498a1.415 1.415 0 0 1 1.038.452l.278-.285a1.8 1.8 0 0 0-.603-.424 1.8 1.8 0 0 0-2.039.424l.276.288a1.408 1.408 0 0 1 1.048-.455M1.199 13.983h3.274c-2.348 6.09-2.757 9.659-.375 9.564-5.227.316-4.549-4.89-2.897-9.564"
            ...
            <defs>
              <clipPath id="di-card-jp-default">
                <path fill="#fff" d="M0 0h61v24H0z" />
              </clipPath>
            </defs>
          </svg>
      ...
      <div class="ux4g-identity-access-layout-card">
        ...
        >
          ...
          <svg
            ...
            viewBox="0 0 61 24"
          >
            <g clip-path="url(#di-card-jp-resume)">
              <path
                fill="#0e6eb6"
                fill-rule="evenodd"
                d="m1.353 12.184-.25-.26c.228-.238.5-.427.801-.556a2.4 2.4 0 0 1 1.898 0c.3.13.573.318.802.556l-.255.25a2.1 2.1 0 0 0-.684-.472 2.06 2.06 0 0 0-2.303.472m.882.867-.23-.236a1.2 1.2 0 0 1 .86-.372 1.17 1.17 0 0 1 .86.372l-.23.236a.88.88 0 0 0-.623-.264.85.85 0 0 0-.623.264m.623.631-.446-.447a.68.68 0 0 1 .446-.193.65.65 0 0 1 .44.193zm0-1.498a1.415 1.415 0 0 1 1.038.452l.278-.285a1.8 1.8 0 0 0-.603-.424 1.8 1.8 0 0 0-2.039.424l.276.288a1.408 1.408 0 0 1 1.048-.455M1.199 13.983h3.274c-2.348 6.09-2.757 9.659-.375 9.564-5.227.316-4.549-4.89-2.897-9.564"
...
export const Column = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Journey Progress - Column', 'Column layout variants.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('journey-column-1', 'Journey Progress Indicator - Default', '', COLUMN_1_HTML)}
                ${renderDemoCodeBlock('journey-column-2', 'Journey Progress - Resume from Step 3', '', COLUMN_2_HTML)}
                ${renderDemoCodeBlock('journey-column-3', 'Journey Progress - Error State', '', COLUMN_3_HTML)}
            </div>
        </div>
    `,
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Journey Progress - Full Screen', 'Full Screen layout variants.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('journey-fullscreen-1', 'Journey Progress Indicator - Default', '', FULLSCREEN_1_HTML)}
                ${renderDemoCodeBlock('journey-fullscreen-2', 'Journey Progress Indicator - Resume from Step 3', '', FULLSCREEN_2_HTML)}
                ${renderDemoCodeBlock('journey-fullscreen-3', 'Journey Progress Indicator - Error State', '', FULLSCREEN_3_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
...
export const Card = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Journey Progress - Card', 'Card layout variants.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('journey-card-1', 'Journey Progress Indicator - Default', '', CARD_1_HTML)}
                ${renderDemoCodeBlock('journey-card-2', 'Journey Progress Indicator - Resume from Step 3', '', CARD_2_HTML)}
                ${renderDemoCodeBlock('journey-card-3', 'Journey Progress Indicator - Error State', '', CARD_3_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
