/**
 * Feedback & Communication — Still Need Help.
 * Pattern: "Still need help?" support channels list (Phone, Live Chat, Email, Walk-in).
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Feedback & Communication/Still Need Help',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Escalation pattern shown after FAQs have not resolved the citizen issue. Lists all available support channels (Phone, Live Chat, Email, Walk-in Centre) with primary action buttons and a "File a complaint" fallback.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
const getReactCode = (html) => htmlToJsx(html, 'StillNeedHelp');
...
/* ================================================================ */
/* Still need help? (Support channels list)                        */
/* ================================================================ */
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Still Need Help?', 'Escalation card listing every support channel available to a citizen who has not resolved their issue through the FAQs.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('stillneed-fullscreen-1', 'Still need help?', 'Lists phone, live chat, email, and walk-in centre channels with primary actions.', FULLSCREEN_1_HTML)}
            </div>
        </div>
    `,
