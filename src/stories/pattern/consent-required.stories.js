...
export default {
    title: 'UX4G/Patterns/Consent & Declaration/Consent Required',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Consent Required patterns for government services including full-screen and card-style consent capture layouts with data usage tables.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
const getReactCodeLocal = (html) => htmlToJsx(html, 'ConsentRequired');
    ...
    <div class="ux4g-consent-capture ux4g-consent-capture-full">
        <div class="ux4g-consent-capture-wrapper">
            <div class="ux4g-consent-header">
                ...
                <p class="ux4g-body-s-default ux4g-text-neutral-secondary">To process your Income Certificate
                    application, the Revenue Department will use the following data:</p>
            </div>
            <div class="ux4g-table-responsive ux4g-table-rounded">
                <table class="ux4g-table ux4g-table-m  ux4g-table-header-brand ux4g-consent-table-req">
                    <thead>
                        <tr>
                            <th>
                            ...
                            <th>
                                <div class="ux4g-table-th-content">Purpose</div>
                            </th>
                            <th>
                                <div class="ux4g-table-th-content">Retention</div>
                            </th>
                            <th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>7 years</td>
                            <td>
                                <span class="ux4g-tag-tonal-error ux4g-tag-s ux4g-radius-full">Required</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <label class="ux4g-checkbox ux4g-checkbox-md">
                    ...
                    <div class="ux4g-checkbox-content">
                        <div class="ux4g-checkbox-header">
                            <span class="ux4g-checkbox-label">I consent to sharing the required information listed
                                above <sup class="ux4g-text-error-default">*</sup></span>
                        </div>
                    </div>
                </label>
                <label class="ux4g-checkbox ux4g-checkbox-md">
                    ...
                    <div class="ux4g-checkbox-content">
                        <div class="ux4g-checkbox-header">
                            <span class="ux4g-checkbox-label">I also consent to receiving email updates regarding my
                                application</span>
                        </div>
                    </div>
                </label>
            ...
            <div class="ux4g-consent-button  ux4g-my-m">
                <button class="ux4g-btn-primary  ux4g-w-100" type="submit">Proceed</button>
                <a class="ux4g-btn-text-neutral ux4g-w-100">Decline and exit</a>
            </div>
        </div>
...
export const FULLSCREEN_1 = {
    name: 'Consent Required - Full Screen',
    render: () => renderDemoCodeBlock('consent-required-full-screen', 'Consent Required - Full Screen', 'Data consent layout with table showing data types, purposes, retention, and required status.', FULLSCREEN_1_HTML, false, 'ux4g-grid-cols-1'),
        ...
        <div class="ux4g-consent-capture-wrapper">
            ...
            <div class="ux4g-alert ux4g-alert-warning ux4g-form-alert ux4g-mb-m">
                ...
                <div class="ux4g-form-alert-body">
                    <span class="ux4g-alert-message ux4g-body-s-default ux4g-text-warning">Consent not given. You
                        cannot proceed without consenting.</span>
                </div>
            </div>
            <div class="ux4g-d-flex ux4g-flex-column ux4g-gap-xs ">
                <label class="ux4g-checkbox ux4g-checkbox-md">
            ...
            <div class="ux4g-consent-button  ux4g-my-m">
                <button class="ux4g-btn-primary  ux4g-w-100" type="submit" disabled>Proceed</button>
                <a class="ux4g-btn-text-neutral">Decline and exit</a>
            </div>
        </div>
        <div class="ux4g-consent-footer">
            <span class="ux4g-label-m-default">Powered by -</span>
...
export const FULLSCREEN_2 = {
    ...
    render: () => renderDemoCodeBlock('consent-validation', 'Consent Validation', 'Consent capture with validation warning when consent is not given.', FULLSCREEN_2_HTML, false, 'ux4g-grid-cols-1'),
    parameters: { docs: { disable: true } },
};
...
const CARD_1_HTML = `<section class="ux4g-consent-capture-container">
    ...
    <div class="ux4g-consent-capture ux4g-consent-capture-card">
        <div class="ux4g-consent-capture-wrapper">
            <div class="ux4g-consent-header">
                <button class="ux4g-icon-btn ux4g-icon-btn-pill ux4g-bg-primary-soft">
                    <i class="ux4g-icon-outlined ux4g-text-primary">shield</i>
                </button>
                <h2 class="ux4g-heading-m-default ">Your Data, Your Control</h2>
                <p class="ux4g-body-s-default ux4g-text-neutral-secondary">To process your Income Certificate
...
export const CARD_1 = {
    name: 'Consent Card Layout',
    render: () => renderDemoCodeBlock('consent-card-layout', 'Consent Card Layout', 'Card-style consent layout for inline consent capture.', CARD_1_HTML, false, 'ux4g-grid-cols-1'),
    parameters: { docs: { disable: true } },
};
