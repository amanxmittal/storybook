...
export default {
    title: 'UX4G/Patterns/Application & Submission/Document Upload',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Document scan and upload flow with checklist, progress tracking, file requirements guidance, and DigiLocker integration support.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
const DESKTOPWORKSPACE_1_HTML = `    <section class="ux4g-identity-access-container ux4g-application-submission">
      <!-- Accessibility Bar -->
          ...
          <ul class="ux4g-stepper ux4g-stepper-horizontal">
            ...
            <li class="ux4g-stepper-step ux4g-stepper-done">
              <div class="ux4g-stepper-head">
                ...
                >
                  <span
                    class="ux4g-stepper-head-check ux4g-stepper-head-check-active"
                  ></span>
                </span>
              </div>
              <span class="ux4g-stepper-label">Personal</span>
            </li>
            <li class="ux4g-stepper-step ux4g-stepper-done">
              <div class="ux4g-stepper-head">
                <span
              ...
              <span class="ux4g-stepper-label">Documents</span>
            </li>
            <li class="ux4g-stepper-step ux4g-stepper-completed">
              ...
              <span class="ux4g-stepper-label">Submit</span>
            </li>
          </ul>
        </div>
      </div>
      <!-- Workspace Content Area -->
      <div class="ux4g-bg-neutral-soft ux4g-py-xl">
        <div class="ux4g-container">
          <!-- Page Header -->
          <h2
            class="ux4g-heading-l-strong ux4g-text-neutral-primary ux4g-mb-xs"
          >
            Upload documents
          </h2>
          <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-xl">
            Upload the required documents to support your application. Files
            must be PDF or JPG, max 5 MB each.
          </p>
          <!-- Two Column Layout -->
          <div class="ux4g-gov-workspace-grid">
            <!-- Left Column: Document Checklist -->
            <div class="ux4g-bg-neutral-elevated ux4g-radius-m ux4g-p-2xl">
              <!-- Progress Header -->
              <h3
                class="ux4g-heading-s-strong ux4g-text-neutral-primary ux4g-mb-s"
              >
                Required documents — 1 of 4 uploaded
              </h3>
              <div
                class="ux4g-progress-bar ux4g-mb-xl"
              ...
              >
                <div class="ux4g-progress-bar-track">
                  <div class="ux4g-progress-bar-fill" data-ux-value="25"></div>
                </div>
              </div>
              <!-- Document List -->
              <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-l">
                <!-- Document 1: Aadhaar Card - Uploaded -->
                <div
                  class="ux4g-d-flex ux4g-flex-column ux4g-md-flex-row ux4g-md-ai-center ux4g-md-jc-between ux4g-p-m ux4g-bg-success ux4g-radius-m ux4g-gap-m"
                >
                  <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                    <span
                      class="ux4g-icon-outlined ux4g-icon-success ux4g-fs-24"
                      >check_circle</span
                    >
                    <div>
                      <span class="ux4g-label-m-strong ux4g-d-block"
                        >Aadhaar Card</span
                      >
                      <span
                        class="ux4g-body-xs-default ux4g-text-neutral-secondary"
                        >aadhaar_card.pdf · 1.2 MB · Uploaded just now</span
                      >
                    </div>
                  </div>
                  <div
                    class="ux4g-d-flex ux4g-flex-wrap ux4g-inline-gap-m ux4g-stack-gap-s"
                  >
                    <button class="ux4g-btn-outline-primary ux4g-btn-sm">
                      View
                    </button>
                    <button class="ux4g-btn-outline-primary ux4g-btn-sm">
                      Re-upload
                ...
                <div
                  class="ux4g-d-flex ux4g-flex-column ux4g-md-flex-row ux4g-md-ai-center ux4g-md-jc-between ux4g-p-m ux4g-gap-m"
                >
                  <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                    <span
                      class="ux4g-icon-outlined ux4g-text-neutral-tertiary ux4g-fs-24"
                      >radio_button_unchecked</span
                    >
                    <div>
                      <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-s">
                        <span class="ux4g-label-m-strong">Proof of Income</span>
                        <span class="ux4g-tag-tonal-error">Required</span>
                      </div>
                      <span
                        class="ux4g-body-xs-default ux4g-text-neutral-secondary"
                        >Salary slip or income tax return</span
                      >
                    </div>
                  </div>
                  <div
                    class="ux4g-d-flex ux4g-flex-column ux4g-md-flex-row ux4g-gap-s"
                  >
                    <button class="ux4g-btn-primary ux4g-btn-sm">Upload</button>
                    <button class="ux4g-btn-outline-primary ux4g-btn-sm">
                ...
                >
                  <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                    ...
                    <div>
                      <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-s">
                        <span class="ux4g-label-m-strong">Residence proof</span>
                        <span class="ux4g-tag-tonal-error">Required</span>
                      </div>
                      <span
                        class="ux4g-body-xs-default ux4g-text-neutral-secondary"
                        >Electricity bill, gas bill or ration card</span
                      >
                    </div>
                  </div>
                  <div
                ...
                >
                  <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                    ...
                    <div>
                      <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-s">
                        <span class="ux4g-label-m-strong"
                          >Caste certificate</span
                        >
                        <span class="ux4g-tag-tonal-neutral">Optional</span>
                      </div>
                      <span
                        class="ux4g-body-xs-default ux4g-text-neutral-secondary"
                        >SC/ST/OBC applicants only</span
                      >
                    </div>
                  </div>
                  <div
              ...
              <!-- Footer Note -->
              <p
                class="ux4g-body-s-default ux4g-text-neutral-secondary ux4g-mt-xl"
              >
                All uploaded documents must be self-attested. We use AI to flag
                quality issues but officers make the final call.
              </p>
            </div>
            <!-- Right Column: Sidebar -->
            <div class="ux4g-bg-primary ux4g-radius-m ux4g-p-xl">
              <div
                class="ux4g-accordion ux4g-accordion-arrow-right"
                id="govDocUploadAccordion"
              >
                <div class="ux4g-accordion__item">
                  <h3 class="ux4g-accordion__header">
                    <button
                      aria-controls="govDocFileReqs"
                      aria-expanded="true"
                      class="ux4g-accordion__button"
                      type="button"
                      ux4g-target="#govDocFileReqs"
                      ux4g-toggle="collapse"
                    >
                      <span class="ux4g-accordion__button-content">
                        <span class="ux4g-accordion__title"
                  ...
                  <div
                    class="ux4g-accordion__collapse collapse show"
                    id="govDocFileReqs"
                    ux4g-parent="#govDocUploadAccordion"
                  >
                    <div class="ux4g-accordion__body">
                      <ul
                        class="ux4g-body-m-default ux4g-text-neutral-secondary"
                      >
                        <li>Format: PDF or JPG only</li>
                        <li>Size: Max 5 MB per file</li>
                        <li>Quality: Clear, well-lit scan or photo</li>
                        <li>Must be self-attested</li>
                        <li>
                ...
                <div class="ux4g-accordion__item">
                  <h3 class="ux4g-accordion__header">
                    <button
                      aria-controls="govDocDigilocker"
                      aria-expanded="false"
                      class="ux4g-accordion__button collapsed"
                      type="button"
                      ux4g-target="#govDocDigilocker"
                      ux4g-toggle="collapse"
                    >
                      <span class="ux4g-accordion__button-content">
                        <span class="ux4g-accordion__title"
                  ...
                  <div
                    class="ux4g-accordion__collapse collapse"
                    id="govDocDigilocker"
                    ux4g-parent="#govDocUploadAccordion"
                  >
                    <div class="ux4g-accordion__body">
                      <p
                        class="ux4g-body-m-default ux4g-text-neutral-secondary"
                      >
                        DigiLocker documents are pre-verified and accepted
                        instantly. Link your DigiLocker account for faster
                        processing.
                      </p>
                    </div>
                  </div>
      ...
      <!-- Footer Action Bar -->
      <div class="ux4g-bg-neutral-elevated ux4g-bt ux4g-py-l">
        <div class="ux4g-container">
          <div
            class="ux4g-d-none ux4g-md-d-flex ux4g-jc-between ux4g-ai-center"
          >
            <button class="ux4g-btn-outline-neutral ux4g-btn-md">Back</button>
            <div class="ux4g-d-flex ux4g-inline-gap-m">
              <button class="ux4g-btn-outline-primary ux4g-btn-md">
                Save as Draft
              </button>
              <button class="ux4g-btn-primary ux4g-btn-md">Continue</button>
            </div>
          </div>
          <div class="ux4g-d-flex ux4g-flex-column ux4g-gap-m ux4g-md-d-none">
            <button class="ux4g-btn-primary ux4g-btn-lg ux4g-w-100">
              Continue
            </button>
            <button class="ux4g-btn-outline-primary ux4g-btn-lg ux4g-w-100">
              Back
            </button>
          </div>
        </div>
...
const DESKTOPWORKSPACE_2_HTML = `    <section class="ux4g-identity-access-container ux4g-application-submission">
      <!-- Accessibility Bar -->
      <header class="ux4g-topbar ux4g-topbar-wide" role="banner">
        <div class="ux4g-container-fluid">
          <div
        ...
        <div class="ux4g-container">
          ...
          <div class="ux4g-gov-workspace-grid">
            ...
            <div class="ux4g-bg-neutral-elevated ux4g-radius-m ux4g-p-2xl">
              ...
              >
                <div class="ux4g-progress-bar-track">
                  <div class="ux4g-progress-bar-fill" data-ux-value="50"></div>
                </div>
              </div>
              <!-- Document List -->
              <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-l">
                ...
                <div
                  class="ux4g-d-flex ux4g-flex-column ux4g-md-flex-row ux4g-md-ai-center ux4g-md-jc-between ux4g-p-m ux4g-bg-primary ux4g-radius-m ux4g-gap-m"
                >
                  <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                    <span
                      class="ux4g-icon-outlined ux4g-text-primary ux4g-fs-24"
                      >hourglass_top</span
                    >
                    <div>
                      <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-s">
                      ...
                      <span
                        class="ux4g-body-xs-default ux4g-text-neutral-secondary"
                        >Uploading income_proof.pdf... 65%</span
                      >
                    </div>
                  </div>
                  <div
            ...
            <div class="ux4g-bg-primary ux4g-radius-m ux4g-p-xl">
              <div
                class="ux4g-accordion ux4g-accordion-arrow-right"
                id="govDocUploadingAccordion"
              >
                <div class="ux4g-accordion__item">
                  <h3 class="ux4g-accordion__header">
                    <button
                      aria-controls="govDocUploadingFileReqs"
                      aria-expanded="true"
                      class="ux4g-accordion__button"
                      type="button"
                      ux4g-target="#govDocUploadingFileReqs"
                      ux4g-toggle="collapse"
                    >
                      <span class="ux4g-accordion__button-content">
                        <span class="ux4g-accordion__title"
                  ...
                  <div
                    class="ux4g-accordion__collapse collapse show"
                    id="govDocUploadingFileReqs"
                    ux4g-parent="#govDocUploadingAccordion"
                  >
                    <div class="ux4g-accordion__body">
                      <ul
                        class="ux4g-body-m-default ux4g-text-neutral-secondary"
                ...
                <div class="ux4g-accordion__item">
                  <h3 class="ux4g-accordion__header">
                    <button
                      aria-controls="govDocUploadingDigilocker"
                      aria-expanded="false"
                      class="ux4g-accordion__button collapsed"
                      type="button"
                      ux4g-target="#govDocUploadingDigilocker"
                      ux4g-toggle="collapse"
                    >
                      <span class="ux4g-accordion__button-content">
                        <span class="ux4g-accordion__title"
...
const DESKTOPWORKSPACE_3_HTML = `    <section class="ux4g-identity-access-container ux4g-application-submission">
      <!-- Accessibility Bar -->
      <header class="ux4g-topbar ux4g-topbar-wide" role="banner">
        <div class="ux4g-container-fluid">
          <div
        ...
        <div class="ux4g-container">
          ...
          <div class="ux4g-gov-workspace-grid">
            ...
            <div class="ux4g-bg-neutral-elevated ux4g-radius-m ux4g-p-2xl">
              ...
              >
                <div class="ux4g-progress-bar-track">
                  <div class="ux4g-progress-bar-fill" data-ux-value="75"></div>
                </div>
              </div>
              <!-- Document List -->
              <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-l">
                ...
                >
                  <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                    ...
                    <div>
                      <span class="ux4g-label-m-strong ux4g-d-block"
                        >Proof of Income</span
                      >
                      <span
                        class="ux4g-body-xs-default ux4g-text-neutral-secondary"
                        >income_proof.pdf · 1.8 MB · Uploaded just now</span
                      >
                    </div>
                  </div>
                  <div
                ...
                <div
                  class="ux4g-d-flex ux4g-flex-column ux4g-md-flex-row ux4g-md-ai-center ux4g-md-jc-between ux4g-p-m ux4g-bg-warning ux4g-radius-m ux4g-gap-m"
                >
                  <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                    <span
                      class="ux4g-icon-outlined ux4g-icon-warning ux4g-fs-24"
                      >error</span
                    >
                    <div>
                      <span class="ux4g-label-m-strong ux4g-d-block"
                        >Residence proof</span
                      >
                    </div>
                  </div>
                  <div
            ...
            <div class="ux4g-bg-primary ux4g-radius-m ux4g-p-xl">
              <div
                class="ux4g-accordion ux4g-accordion-arrow-right"
                id="govDocAiWarningAccordion"
              >
                <div class="ux4g-accordion__item">
                  <h3 class="ux4g-accordion__header">
                    <button
                      aria-controls="govDocAiWarningFileReqs"
                      aria-expanded="true"
                      class="ux4g-accordion__button"
                      type="button"
                      ux4g-target="#govDocAiWarningFileReqs"
                      ux4g-toggle="collapse"
                    >
                      <span class="ux4g-accordion__button-content">
                        <span class="ux4g-accordion__title"
                  ...
                  <div
                    class="ux4g-accordion__collapse collapse show"
                    id="govDocAiWarningFileReqs"
                    ux4g-parent="#govDocAiWarningAccordion"
                  >
                    <div class="ux4g-accordion__body">
                      <ul
                        class="ux4g-body-m-default ux4g-text-neutral-secondary"
                ...
                <div class="ux4g-accordion__item">
                  <h3 class="ux4g-accordion__header">
                    <button
                      aria-controls="govDocAiWarningDigilocker"
                      aria-expanded="false"
                      class="ux4g-accordion__button collapsed"
                      type="button"
                      ux4g-target="#govDocAiWarningDigilocker"
                      ux4g-toggle="collapse"
                    >
                      <span class="ux4g-accordion__button-content">
                        <span class="ux4g-accordion__title"
...
const DESKTOPWORKSPACE_4_HTML = `    <section class="ux4g-identity-access-container ux4g-application-submission">
      <!-- Accessibility Bar -->
      <header class="ux4g-topbar ux4g-topbar-wide" role="banner">
        <div class="ux4g-container-fluid">
          <div
        ...
        <div class="ux4g-container">
          ...
          <div class="ux4g-gov-workspace-grid">
            ...
            <div class="ux4g-bg-neutral-elevated ux4g-radius-m ux4g-p-2xl">
              ...
              <div
                class="ux4g-d-flex ux4g-ai-start ux4g-inline-gap-m ux4g-p-m ux4g-bg-success ux4g-radius-m ux4g-mb-xl"
              >
                <span class="ux4g-icon-outlined ux4g-icon-success ux4g-fs-24"
                  >check_circle</span
                >
                <div>
                  <span class="ux4g-body-m-default ux4g-d-block"
                    >All required documents uploaded. You can proceed to
                    review.</span
                  >
                  <span class="ux4g-tag-tonal-success ux4g-mt-xs">Success</span>
                </div>
              </div>
              <!-- Progress Header -->
              <h3
              ...
              >
                <div class="ux4g-progress-bar-track">
                  <div class="ux4g-progress-bar-fill" data-ux-value="100"></div>
                </div>
              </div>
              <!-- Document List -->
              <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-l">
                ...
                >
                  <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                    ...
                    <div>
                      ...
                      <span
                        class="ux4g-body-xs-default ux4g-text-neutral-secondary"
                        >income_proof.pdf · 1.8 MB · Uploaded</span
                      >
                    </div>
                  </div>
                  <div
                ...
                >
                  <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                    ...
                    <div>
                      ...
                      <span
                        class="ux4g-body-xs-default ux4g-text-neutral-secondary"
                        >electricity_bill.jpg · 920 KB · Uploaded</span
                      >
                    </div>
                  </div>
                  <div
                ...
                >
                  <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                    ...
                    <div>
                      ...
                      <span
                        class="ux4g-body-xs-default ux4g-text-neutral-secondary"
                        >caste_cert.pdf · 1.1 MB · Uploaded</span
                      >
                    </div>
                  </div>
                  <div
            ...
            <div class="ux4g-bg-primary ux4g-radius-m ux4g-p-xl">
              <div
                class="ux4g-accordion ux4g-accordion-arrow-right"
                id="govDocCompleteAccordion"
              >
                <div class="ux4g-accordion__item">
                  <h3 class="ux4g-accordion__header">
                    <button
                      aria-controls="govDocCompleteFileReqs"
                      aria-expanded="true"
                      class="ux4g-accordion__button"
                      type="button"
                      ux4g-target="#govDocCompleteFileReqs"
                      ux4g-toggle="collapse"
                    >
                      <span class="ux4g-accordion__button-content">
                        <span class="ux4g-accordion__title"
                  ...
                  <div
                    class="ux4g-accordion__collapse collapse show"
                    id="govDocCompleteFileReqs"
                    ux4g-parent="#govDocCompleteAccordion"
                  >
                    <div class="ux4g-accordion__body">
                      <ul
                        class="ux4g-body-m-default ux4g-text-neutral-secondary"
                ...
                <div class="ux4g-accordion__item">
                  <h3 class="ux4g-accordion__header">
                    <button
                      aria-controls="govDocCompleteDigilocker"
                      aria-expanded="false"
                      class="ux4g-accordion__button collapsed"
                      type="button"
                      ux4g-target="#govDocCompleteDigilocker"
                      ux4g-toggle="collapse"
                    >
                      <span class="ux4g-accordion__button-content">
                        <span class="ux4g-accordion__title"
        ...
        <div class="ux4g-container">
          ...
          >
            ...
            <div class="ux4g-d-flex ux4g-inline-gap-m">
              ...
              <button class="ux4g-btn-primary ux4g-btn-md">
                Proceed to review
              </button>
            </div>
          </div>
      ...
      <div class="ux4g-identity-access-full">
        <div class="ux4g-form-box">
          ...
          <div class="ux4g-mt-l">
            ...
            <p
              class="ux4g-body-s-default ux4g-text-neutral-secondary ux4g-mb-l"
            >
              Upload the required documents. PDF or JPG, max 5 MB each.
              Documents must be self-attested.
            </p>
            <!-- Progress Header -->
            <h3
              class="ux4g-label-l-default ux4g-text-neutral-primary ux4g-mb-m"
            >
              Required documents — 1 of 4 uploaded
            </h3>
            <!-- Document List -->
            <div
              class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-l ux4g-mb-xl"
            >
              <!-- Document 1: Aadhaar Card - Uploaded -->
              <div class="ux4g-p-m ux4g-bg-success ux4g-radius-m">
                <div
                  class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m ux4g-mb-s"
                >
                  <span class="ux4g-icon-outlined ux4g-icon-success ux4g-fs-24"
                    >check_circle</span
                  >
              ...
              <div class="ux4g-p-m">
                ...
                >
                  ...
                  <div>
                    <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-s">
                      <span class="ux4g-label-m-strong">Caste certificate</span>
                      <span class="ux4g-tag-tonal-neutral">Optional</span>
                    </div>
                    <span
                      class="ux4g-body-xs-default ux4g-text-neutral-secondary"
            ...
            <!-- Actions -->
            <div
              class="ux4g-d-flex ux4g-flex-column-reverse ux4g-md-flex-row ux4g-gap-m"
            >
              <button class="ux4g-btn-outline-primary ux4g-btn-lg ux4g-flex-1">
                Back
              </button>
              <button class="ux4g-btn-primary ux4g-btn-lg ux4g-flex-1">
                Continue
              </button>
            </div>
          </div>
        ...
        <div class="ux4g-form-box">
          ...
          <div class="ux4g-mt-l">
            ...
            >
              ...
              <!-- Document 2: Proof of Income - Uploading -->
              <div class="ux4g-p-m ux4g-bg-primary ux4g-radius-m">
                <div
                  class="ux4g-d-flex ux4g-ai-center ux4g-jc-between ux4g-gap-m"
                >
                  <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                    <span
                      class="ux4g-icon-outlined ux4g-text-primary ux4g-fs-24"
        ...
        <div class="ux4g-form-box">
          ...
          <div class="ux4g-mt-l">
            ...
            >
              ...
              <!-- Document 3: Residence proof - AI Warning/Flagged -->
              <div class="ux4g-p-m ux4g-bg-warning ux4g-radius-m">
                <div
                  class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m ux4g-mb-s"
                >
                  <span class="ux4g-icon-outlined ux4g-icon-warning ux4g-fs-24"
                    >error</span
                  >
                  <div>
                    <span class="ux4g-label-m-strong ux4g-d-block"
      ...
      <div class="ux4g-identity-access-layout-card">
        ...
        >
          ...
          <svg
            ...
            viewBox="0 0 61 24"
          >
            <g clip-path="url(#di-card-jp-error)">
              <path
                fill="#0e6eb6"
                fill-rule="evenodd"
                d="m1.353 12.184-.25-.26c.228-.238.5-.427.801-.556a2.4 2.4 0 0 1 1.898 0c.3.13.573.318.802.556l-.255.25a2.1 2.1 0 0 0-.684-.472 2.06 2.06 0 0 0-2.303.472m.882.867-.23-.236a1.2 1.2 0 0 1 .86-.372 1.17 1.17 0 0 1 .86.372l-.23.236a.88.88 0 0 0-.623-.264.85.85 0 0 0-.623.264m.623.631-.446-.447a.68.68 0 0 1 .446-.193.65.65 0 0 1 .44.193zm0-1.498a1.415 1.415 0 0 1 1.038.452l.278-.285a1.8 1.8 0 0 0-.603-.424 1.8 1.8 0 0 0-2.039.424l.276.288a1.408 1.408 0 0 1 1.048-.455M1.199 13.983h3.274c-2.348 6.09-2.757 9.659-.375 9.564-5.227.316-4.549-4.89-2.897-9.564"
...
export const DesktopWorkspace = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Document Upload - Desktop Workspace', 'Desktop Workspace layout variants.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('doc-desktopworkspace-1', 'Document Checklist', '', DESKTOPWORKSPACE_1_HTML)}
                ${renderDemoCodeBlock('doc-desktopworkspace-2', 'Upload In Progress', '', DESKTOPWORKSPACE_2_HTML)}
                ${renderDemoCodeBlock('doc-desktopworkspace-3', 'AI Verification Warning', '', DESKTOPWORKSPACE_3_HTML)}
                ${renderDemoCodeBlock('doc-desktopworkspace-4', 'All Documents Uploaded', '', DESKTOPWORKSPACE_4_HTML)}
            </div>
        </div>
    `,
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Document Upload - Full Screen', 'Full Screen layout variants.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('doc-fullscreen-1', 'Document Checklist', '', FULLSCREEN_1_HTML)}
                ${renderDemoCodeBlock('doc-fullscreen-2', 'Upload In Progress', '', FULLSCREEN_2_HTML)}
                ${renderDemoCodeBlock('doc-fullscreen-3', 'AI Verification Warning', '', FULLSCREEN_3_HTML)}
                ${renderDemoCodeBlock('doc-fullscreen-4', 'All Documents Uploaded', '', FULLSCREEN_4_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
...
export const Card = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Document Upload - Card', 'Card layout variants.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('doc-card-1', 'Document Checklist', '', CARD_1_HTML)}
                ${renderDemoCodeBlock('doc-card-2', 'Upload In Progress', '', CARD_2_HTML)}
                ${renderDemoCodeBlock('doc-card-3', 'AI Verification Warning', '', CARD_3_HTML)}
                ${renderDemoCodeBlock('doc-card-4', 'All Documents Uploaded', '', CARD_4_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
