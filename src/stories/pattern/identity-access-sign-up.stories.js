...
export default {
    title: 'UX4G/Patterns/Identity & Access/Sign Up',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Sign-up and registration patterns for government services with citizen onboarding flows.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
        ...
        <div class="ux4g-identity-access-layout">
            ...
            <div class="ux4g-identity-access-column ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-flex-column">
                <div class="ux4g-form-box">
                    <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Create your account</h2>
                    <p class="ux4g-body-s-default ux4g-text-neutral-secondary ux4g-mb-2xl">Enter your mobile number
                        to get started</p>
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpMobileNumber">Mobile
                                Number</label>
                            <div class="ux4g-input">
                                <span class="ux4g-input-prefix">+91</span>
                                <input class="ux4g-input-input" id="signUpMobileNumber"
                    ...
                    <div class="ux4g-text-center ux4g-mt-2xl">
                        <a href="#" class="ux4g-text-link ux4g-label-xl-default">Already have an account? Sign
                            in</a>
                    </div>
        ...
        <div class="ux4g-identity-access-layout">
            ...
            <div
                ...
                <div class="ux4g-form-box">
                    ...
                    <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Verify your mobile</h2>
                    <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl">Enter the 6-digit OTP
                        sent to +91 98765 XXXXX</p>
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                            ...
                            <div class="ux4g-otp-meta ux4g-body-s-default" id="ux4g-otp-meta-signup">
        ...
        <div class="ux4g-identity-access-layout">
            ...
            <div class="ux4g-identity-access-column ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-flex-column">
                <div class="ux4g-form-box">
                    ...
                    <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-2xl">Complete your profile
                    </h2>
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpFullName">Full name</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="signUpFullName" placeholder="Enter your full name"
                                    type="text">
                            </div>
                        </div>
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpEmail">Email Address</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="signUpEmail" placeholder="example@mail.com"
                                    type="email">
                            </div>
                        </div>
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpMobileProfile">Mobile
                                Number</label>
                            <div class="ux4g-input">
                                <span class="ux4g-input-prefix">+91</span>
                                <input class="ux4g-input-input" id="signUpMobileProfile"
                                    placeholder="Enter mobile number" type="text" inputmode="numeric" maxlength="10">
                            </div>
                        </div>
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpCategory">Category</label>
                            <div class="ux4g-input">
                                <select class="ux4g-input-input" id="signUpCategory">
        ...
        <div class="ux4g-identity-access-layout">
            ...
            <div class="ux4g-identity-access-column ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-flex-column">
                <div class="ux4g-form-box">
                    ...
                    <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-2xl">Password setup</h2>

                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        onsubmit="return false;">
                        <!-- Password Input Field -->
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpPassword">Password</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="signUpPassword" placeholder="************"
                                    type="password">
                                <div class="ux4g-input-actions">
                                    <button class="ux4g-input-action-btn" type="button"
                                        onclick="const input = this.closest('.ux4g-input').querySelector('input'); const isPass = input.type === 'password'; input.type = isPass ? 'text' : 'password'; this.querySelector('.ux4g-icon-outlined').textContent = isPass ? 'visibility_off' : 'visibility';">
                                        <span class="ux4g-icon-outlined">visibility</span>
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpConfirmPassword">Confirm
                                password</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="signUpConfirmPassword" placeholder="************"
                                    type="password">
                                <div class="ux4g-input-actions">
                                    <button class="ux4g-input-action-btn" type="button"
                                        onclick="const input = this.closest('.ux4g-input').querySelector('input'); const isPass = input.type === 'password'; input.type = isPass ? 'text' : 'password'; this.querySelector('.ux4g-icon-outlined').textContent = isPass ? 'visibility_off' : 'visibility';">
                        ...
                        <!-- Actions -->
                        <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-mt-xl">
                            <button class="ux4g-btn-primary ux4g-btn-lg ux4g-w-100" type="submit">Create
                                account</button>
                        </div>
                    </form>
            ...
            <div class="ux4g-identity-access-column ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-flex-column">
                <div class="ux4g-form-box">
                    <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-jc-center">
                        ...
                        <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs ux4g-text-center">
                            Account Created!</h2>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl ux4g-text-center">
                            Welcome, Ramesh Kumar</p>

                        <!-- Recommended Tag and Actions -->
                        <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-w-100 ux4g-mt-xl">
                            <span class="ux4g-tag-tonal-warning ux4g-tag-s ux4g-mb-xs">RECOMMENDED</span>
                            <button class="ux4g-btn-primary ux4g-btn-lg ux4g-w-100 ux4g-mb-s" type="button">Link
                                Aadhaar Now</button>
                            <button class="ux4g-btn-outline-primary ux4g-btn-lg ux4g-w-100 ux4g-mb-m" type="button">Skip
                                and Browse Services</button>
                            <span class="ux4g-body-s-default ux4g-text-neutral-tertiary ux4g-text-center">You can
                                link Aadhaar later from your profile</span>
                        </div>
                    </div>
            ...
            <div class="ux4g-identity-access-full ux4g-bg-neutral">
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <!-- Input container -->
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpMobileNumberVar2">Mobile
                                Number</label>
                            <div class="ux4g-input">
                                <span class="ux4g-input-prefix">+91</span>
                                <input class="ux4g-input-input" id="signUpMobileNumberVar2"
                                    placeholder="Enter mobile number" type="text" inputmode="numeric" maxlength="10"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                            </div>
                        </div>
                ...
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                            ...
                            <div class="ux4g-otp-meta ux4g-body-s-default" id="ux4g-otp-meta-signup-var2">
                                <span class="ux4g-otp-helper" data-ux-otp-helper>Didn't receive OTP?</span>
                                <span class="ux4g-otp-resend ux4g-otp-resend-disabled" data-ux-otp-timer
                                    data-ux-otp-prefix="Resend in " data-ux-otp-seconds="17">Resend in 00:17</span>
                            </div>
            ...
            <div class="ux4g-identity-access-full ux4g-bg-neutral">
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <!-- Full Name Input Field -->
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpFullNameVar2">Full
                                name</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="signUpFullNameVar2"
                        ...
                        <!-- Email Address Input Field -->
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpEmailVar2">Email
                                Address</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="signUpEmailVar2" placeholder="example@mail.com"
                                    type="email">
                            </div>
                        </div>
                        ...
                        <!-- Mobile Number Input Field -->
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpMobileProfileVar2">Mobile
                                Number</label>
                            <div class="ux4g-input">
                                <span class="ux4g-input-prefix">+91</span>
                                <input class="ux4g-input-input" id="signUpMobileProfileVar2"
                                    placeholder="Enter mobile number" type="text" inputmode="numeric" maxlength="10">
                            </div>
                        </div>
                        ...
                        <!-- Category Select Field -->
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpCategoryVar2">Category</label>
                            <div class="ux4g-input">
                                <select class="ux4g-input-input" id="signUpCategoryVar2">
                                    <option value="" disabled selected hidden>Please select..</option>
                                    <option value="General">General</option>
                                    <option value="OBC">OBC</option>
                                    <option value="SC">SC</option>
            ...
            <div class="ux4g-identity-access-full ux4g-bg-neutral">
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <!-- Password Input Field -->
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpPasswordVar2">Password</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="signUpPasswordVar2" placeholder="************"
                                    type="password">
                                <div class="ux4g-input-actions">
                                    <button class="ux4g-input-action-btn" type="button"
                                        onclick="const input = this.closest('.ux4g-input').querySelector('input'); const isPass = input.type === 'password'; input.type = isPass ? 'text' : 'password'; this.querySelector('.ux4g-icon-outlined').textContent = isPass ? 'visibility_off' : 'visibility';">
                        ...
                        <!-- Confirm Password Input Field -->
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpConfirmPasswordVar2">Confirm
                                password</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="signUpConfirmPasswordVar2"
...
const CARD_3_HTML = `    <section class="ux4g-identity-access-container">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            <div class="ux4g-form-box ">
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="newPwd_card_2">Password</label>
                        <div class="ux4g-input">
                            <input class="ux4g-input-input" id="newPwd_card_2" placeholder="************"
                                type="password">
                    ...
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="confirmPwd_card_2">Confirm Password</label>
                        <div class="ux4g-input">
                            <input class="ux4g-input-input" id="confirmPwd_card_2" placeholder="************"
                                type="password">
                            <span class="ux4g-input-suffix ux4g-icon-outlined ux4g-cursor-pointer"
                                onclick="const input = this.closest('.ux4g-input').querySelector('input'); const isPass = input.type === 'password'; input.type = isPass ? 'text' : 'password'; this.textContent = isPass ? 'visibility_off' : 'visibility';">visibility</span>
                        </div>
...
const CARD_6_HTML = `    <section class="ux4g-identity-access-container">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            ...
            <div class="ux4g-form-box">
                <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Create your account</h2>
                <p class="ux4g-body-s-default ux4g-text-neutral-secondary ux4g-mb-2xl">Enter your mobile number to
                    get started</p>

                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    <!-- Input container -->
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpMobileNumberVar3">Mobile
                            Number</label>
                        <div class="ux4g-input">
                            <span class="ux4g-input-prefix">+91</span>
                            <input class="ux4g-input-input" id="signUpMobileNumberVar3"
                                placeholder="Enter mobile number" type="text" inputmode="numeric" maxlength="10"
                                oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        </div>
                    </div>
                ...
                <!-- Bottom Link -->
                <div class="ux4g-text-center ux4g-mt-2xl">
                    <a href="#" class="ux4g-text-link ux4g-label-xl-default">Already have an account? Sign in</a>
                </div>
...
const CARD_7_HTML = `    <section class="ux4g-identity-access-container">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            ...
            <div class="ux4g-form-box">
                ...
                <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Verify your mobile</h2>
                <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl">Enter the 6-digit OTP sent to
                    +91 98765 XXXXX</p>
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    ...
                    <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                        ...
                        <div class="ux4g-otp-meta ux4g-body-s-default" id="ux4g-otp-meta-signup-var3">
                            <span class="ux4g-otp-helper" data-ux-otp-helper>Didn't receive OTP?</span>
                            <span class="ux4g-otp-resend ux4g-otp-resend-disabled" data-ux-otp-timer
                                data-ux-otp-prefix="Resend in " data-ux-otp-seconds="17">Resend in 00:17</span>
                        </div>
...
const CARD_8_HTML = `    <section class="ux4g-identity-access-container">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            ...
            <div class="ux4g-form-box">
                ...
                <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-2xl">Complete your profile</h2>

                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    <!-- Full Name Input Field -->
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpFullNameVar3">Full name</label>
                        <div class="ux4g-input">
                            <input class="ux4g-input-input" id="signUpFullNameVar3" placeholder="Enter your full name"
                                type="text">
                        </div>
                    </div>
                    ...
                    <!-- Email Address Input Field -->
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpEmailVar3">Email Address</label>
                        <div class="ux4g-input">
                            <input class="ux4g-input-input" id="signUpEmailVar3" placeholder="example@mail.com"
                                type="email">
                        </div>
                    </div>
                    ...
                    <!-- Mobile Number Input Field -->
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpMobileProfileVar3">Mobile
                            Number</label>
                        <div class="ux4g-input">
                            <span class="ux4g-input-prefix">+91</span>
                            <input class="ux4g-input-input" id="signUpMobileProfileVar3"
                                placeholder="Enter mobile number" type="text" inputmode="numeric" maxlength="10">
                        </div>
                    </div>
                    ...
                    <!-- Category Select Field -->
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpCategoryVar3">Category</label>
                        <div class="ux4g-input">
                            <select class="ux4g-input-input" id="signUpCategoryVar3">
                                <option value="" disabled selected hidden>Please select..</option>
                                <option value="General">General</option>
                                <option value="OBC">OBC</option>
                                <option value="SC">SC</option>
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            ...
            <div class="ux4g-form-box">
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    <!-- Password Input Field -->
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpPasswordVar3">Password</label>
                        <div class="ux4g-input">
                            <input class="ux4g-input-input" id="signUpPasswordVar3" placeholder="************"
                                type="password">
                            <div class="ux4g-input-actions">
                                <button class="ux4g-input-action-btn" type="button"
                                    onclick="const input = this.closest('.ux4g-input').querySelector('input'); const isPass = input.type === 'password'; input.type = isPass ? 'text' : 'password'; this.querySelector('.ux4g-icon-outlined').textContent = isPass ? 'visibility_off' : 'visibility';">
                    ...
                    <!-- Confirm Password Input Field -->
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="signUpConfirmPasswordVar3">Confirm
                            password</label>
                        <div class="ux4g-input">
                            <input class="ux4g-input-input" id="signUpConfirmPasswordVar3" placeholder="************"
                                type="password">
                            <div class="ux4g-input-actions">
                                <button class="ux4g-input-action-btn" type="button"
                                    onclick="const input = this.closest('.ux4g-input').querySelector('input'); const isPass = input.type === 'password'; input.type = isPass ? 'text' : 'password'; this.querySelector('.ux4g-icon-outlined').textContent = isPass ? 'visibility_off' : 'visibility';">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            ...
            <div class="ux4g-form-box">
                <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-jc-center">
                    ...
                    <!-- Success Heading & Subtext -->
                    <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs ux4g-text-center">Account
                        Created!</h2>
                    <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl ux4g-text-center">Welcome,
                        Ramesh Kumar</p>

                    <!-- Recommended Tag and Actions -->
                    <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-w-100 ux4g-mt-xl">
                        <span class="ux4g-tag-tonal-warning ux4g-tag-s ux4g-mb-xs">RECOMMENDED</span>
                        <button class="ux4g-btn-primary ux4g-btn-lg ux4g-w-100 ux4g-mb-s" type="button">Link Aadhaar
                            Now</button>
                        <button class="ux4g-btn-outline-primary ux4g-btn-lg ux4g-w-100 ux4g-mb-m" type="button">Skip
                            and Browse Services</button>
                        <span class="ux4g-body-s-default ux4g-text-neutral-tertiary ux4g-text-center">You can link
                            Aadhaar later from your profile</span>
                    </div>
                </div>
...
export const Column = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Sign Up - Column', 'Column layout variants for sign up patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('signup-col-1', 'Create Account - Mobile Number', '', COLUMN_1_HTML)}
                ${renderDemoCodeBlock('signup-col-2', 'Verify Mobile - OTP Entry', '', COLUMN_2_HTML)}
                ${renderDemoCodeBlock('signup-col-3', 'Complete Profile', '', COLUMN_3_HTML)}
                ${renderDemoCodeBlock('signup-col-4', 'Password Setup', '', COLUMN_4_HTML)}
                ${renderDemoCodeBlock('signup-col-5', 'Success - Account Created', '', COLUMN_5_HTML)}
            </div>
        </div>
    `,
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Sign Up - Full Screen', 'Full screen layout variants for sign up patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('signup-full-1', 'Create Account - Mobile Number', '', FULL_1_HTML)}
                ${renderDemoCodeBlock('signup-full-2', 'Verify Mobile - OTP Entry', '', FULL_2_HTML)}
                ${renderDemoCodeBlock('signup-full-3', 'Complete Profile', '', FULL_3_HTML)}
                ${renderDemoCodeBlock('signup-full-4', 'Password Setup', '', FULL_4_HTML)}
                ${renderDemoCodeBlock('signup-full-5', 'Success - Account Created', '', FULL_5_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
...
export const Card = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Sign Up - Card', 'Card layout variants for sign up patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('signup-card-1', 'Reset Password - Mobile Number', '', CARD_1_HTML)}
                ${renderDemoCodeBlock('signup-card-2', 'Reset Password - OTP Entry', '', CARD_2_HTML)}
                ${renderDemoCodeBlock('signup-card-3', 'Reset Password - Create New Password', '', CARD_3_HTML)}
                ${renderDemoCodeBlock('signup-card-4', 'Success - Password Reset', '', CARD_4_HTML)}
                ${renderDemoCodeBlock('signup-card-5', 'Account Recovery - Email', '', CARD_5_HTML)}
                ${renderDemoCodeBlock('signup-card-6', 'Create Account - Mobile Number', '', CARD_6_HTML)}
                ${renderDemoCodeBlock('signup-card-7', 'Verify Mobile - OTP Entry', '', CARD_7_HTML)}
                ${renderDemoCodeBlock('signup-card-8', 'Complete Profile', '', CARD_8_HTML)}
                ${renderDemoCodeBlock('signup-card-9', 'Password Setup', '', CARD_9_HTML)}
                ${renderDemoCodeBlock('signup-card-10', 'Success - Account Created', '', CARD_10_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
