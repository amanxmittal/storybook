...
export default {
    title: 'UX4G/Patterns/Feedback & Communication/Language Switcher',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Language selection screen with regional language list and current language indicator.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'LanguageSwitcher');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Language Switcher', 'Language selection screen with regional language list and current language indicator.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            <span class="ux4g-icon-outlined ux4g-fs-24 ux4g-text-primary">language</span>
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">Language Switcher</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Multi-language selection interface with regional language options.</p>
                    </div>
                </div>
            </div>
        </div>
...
export const LanguageSwitcher = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Language Switcher', 'Language selection screen with regional language list and current language indicator.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('language-switcher', 'Language Switcher', 'Multi-language selection interface with regional language options.', `<section>
    ...
    <section class="ux4g-feedback-completion-section">
        <div class="ux4g-container ux4g-d-flex ux4g-flex-column ux4g-ai-center">
            <div class="ux4g-feedback-completion-card">
                <div class="ux4g-language-header ux4g-stack-gap-xs">
                    <h1 class="ux4g-heading-l-default ux4g-mb-none">Choose your interface language</h1>
                    <p class="ux4g-body-s-default ux4g-text-neutral-secondary">
                        Switch the portal to a language you read most comfortably. <br class="ux4g-d-none ux4g-d-md-inline">You can change this anytime from the header.
                    </p>
                </div>
                <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m">
                    <label class="ux4g-label-m-default ux4g-d-block ux4g-mb-2xs">Interface Language</label>
                    <div class="ux4g-form-group ux4g-w-100 ux4g-custom-list-dropdown">
                        <div class="ux4g-custom-dropdown-wrapper">
                            <span class="ux4g-icon-outlined ux4g-dropdown-leading-icon">language</span>
                            <button class="ux4g-custom-dropdown-btn ux4g-w-100" type="button" aria-haspopup="listbox" data-value="en">
                                <span>English (United States)</span>
                                <span class="ux4g-icon-outlined">expand_more</span>
                            </button>
                            <ul class="ux4g-custom-dropdown-menu ux4g-o-y-scroll" role="listbox" style="max-height: 200px;">
                                <li class="ux4g-custom-dropdown-item" role="option" data-value="en">
                                    <span class="ux4g-custom-dropdown-text">English (United States)</span>
                                    <span aria-hidden="true" class="ux4g-icon-outlined ux4g-dropdown-single-check">check</span>
                                </li>
                                <li class="ux4g-custom-dropdown-item" role="option" data-value="hi">
                                    <span class="ux4g-custom-dropdown-text">\u0939\u093f\u0928\u094d\u0926\u0940 (Hindi)</span>
                                    <span aria-hidden="true" class="ux4g-icon-outlined ux4g-dropdown-single-check">check</span>
                                </li>
                                <li class="ux4g-custom-dropdown-item" role="option" data-value="bn">
                                    <span class="ux4g-custom-dropdown-text">\u09ac\u09be\u0982\u09b2\u09be (Bengali)</span>
                                    <span aria-hidden="true" class="ux4g-icon-outlined ux4g-dropdown-single-check">check</span>
                                </li>
                                <li class="ux4g-custom-dropdown-item" role="option" data-value="mr">
                                    <span class="ux4g-custom-dropdown-text">\u092e\u0930\u093e\u0920\u0940 (Marathi)</span>
                                    <span aria-hidden="true" class="ux4g-icon-outlined ux4g-dropdown-single-check">check</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <p class="ux4g-body-s-default ux4g-text-neutral-secondary ux4g-mb-none">
                        Auto-detected from your browser preferences. Changing this updates the portal immediately &mdash; no page reload needed.
                    </p>
                </div>
            </div>
