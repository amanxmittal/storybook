...
export default {
    title: 'UX4G/Patterns/Identity & Access/Sign In',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Sign-in patterns for government services with mobile OTP, username/password, and Aadhaar-based authentication options.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
const COLUMN_1_HTML = `    <section class="ux4g-identity-access-container">
        ...
        <div class="ux4g-identity-access-layout">
            ...
            <div class="ux4g-identity-access-sidebar ux4g-d-none ux4g-md-d-flex ux4g-flex-column ux4g-jc-between">
                ...
                <div class="ux4g-sidebar-top">
                    ...
                    <p class="ux4g-body-l-default ux4g-text-neutral-inverse ">
                        Access certificates, documents, and identity verification seamlessly across all government
                        platforms through a unified citizen login.
                    </p>
                </div>

                <!-- Bottom section -->
                <div class="ux4g-sidebar-bottom ux4g-d-flex ux4g-inline-gap-s">
            ...
            <div class="ux4g-identity-access-column ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-flex-column">
                <div class="ux4g-form-box">
                    <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Sign in to your account
                    </h2>
                    <p class="ux4g-body-s-default ux4g-text-neutral-secondary ux4g-mb-2xl">Access your government
                        services securely</p>
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="mobileNumber">Mobile Number</label>
                            <div class="ux4g-input">
                                <span class="ux4g-input-prefix">+91</span>
                                <input class="ux4g-input-input" id="mobileNumber" placeholder="Enter mobile number"
                        ...
                        <div class="ux4g-alert ux4g-alert-error ux4g-form-alert">
                            ...
                            <div class="ux4g-form-alert-body">
                                <span class="ux4g-alert-message">Mobile number not registered.</span>
                                <div class="ux4g-form-alert-footer">
                                    <a href="#" class="ux4g-body-s-strong ux4g-text-error">Register here</a>
                                    <span class="ux4g-alert-counter ux4g-text-error ux4g-label-m-default">Attempt 1
                                        of 5</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Actions -->
                        <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-gap-xs">
                            <button class="ux4g-btn-primary ux4g-btn-lg" type="submit">Send OTP</button>

                            <div class="ux4g-divider-horizontal-text ux4g-text-center">
                                <span
                                    class="ux4g-divider-label ux4g-body-xs-medium ux4g-text-neutral-secondary">OR</span>
                            </div>

                            <button class="ux4g-btn-outline-primary ux4g-btn-lg" type="button">
                    ...
                    <!-- Bottom Link -->
                    <div class="ux4g-text-center ux4g-mt-2xl">
                        <a href="#" class="ux4g-text-link ux4g-label-xl-default">New user? Register here</a>
                    </div>
...
const COLUMN_2_HTML = `    <section class="ux4g-identity-access-container">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
                    <!-- Logo & Brand -->
            ...
            <div class="ux4g-identity-access-column ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-flex-column">
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <!-- NEW in this screen: Dual-field Username & Password layout instead of single Mobile Number with prefix -->

                        <!-- Username Input Field -->
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="username">Username</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="username" placeholder="Enter your username"
                                    type="text">
                            </div>
                        </div>
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="password">Password</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="password" placeholder="************"
                                    type="password">
                            </div>
                        </div>

                        <!-- NEW in this screen: Error Alert Block message "Username not found" and link "Take action" -->
                        <!-- Error Alert Block -->
                        <div class="ux4g-alert ux4g-alert-error ux4g-form-alert">
                            <i class="ux4g-icon ux4g-alert-icon">error</i>
                            <div class="ux4g-form-alert-body">
                                <span class="ux4g-alert-message">Username not found.</span>
                                <div class="ux4g-form-alert-footer">
                                    <a href="#" class="ux4g-body-s-strong ux4g-text-error">Take action</a>
                                    <span class="ux4g-alert-counter ux4g-text-error ux4g-label-m-default">Attempt 1
                                        of 5</span>
                                </div>
                            </div>
                        ...
                        <!-- Reusable: Actions layout with primary and secondary button actions -->
                        <!-- Actions -->
                        <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-gap-xs">
                            <button class="ux4g-btn-primary ux4g-btn-lg" type="submit">Send OTP</button>
                    ...
                    <!-- Reusable: Bottom registration link & powered branding -->
                    <!-- Bottom Link -->
                    <div class="ux4g-text-center ux4g-mt-2xl">
                        <a href="#" class="ux4g-text-link ux4g-label-xl-default">New user? Register here</a>
                    </div>
...
const COLUMN_3_HTML = `    <section class="ux4g-identity-access-container">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
                    <!-- Logo & Brand -->
        ...
        <div class="ux4g-identity-access-layout">
            ...
            <!-- Right Panel (Form panel) -->
            <div
                class="ux4g-identity-access-column ux4g-identity-access-column-otp ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-flex-column">
                <div class="ux4g-form-box">

                    <!-- NEW in this screen: Back navigation link -->
                    ...
                    <!-- NEW in this screen: OTP Verification Header details -->
                    <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Enter OTP</h2>
                    <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl">Sent to +91 98765 XXXXX
                    </p>
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                            role="group">
                            <div class="ux4g-otp-group">
                                <input class="ux4g-otp-source" type="hidden" value="" >
                            </div>
                            <div class="ux4g-otp-meta ux4g-body-s-default" id="ux4g-otp-meta">
                        ...
                        <!-- Actions -->
                        <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-mt-xl">
                            <!-- NEW in this screen: Verify OTP submit action -->
                            <button class="ux4g-btn-primary ux4g-btn-lg ux4g-w-100" type="submit">Verify
                                OTP</button>

                            <!-- NEW in this screen: Info metadata message below action button -->
                            <div class="ux4g-text-center ux4g-mt-s">
                                <span class="ux4g-body-s-default ux4g-text-neutral-tertiary">OTP is valid for 10
                                    minutes</span>
                            </div>
                        </div>
                    </form>
...
const COLUMN_4_HTML = `    <section class="ux4g-identity-access-container">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
                    <!-- Logo & Brand -->
        ...
        <div class="ux4g-identity-access-layout">
            ...
            <!-- Right Panel (Form panel) -->
            <div
                class="ux4g-identity-access-column ux4g-identity-access-column-adhar ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-flex-column">
                <div class="ux4g-form-box">
                    ...
                    <!-- NEW in this screen: Heading and Subheading for Aadhaar Verification -->
                    <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Sign in with Aadhaar
                    </h2>
                    <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl">Enter your 12-digit
                        Aadhaar number</p>
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="aadhaarNumber">Aadhaar
                                Number</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="aadhaarNumber" placeholder="XXXX XXXX 1234"
                        ...
                        <div class="ux4g-d-flex ux4g-flex-column  ux4g-my-m">
                            <span class="ux4g-label-l-default ux4g-text-neutral-secondary ux4g-mb-s">Choose
                                Authentication Method</span>
                            <div class="ux4g-d-flex ux4g-inline-gap-l ux4g-flex-wrap">
                                <label class="ux4g-radio ux4g-radio-md">
                                    <input type="radio" name="auth-method" class="ux4g-radio-input" checked>
                                    ...
                                    <div class="ux4g-radio-content">
                                        <div class="ux4g-radio-header">
                                            <span
                                                class="ux4g-radio-label ux4g-d-inline-flex ux4g-ai-center ux4g-inline-gap-2xs">
                                                Send OTP <span class="ux4g-icon-outlined ux4g-fs-18">phone</span>
                                            </span>
                                        </div>
                                    </div>
                                </label>
                                <label class="ux4g-radio ux4g-radio-md">
                                    <input type="radio" name="auth-method" class="ux4g-radio-input">
                                    <div class="ux4g-radio-control">
                                        <span class="ux4g-radiomark"></span>
                                    </div>
                                    <div class="ux4g-radio-content">
                                        <div class="ux4g-radio-header">
                                            <span
                                                class="ux4g-radio-label ux4g-d-inline-flex ux4g-ai-center ux4g-inline-gap-2xs">
                                                Face Auth <span class="ux4g-icon-outlined ux4g-fs-18">fingerprint</span>
                                            </span>
                                        </div>
                                    </div>
                                </label>
                        ...
                        <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-mt-xl">
                            <button class="ux4g-btn-primary ux4g-btn-lg ux4g-w-100" type="submit">Continue</button>

                            <div class="ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-inline-gap-2xs ux4g-mt-s">
                                <span class="ux4g-icon-outlined ux4g-text-neutral-tertiary ux4g-fs-16">lock</span>
                                <span class="ux4g-body-xs-default ux4g-text-neutral-tertiary">Your Aadhaar details
                                    are encrypted and secure</span>
                            </div>
                        </div>
                    </form>
...
const COLUMN_5_HTML = `    <section class="ux4g-identity-access-container">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
                    <!-- Logo & Brand -->
        ...
        <div class="ux4g-identity-access-layout">
            ...
            <!-- Right Panel (Form panel) -->
            <div
                class="ux4g-identity-access-column ux4g-identity-access-column-success ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-flex-column">
                <div class="ux4g-form-box ux4g-d-flex ux4g-flex-column ux4g-jc-between">
                    <!-- Top spacer for vertical balance of the center success content -->
                    <div class="ux4g-d-none ux4g-md-d-block"></div>

                    <!-- NEW in this screen: Success Central Content -->
                    <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-jc-center">
                        <!-- NEW in this screen: Success Badge Checkmark -->
                        <div class="ux4g-success-badge-outer">
                            <div class="ux4g-success-badge-inner">
                                <span class="ux4g-icon-outlined ux4g-success-icon ux4g-text-white">done</span>
                            </div>
                        </div>

                        <!-- NEW in this screen: Success Heading & Subtext -->
                        <h2 class="ux4g-heading-l-default ux4g-text-success ux4g-mb-xs ux4g-text-center">Signed in
                            successfully!</h2>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl ux4g-text-center">You
                            are being redirected to your service</p>

                        <!-- NEW in this screen: 3-dot Redirect Progress Loader -->
                        <div class="ux4g-loader-dots ux4g-inline-gap-xs">
                            <span class="ux4g-loader-dot ux4g-loader-dot-active"></span>
                            <span class="ux4g-loader-dot ux4g-loader-dot-active"></span>
                            <span class="ux4g-loader-dot"></span>
                        </div>
                    </div>
...
const FULL_1_HTML = `    <section class="ux4g-identity-access-container">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
                    <!-- Logo & Brand -->
            ...
            <div class="ux4g-identity-access-full ux4g-bg-neutral">
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <!-- Input container -->
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="mobileNumberPattern2">Mobile
                                Number</label>
                            <div class="ux4g-input">
                                <span class="ux4g-input-prefix">+91</span>
                                <input class="ux4g-input-input" id="mobileNumberPattern2"
                                    placeholder="Enter mobile number" type="text" inputmode="numeric" maxlength="10"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                            </div>
                        </div>
                        ...
                        <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-gap-xs">
                            ...
                            <div class="ux4g-divider-horizontal-text ux4g-text-center">
                                <span
                                    class="ux4g-divider-label ux4g-body-xs-medium ux4g-text-neutral-secondary ux4g-bg-neutral-elevated">OR</span>
                            </div>
...
const FULL_2_HTML = `    <section class="ux4g-identity-access-container">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
                    <!-- Logo & Brand -->
            ...
            <div class="ux4g-identity-access-full ux4g-bg-neutral">
                <div class="ux4g-form-box">
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <!-- Username Input Field -->
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="usernamePattern2">Username</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="usernamePattern2" placeholder="Enter your username"
                                    type="text">
                            </div>
                        </div>
                        ...
                        <!-- Password Input Field -->
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="passwordPattern2">Password</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="passwordPattern2" placeholder="************"
                                    type="password">
                            </div>
                        </div>
...
const FULL_3_HTML = `    <section class="ux4g-identity-access-container">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
                    <!-- Logo & Brand -->
        ...
        <div class="ux4g-identity-access-layout ux4g-jc-center">
            ...
            <div class="ux4g-identity-access-full ux4g-bg-neutral">
                <div class="ux4g-form-box">
                    ...
                    <!-- OTP Verification Header details -->
                    <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Enter OTP</h2>
                    <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl">Sent to +91 98765 XXXXX
                    </p>
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                            ...
                            <div class="ux4g-otp-meta ux4g-body-s-default" id="ux4g-otp-meta-pattern2">
                                <span class="ux4g-otp-helper" data-ux-otp-helper>Didn't receive OTP?</span>
                                <span class="ux4g-otp-resend ux4g-otp-resend-disabled" data-ux-otp-timer
                                    data-ux-otp-prefix="Resend in " data-ux-otp-seconds="17">Resend in 00:17</span>
                            </div>
...
const FULL_4_HTML = `    <section class="ux4g-identity-access-container">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
                    <!-- Logo & Brand -->
        ...
        <div class="ux4g-identity-access-layout ux4g-jc-center">
            ...
            <div class="ux4g-identity-access-full ux4g-bg-neutral">
                <div class="ux4g-form-box">
                    ...
                    <!-- Heading and Subheading for Aadhaar Verification -->
                    <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Sign in with Aadhaar
                    </h2>
                    <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl">Enter your 12-digit
                        Aadhaar number</p>
                    ...
                    <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m"
                        ...
                        <div class="ux4g-input-container ux4g-input-lg">
                            <label class="ux4g-label-l-default ux4g-mb-2xs" for="aadhaarNumberPattern2">Aadhaar
                                Number</label>
                            <div class="ux4g-input">
                                <input class="ux4g-input-input" id="aadhaarNumberPattern2" placeholder="XXXX XXXX 1234"
                                    type="text" inputmode="numeric" maxlength="14"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '').substring(0, 12).replace(/(\\d{4})(?=\\d)/g, '$1 ')">
                            </div>
                        </div>
                        ...
                        <div class="ux4g-d-flex ux4g-flex-column ux4g-my-m">
                            ...
                            <div class="ux4g-d-flex ux4g-inline-gap-l ux4g-flex-wrap">
                                <label class="ux4g-radio ux4g-radio-md">
                                    <input type="radio" name="auth-method-pattern2" class="ux4g-radio-input" checked>
                                    <div class="ux4g-radio-control">
                                        <span class="ux4g-radiomark"></span>
                                    </div>
                                    <div class="ux4g-radio-content">
                                ...
                                <label class="ux4g-radio ux4g-radio-md">
                                    <input type="radio" name="auth-method-pattern2" class="ux4g-radio-input">
                                    <div class="ux4g-radio-control">
                                        <span class="ux4g-radiomark"></span>
                                    </div>
                                    <div class="ux4g-radio-content">
...
const FULL_5_HTML = `    <section class="ux4g-identity-access-container">
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
                    <!-- Logo & Brand -->
...
const CARD_1_HTML = `    <section class="ux4g-identity-access-container">
            ...
            <div class="ux4g-form-box ">
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    ...
                    <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-stack-gap-s">
                        <div class="ux4g-d-flex ux4g-flex-column ux4g-gap-xs ux4g-w-100">
                            <button class="ux4g-btn-primary ux4g-btn-lg " type="submit">Send OTP</button>
                            <div class="ux4g-text-center ux4g-mt-s">
                                <a href="#"
...
const CARD_2_HTML = `    <section class="ux4g-identity-access-container">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            <div class="ux4g-form-box ">
                ...
                <h2 class="ux4g-heading-xl-strong ux4g-mb-xs">Enter OTP</h2>
                <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl">Sent to +91 98765 XXXXX</p>
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                        ...
                        <div class="ux4g-otp-meta ux4g-body-s-default" id="ux4g-otp-meta-full_1">
                            <span class="ux4g-otp-helper" data-ux-otp-helper>Didn't receive OTP?</span>
                            <span class="ux4g-otp-resend ux4g-otp-resend-disabled" data-ux-otp-timer
                                data-ux-otp-prefix="Resend in " data-ux-otp-seconds="17">Resend in 00:17</span>
                        </div>
...
const CARD_3_HTML = `    <section class="ux4g-identity-access-container">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            <div class="ux4g-form-box ">
                ...
                <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Create new password</h2>
                <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl">Your new password must be
                    different from previous used password</p>

                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="createPassword">Password</label>
                        <div class="ux4g-input">
                            <input class="ux4g-input-input" id="createPassword" placeholder="************"
                                type="password" data-ux4g-init="true">
                            <span class="ux4g-input-suffix ux4g-icon-outlined ux4g-cursor-pointer"
                                onclick="const input = this.closest('.ux4g-input').querySelector('input'); const isPass = input.type === 'password'; input.type = isPass ? 'text' : 'password'; this.textContent = isPass ? 'visibility_off' : 'visibility';">visibility</span>
                        </div>
                    </div>

                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="confirmPassword">Confirm Password</label>
                        <div class="ux4g-input">
                            <input class="ux4g-input-input" id="confirmPassword" placeholder="************"
                                type="password" data-ux4g-init="true">
                    ...
                    <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-mt-xl">
                        <button class="ux4g-btn-primary ux4g-btn-lg ux4g-w-100" type="submit">Reset Password</button>
                    </div>
                </form>
...
const CARD_4_HTML = `    <section class="ux4g-identity-access-container">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            <div class="ux4g-form-box ux4g-h-100 ux4g-d-flex ux4g-flex-column ux4g-jc-center">
                ...
                <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-jc-center">
                    ...
                    <h2 class="ux4g-heading-l-default ux4g-text-success ux4g-mb-xs ux4g-text-center">Password reset
                        successfully</h2>
                    <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl ux4g-text-center">Your
                        password has been changed successfully. Use your new password to log in.</p>

                    <button class="ux4g-btn-primary ux4g-btn-lg ux4g-w-100 ux4g-mt-xl" type="button">Log in</button>
                </div>
...
const CARD_5_HTML = `    <section class="ux4g-identity-access-container">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            <div class="ux4g-form-box ">
                ...
                <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Account recovery</h2>
                <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl">Enter your registered email
                    address to recover your account.</p>

                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="recoveryEmail_card_4">Email Address</label>
                        <div class="ux4g-input">
                            <input class="ux4g-input-input" id="recoveryEmail_card_4"
                                placeholder="Enter your email address" type="email">
                        </div>
                    </div>

                    <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-mt-xl">
                        <button class="ux4g-btn-primary ux4g-btn-lg ux4g-w-100" type="submit">Get OTP</button>
                    </div>
                </form>
...
const CARD_6_HTML = `    <section class="ux4g-identity-access-container">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            ...
            <div class="ux4g-form-box">
                <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Sign in to your account</h2>
                <p class="ux4g-body-s-default ux4g-text-neutral-secondary ux4g-mb-2xl">Access your government
                    services securely</p>
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    <!-- Input container -->
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="mobileNumberPattern3">Mobile
                            Number</label>
                        <div class="ux4g-input">
                            <span class="ux4g-input-prefix">+91</span>
                            <input class="ux4g-input-input" id="mobileNumberPattern3" placeholder="Enter mobile number"
                                type="text" inputmode="numeric" maxlength="10"
                                oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        </div>
                    </div>
                    ...
                    <!-- Error Alert Block -->
                    <div class="ux4g-alert ux4g-alert-warning ux4g-form-alert">
                        <i class="ux4g-icon-outlined ux4g-alert-icon">error</i>
                        <div class="ux4g-form-alert-body">
                            <span class="ux4g-alert-message">Your status message goes here</span>
                            <div class="ux4g-form-alert-footer">
                                <a href="#" class="ux4g-body-s-strong ux4g-text-warning">Take action</a>
                                <span class="ux4g-alert-counter ux4g-text-warning ux4g-label-m-default">Attempt 1 of
                                    5</span>
                            </div>
                        </div>
                    </div>
...
const CARD_7_HTML = `    <section class="ux4g-identity-access-container">
        <!-- Reusable Component: Navbar Header -->
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            ...
            <div class="ux4g-form-box">
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    ...
                    <!-- Username Input Field -->
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="usernamePattern3">Username</label>
                        <div class="ux4g-input">
                            <input class="ux4g-input-input" id="usernamePattern3" placeholder="Enter your username"
                                type="text">
                        </div>
                    </div>
                    ...
                    <!-- Password Input Field -->
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="passwordPattern3">Password</label>
                        <div class="ux4g-input">
                            <input class="ux4g-input-input" id="passwordPattern3" placeholder="************"
                                type="password">
                        </div>
                    </div>
...
const CARD_8_HTML = `    <section class="ux4g-identity-access-container">
        <!-- Reusable Component: Navbar Header -->
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
            ...
            <div class="ux4g-form-box">
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    ...
                    <div class="ux4g-otp ux4g-otp-default" data-ux-otp data-ux-state="default" data-ux-count="6"
                        ...
                        <div class="ux4g-otp-meta ux4g-body-s-default" id="ux4g-otp-meta-pattern3">
                            <span class="ux4g-otp-helper" data-ux-otp-helper>Didn't receive OTP?</span>
                            <span class="ux4g-otp-resend ux4g-otp-resend-disabled" data-ux-otp-timer
                                data-ux-otp-prefix="Resend in " data-ux-otp-seconds="17">Resend in 00:17</span>
                        </div>
...
const CARD_9_HTML = `    <section class="ux4g-identity-access-container">
        <!-- Reusable Component: Navbar Header -->
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            ...
            <div class="ux4g-form-box">
                ...
                <!-- Heading and Subheading for Aadhaar Verification -->
                <h2 class="ux4g-heading-l-default ux4g-text-neutral-primary ux4g-mb-xs">Sign in with Aadhaar</h2>
                <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl">Enter your 12-digit Aadhaar
                    number</p>
                ...
                <form class="ux4g-signin-form ux4g-d-flex ux4g-flex-column ux4g-stack-gap-m" onsubmit="return false;">
                    ...
                    <!-- Aadhaar Number Input Field -->
                    <div class="ux4g-input-container ux4g-input-lg">
                        <label class="ux4g-label-l-default ux4g-mb-2xs" for="aadhaarNumberPattern3">Aadhaar
                            Number</label>
                        <div class="ux4g-input">
                            <input class="ux4g-input-input" id="aadhaarNumberPattern3" placeholder="XXXX XXXX 1234"
                                type="text" inputmode="numeric" maxlength="14"
                                oninput="this.value = this.value.replace(/[^0-9]/g, '').substring(0, 12).replace(/(\\d{4})(?=\\d)/g, '$1 ')">
                        </div>
                    </div>
                    ...
                    <div class="ux4g-d-flex ux4g-flex-column ux4g-my-m">
                        ...
                        <div class="ux4g-d-flex ux4g-inline-gap-l ux4g-flex-wrap">
                            <label class="ux4g-radio ux4g-radio-md">
                                <input type="radio" name="auth-method-pattern3" class="ux4g-radio-input" checked>
                                <div class="ux4g-radio-control">
                                    <span class="ux4g-radiomark"></span>
                                </div>
                                <div class="ux4g-radio-content">
                            ...
                            <label class="ux4g-radio ux4g-radio-md">
                                <input type="radio" name="auth-method-pattern3" class="ux4g-radio-input">
                                <div class="ux4g-radio-control">
                                    <span class="ux4g-radiomark"></span>
                                </div>
                                <div class="ux4g-radio-content">
                    ...
                    <div class="ux4g-form-actions ux4g-d-flex ux4g-flex-column ux4g-mt-xl">
                        ...
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-jc-center ux4g-inline-gap-2xs ux4g-mt-s">
                            <span class="ux4g-icon-outlined ux4g-text-neutral-tertiary ux4g-fs-16">lock</span>
                            <span class="ux4g-body-xs-default ux4g-text-neutral-tertiary">Your Aadhaar details are
...
const CARD_10_HTML = `    <section class="ux4g-identity-access-container">
        <!-- Reusable Component: Navbar Header -->
        <nav class="ux4g-navbar">
            <div class="ux4g-container">
                <div class="ux4g-navbar-wrap">
        ...
        <div class="ux4g-identity-access-layout-card ux4g-bg-primary-soft">
            ...
            <div class="ux4g-form-box ux4g-d-flex ux4g-flex-column ux4g-jc-between">
                ...
                <!-- Success Central Content -->
                <div class="ux4g-d-flex ux4g-flex-column ux4g-ai-center ux4g-jc-center ux4g-my-2xl">
                    <!-- Success Badge Checkmark -->
                    <div class="ux4g-success-badge-outer">
                        <div class="ux4g-success-badge-inner">
                            <span class="ux4g-icon-outlined ux4g-success-icon ux4g-text-white">done</span>
                    ...
                    <h2 class="ux4g-heading-l-default ux4g-text-success ux4g-mb-xs ux4g-text-center">Signed in
                        successfully!</h2>
                    <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mb-2xl ux4g-text-center">You are
                        being redirected to your service</p>
...
export const Column = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Sign In - Column', 'Column layout variants for sign in patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('signin-col-1', 'Error - Unregistered Mobile Number', '', COLUMN_1_HTML)}
                ${renderDemoCodeBlock('signin-col-2', 'Error - Username Not Found', '', COLUMN_2_HTML)}
                ${renderDemoCodeBlock('signin-col-3', 'OTP Entry - Active Timer', '', COLUMN_3_HTML)}
                ${renderDemoCodeBlock('signin-col-4', 'Sign In with Aadhaar', '', COLUMN_4_HTML)}
                ${renderDemoCodeBlock('signin-col-5', 'Success - Signed In', '', COLUMN_5_HTML)}
            </div>
        </div>
    `,
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Sign In - Full Screen', 'Full screen layout variants for sign in patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('signin-full-1', 'Error - Unregistered Mobile Number', '', FULL_1_HTML)}
                ${renderDemoCodeBlock('signin-full-2', 'Error - Username Not Found', '', FULL_2_HTML)}
                ${renderDemoCodeBlock('signin-full-3', 'OTP Entry - Active Timer', '', FULL_3_HTML)}
                ${renderDemoCodeBlock('signin-full-4', 'Sign In with Aadhaar', '', FULL_4_HTML)}
                ${renderDemoCodeBlock('signin-full-5', 'Success - Signed In', '', FULL_5_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
...
export const Card = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Sign In - Card', 'Card layout variants for sign in patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('signin-card-1', 'Reset Password - Mobile Number', '', CARD_1_HTML)}
                ${renderDemoCodeBlock('signin-card-2', 'Reset Password - OTP Entry', '', CARD_2_HTML)}
                ${renderDemoCodeBlock('signin-card-3', 'Reset Password - Create New Password', '', CARD_3_HTML)}
                ${renderDemoCodeBlock('signin-card-4', 'Success - Password Reset', '', CARD_4_HTML)}
                ${renderDemoCodeBlock('signin-card-5', 'Account Recovery - Email', '', CARD_5_HTML)}
                ${renderDemoCodeBlock('signin-card-6', 'Warning - Mobile Number', '', CARD_6_HTML)}
                ${renderDemoCodeBlock('signin-card-7', 'Error - Username Not Found', '', CARD_7_HTML)}
                ${renderDemoCodeBlock('signin-card-8', 'OTP Entry - Active Timer', '', CARD_8_HTML)}
                ${renderDemoCodeBlock('signin-card-9', 'Sign In with Aadhaar', '', CARD_9_HTML)}
                ${renderDemoCodeBlock('signin-card-10', 'Success - Signed In', '', CARD_10_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
