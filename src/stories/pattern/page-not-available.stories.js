/**
 * Page Not Available Pattern
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Feedback & Communication/Page Not Available',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Content unavailability notice with language feedback options and navigation alternatives.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'PageNotAvailable');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Page Not Available', 'Content unavailability notice with language feedback options and navigation alternatives.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            <span class="ux4g-icon-outlined ux4g-fs-24 ux4g-text-primary">error_outline</span>
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">Page Not Available</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Content not available in selected language with feedback and navigation options.</p>
                    </div>
                </div>
            </div>
        </div>
...
export const PageNotAvailable = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Page Not Available', 'Content unavailability notice with language feedback options and navigation alternatives.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('page-not-available', 'Page Not Available', 'Content not available in selected language with feedback and navigation options.', `<section>
        ...
        <div class="ux4g-container ux4g-d-flex ux4g-flex-column ux4g-ai-center">
            <div class="ux4g-feedback-completion-card">
                <div class="ux4g-language-header ux4g-stack-gap-xs">
                    <h1 class="ux4g-heading-l-default ux4g-mb-none">This page is not yet available in Tamil</h1>
                    <p class="ux4g-body-s-default ux4g-text-neutral-secondary">
                        We are translating Income Certificate pages &mdash; the Tamil version is coming in May 2026.
                    </p>
                </div>
                <div class="ux4g-alert ux4g-alert-warning ux4g-radius-m ux4g-border ux4g-border-warning ux4g-ai-start">
                    <i class="ux4g-icon ux4g-alert-icon ux4g-icon-warning">error</i>
                    <div class="ux4g-alert-content ux4g-d-flex ux4g-flex-column ux4g-stack-gap-2xs">
                        <span class="ux4g-alert-title ux4g-text-warning">Translation in progress</span>
                        <span class="ux4g-alert-message ux4g-text-warning">You can read this page in English meanwhile, or use your browser to auto-translate.</span>
                    </div>
                </div>
                <div class="ux4g-d-flex ux4g-flex-column ux4g-stack-gap-s ux4g-mt-xl">
                    <button type="button" class="ux4g-btn-primary ux4g-btn-md ux4g-w-100">Switch to English</button>
                    <button type="button" class="ux4g-btn-outline-primary ux4g-btn-md ux4g-w-100">Translate with browser</button>
                </div>
            </div>
