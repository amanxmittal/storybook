...
export default {
    title: 'UX4G/Patterns/Payment & Transactions/Payment Failed',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Error state with failure reason, attempted amount, and retry options including alternate payment methods.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'PaymentFailed');
...
const FULLSCREEN_1_HTML = `<section class="ux4g-mb-xl">
    <div class="ux4g-payment ux4g-payment-card">
        <div class="ux4g-payment-wrapper">
            ...
            <div class="ux4g-text-center ux4g-py-l">
                <button class="ux4g-icon-btn ux4g-bg-error-soft ux4g-icon-btn-lg ux4g-icon-btn-pill ux4g-mb-s">
                    <i class="ux4g-icon-filled ux4g-fs-24 ux4g-text-error">error</i>
                </button>
                <h2 class="ux4g-heading-m-default">Payment Failed</h2>
                <p class="ux4g-body-s-default ux4g-text-neutral-secondary ux4g-mt-s">Bank declined the transaction. No amount was deducted from your account.</p>
            </div>
            <div class="ux4g-table-responsive ux4g-table-rounded ux4g-mb-l ux4g-bg-error-soft ux4g-border-error">
                <table class="ux4g-table ux4g-table-m">
                    <tbody class="ux4g-bg-transparent">
                        <tr><td class="ux4g-text-neutral-secondary">Reason</td><td class="ux4g-text-right"><span class="ux4g-body-m-strong">Bank declined</span></td></tr>
                        <tr><td class="ux4g-text-neutral-secondary">Attempted amount</td><td class="ux4g-text-right"><span class="ux4g-body-m-strong">Rs 41.30</span></td></tr>
            ...
            <div class="ux4g-d-flex ux4g-flex-column ux4g-gap-xs">
                <button class="ux4g-btn-primary ux4g-w-100">Try again with UPI</button>
                <button class="ux4g-btn-outline-primary ux4g-w-100">Try a different method</button>
                <button class="ux4g-btn-text-primary ux4g-w-100">Pay at CSC centre</button>
            </div>
        </div>
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Payment Failed', 'Error state with failure reason, attempted amount, and retry options.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('payment-failed-full', 'Payment Failed', 'Full screen layout with reason, attempted amount, and retry actions.', FULLSCREEN_FULL_HTML, false, 'ux4g-grid-cols-1')}
            </div>
        </div>
    `,
...
export const Card = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Payment Failed', 'Error state with failure reason, attempted amount, and retry options.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('payment-failed-card', 'Payment Failed', 'Error card with reason, attempted amount, and retry actions.', FULLSCREEN_1_HTML, false, 'ux4g-grid-cols-1')}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
