/**
 * Live Chat Conversation Pattern
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Feedback & Communication/Live Chat Conversation',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Live chat conversation interface with message bubbles, timestamps, and quick reply options.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'LiveChatConversation');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Live Chat', 'Live chat conversation interface with message bubbles, timestamps, and quick reply options.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            <span class="ux4g-icon-outlined ux4g-fs-24 ux4g-text-primary">forum</span>
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">Live Chat Conversation</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Real-time chat conversation interface with multimedia message support.</p>
                    </div>
                </div>
            </div>
        </div>
...
export const LiveChatConversation = {
    name: 'Live Chat Conversation',
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Live Chat', 'Live chat conversation interface with message bubbles, timestamps, and quick reply options.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('live-chat-conversation', 'Live Chat Conversation', 'Real-time chat conversation interface with multimedia message support.', `<section>
        ...
        <div class="ux4g-container ux4g-d-flex ux4g-flex-column ux4g-ai-center">
            <div class="ux4g-feedback-completion-card ux4g-chat-support-card">
                ...
                <div class="ux4g-feedback-header-wrapper ux4g-stack-gap-xs">
                    <h1 class="ux4g-heading-l-default">Live Chat Support</h1>
                ...
                <!-- Status Banner -->
                <div
                    class="ux4g-alert ux4g-alert-success ux4g-radius-s ux4g-border ux4g-border-success ux4g-feedback-alert">
                    <span class="ux4g-icon-filled ux4g-alert-icon ux4g-icon-success">check_circle</span>
                    <div class="ux4g-alert-content ux4g-d-flex ux4g-flex-column ux4g-stack-gap-3xs">
                        <span class="ux4g-alert-title ux4g-text-success ux4g-body-m-strong">Queue agent available</span>
                        <span class="ux4g-alert-message ux4g-text-success ux4g-body-s-default">Estimated wait time: 1-2
                            mins</span>
                    </div>
                </div>

                <!-- Description -->
                <p class="ux4g-body-m-default">
                    Connect now to discuss your application with our support team. Average response time under 2
                    minutes.
                </p>

                <!-- Action Buttons -->
                <div class="ux4g-form-action-footer ux4g-d-flex ux4g-flex-column ux4g-stack-gap-xs">
                    <button class="ux4g-btn ux4g-btn-primary ux4g-btn-md" type="button"
                        data-modal-target="#modalBackdropBlur">Start Chat Session</button>
                    <button class="ux4g-btn ux4g-btn-outline-primary ux4g-btn-md" type="button">Email support
                        instead</button>
                </div>
            </div>
    ...
    <!-- chat modal -->
    <div aria-labelledby="modalBackdropBlurLabel"
        class="ux4g-modal-backdrop ux4g-modal-backdrop-25 ux4g-modal-backdrop-blur" id="modalBackdropBlur">
        <div class="ux4g-feedback ux4g-fixed ux4g-bottom-0 ux4g-end-0 ux4g-feedback ux4g-fixed ux4g-bottom-0 ux4g-end-0 ux4g-mr-2xl ux4g-mb-2xl" data-ux4g-init="true">
            ...
            <div class="feedback-thumb-wrapper">
                <button class="ux4g-btn-outline-primary feedback-thumb-up">
                    <span class="ux4g-icon-outlined ux4g-text-neutral-secondary" data-ux4g-init="true">thumb_up</span>
                    Yes
                </button>
                <button class="ux4g-btn-outline-primary feedback-thumb-up">
                    <span class="ux4g-icon-outlined ux4g-text-neutral-secondary" data-ux4g-init="true">thumb_down</span>
                    No
                </button>
            </div>
        </div>
