/**
 * Search & Browse — Browse and discover government services with intelligent search, topic-based discovery, and featured schemes.
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Search & Discovery/Search Browse',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Browse and discover government services with intelligent search, topic-based discovery, and featured schemes.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
const FULLSCREEN_1_HTML = `    <section>
        ...
        <div class="ux4g-bg-primary ux4g-sb-search-hero-section">
            <div class="ux4g-container">
                <div class="ux4g-sb-search-hero-section-inner">
        ...
        <div class="ux4g-container">
            ...
            <div class="ux4g-grid ux4g-grid-auto-fit-250 ux4g-mt-m ux4g-sb-card-category">
                ...
                <div class="ux4g-p-l ux4g-sb-category-card">
                    <div class="ux4g-sb-category-icon-wrap ux4g-d-inline-flex ux4g-ai-center ux4g-jc-center">
                        <span
                            class="ux4g-icon-outlined ux4g-text-primary ux4g-sb-category-card-icon">volunteer_activism</span>
                    </div>
                ...
                <div class="ux4g-p-l ux4g-sb-category-card">
                    <div class="ux4g-sb-category-icon-wrap ux4g-d-inline-flex ux4g-ai-center ux4g-jc-center">
                        <span
                            class="ux4g-icon-outlined ux4g-text-primary ux4g-sb-category-card-icon">account_balance</span>
                    </div>
    ...
    <section class="ux4g-sb-featured-scheme-section ux4g-bg-neutral ux4g-pt-2xl">
        <div class="ux4g-container">
            <div class="ux4g-sb-featured-scheme-card ux4g-p-2xl">
                <div class="ux4g-grid ux4g-grid-cols-1 ux4g-grid-cols-md-2 ux4g-gap-s ux4g-ai-center">

                    <!-- Left Content Column -->
                    <div class="ux4g-sb-featured-scheme-content">
                        ...
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Subsidised housing loans for eligible
                            families — interest subsidy up to ₹2.67 lakh.</p>
                        <button class="ux4g-btn-primary ux4g-btn-md ux4g-sb-featured-scheme-btn">Check eligibility</button>
                    </div>

                    <!-- Right Graphic Column -->
                    <div class="ux4g-sb-featured-scheme-graphic-wrap">
                        <div class="ux4g-sb-featured-scheme-graphic"></div>
                    </div>
    ...
    <section class="ux4g-popular-services-section ux4g-bg-neutral ux4g-pt-2xl ux4g-pb-2xl">
        <div class="ux4g-container">
            <!-- Title -->
...
export const FullScreen = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Search & Browse - Full Screen', 'Full Screen layout variant for search and discovery patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('search-browse', 'Search & Browse - Full Page', '', FULLSCREEN_1_HTML)}
            </div>
        </div>
    `,
...
export const Column = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Search & Browse - Full Screen', 'Full Screen layout variant for search and discovery patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('search-browse-column', 'Search & Browse - Full Page', '', COLUMN_1_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
...
export const DesktopWorkspace = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Search & Browse - Full Screen', 'Full Screen layout variant for search and discovery patterns.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('search-browse-desktopworkspace', 'Search & Browse - Full Page', '', DESKTOPWORKSPACE_1_HTML)}
            </div>
        </div>
    `,
    parameters: { docs: { disable: true } },
