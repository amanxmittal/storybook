/**
 * Contact Channels Pattern
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Feedback & Communication/Contact Channels',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Multi-channel contact support options with phone, chat, email, and walk-in centre cards.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'ContactChannels');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Contact Channels', 'Multi-channel contact support options with phone, chat, email, and walk-in centre cards.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            <span class="ux4g-icon-outlined ux4g-fs-24 ux4g-text-primary">support_agent</span>
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">Contact Channels</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Multi-channel contact support options with phone, chat, email, and walk-in centre cards.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-l">
                        <ul class="ux4g-navbar-links">
                            ...
                            <li class="ux4g-dropdown ux4g-dropdown-button" data-ux4g-init="true">
                                <a href="#" class="ux4g-text-link-sm ux4g-dropdown-control " data-ux-toggle="dropdown" id="ux4g-dropdown-control-6" aria-haspopup="listbox" aria-expanded="false">
                                    <span>Schemes</span>
                                    <span class="ux4g-icon-outlined ux4g-text-primary ux4g-fs-20 ux4g-dropdown-caret" data-ux4g-init="true">arrow_drop_down</span>
                                </a>
    ...
    <section class="ux4g-feedback-completion-section">
        <div class="ux4g-container ux4g-d-flex ux4g-flex-column ux4g-ai-center">
            <div class="ux4g-feedback-completion-card">
                <div class="ux4g-feedback-header-wrapper ux4g-stack-gap-xs">
                    <h1 class="ux4g-heading-l-default ux4g-feedback-title ux4g-mb-none">Still need help?</h1>
                ...
                <div class="ux4g-support-channels-list">
                    <div class="ux4g-support-channel-card ux4g-d-flex ux4g-ai-center ux4g-jc-between">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                            <div class="ux4g-support-icon-wrapper">
                                <span class="ux4g-icon-outlined">phone</span>
                            </div>
                            <div class="ux4g-d-flex ux4g-flex-column">
                                <span class="ux4g-title-s-strong">Phone Support</span>
                                <span class="ux4g-body-s-default">1800-XXX-XXXX · Toll free · Mon-Sat 9AM-6PM</span>
                            </div>
                        </div>
                        <button class="ux4g-btn-primary ux4g-btn-md" type="button">Call Now</button>
                    </div>
                    <div class="ux4g-support-channel-card ux4g-d-flex ux4g-ai-center ux4g-jc-between">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                            <div class="ux4g-support-icon-wrapper">
                                <span class="ux4g-icon-outlined">forum</span>
                            </div>
                            <div class="ux4g-d-flex ux4g-flex-column">
                                <span class="ux4g-title-s-strong">Live Chat</span>
                                <span class="ux4g-body-s-default">Available now · Estimated wait 1-2 minutes</span>
                            </div>
                        </div>
                        <button class="ux4g-btn-primary ux4g-btn-md" onclick="window.location.href='../../contact-n-support-4.html';" type="button">Start Chat</button>
                    </div>
                    <div class="ux4g-support-channel-card ux4g-d-flex ux4g-ai-center ux4g-jc-between">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                            <div class="ux4g-support-icon-wrapper">
                                <span class="ux4g-icon-outlined">mail</span>
                            </div>
                            <div class="ux4g-d-flex ux4g-flex-column">
                                <span class="ux4g-title-s-strong">Email Support</span>
                                <span class="ux4g-body-s-default">Response within 2 working days</span>
                            </div>
                        </div>
                        <button class="ux4g-btn-primary ux4g-btn-md" type="button">Send Email</button>
                    </div>
                    <div class="ux4g-support-channel-card ux4g-d-flex ux4g-ai-center ux4g-jc-between">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-inline-gap-m">
                            <div class="ux4g-support-icon-wrapper">
                                <span class="ux4g-icon-outlined">directions_walk</span>
                            </div>
                            <div class="ux4g-d-flex ux4g-flex-column">
                                <span class="ux4g-title-s-strong">Walk-in Centre</span>
                                <span class="ux4g-body-s-default">Visit your nearest Common Service Centre</span>
                            </div>
                        </div>
                        <button class="ux4g-btn-outline-primary ux4g-btn-md" type="button">Find CSC</button>
                    </div>
                </div>
                <div class="ux4g-d-flex ux4g-jc-center ux4g-mt-m">
                    <a href="#" class="ux4g-support-complaint-link">File a complaint about this portal</a>
                </div>
            </div>
        ...
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Contact Channels', 'Multi-channel contact support options with phone, chat, email, and walk-in centre cards.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('contact-channels', 'Contact Channels', 'Multi-channel contact support options with phone, chat, email, and walk-in centre cards.', bodyContent, false, 'ux4g-grid-cols-1')}
            </div>
        </div>
    `;
    },
