/**
 * Live Chat Init Pattern
 */

import { formatCode, htmlToJsx } from '../utils/formatCode';

export default {
    title: 'UX4G/Patterns/Feedback & Communication/Live Chat Init',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Live chat initiation card with queue availability status and action buttons.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
// ==================== HELPERS ====================
const getReactCodeLocal = (html) => htmlToJsx(html, 'LiveChatInit');
...
export const Introduction = {
    ...
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Live Chat Init', 'Live chat initiation card with queue availability status and action buttons.')}
                ...
                <div class="ux4g-d-grid ux4g-grid-cols-1 ux4g-md-grid-cols-2 ux4g-lg-grid-cols-3 ux4g-gap-l">
                    <div class="ux4g-bg-white ux4g-radius-l ux4g-p-xl ux4g-border ux4g-border-neutral-emphasis">
                        <div class="ux4g-d-flex ux4g-ai-center ux4g-gap-m ux4g-mb-m">
                            <span class="ux4g-icon-outlined ux4g-fs-24 ux4g-text-primary">chat</span>
                            <h3 class="ux4g-heading-s-strong ux4g-text-neutral-primary">Live Chat Init</h3>
                        </div>
                        <p class="ux4g-body-m-default ux4g-text-neutral-secondary">Live chat initiation card with queue availability status and action buttons.</p>
                    </div>
                </div>
            </div>
        </div>
...
// ==================== LIVE CHAT INIT ====================
export const LiveChatInit = {
    name: 'Live Chat Init',
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Live Chat Init', 'Live chat initiation card with queue availability status and action buttons.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('live-chat-init', 'Live Chat Init', 'Live chat initiation card with queue availability status and action buttons.', `<section>
    ...
    <section class="ux4g-feedback-completion-section">
        <div class="ux4g-container ux4g-d-flex ux4g-flex-column ux4g-ai-center">
            <div class="ux4g-feedback-completion-card ux4g-chat-support-card">
                ...
                <div class="ux4g-alert ux4g-alert-success ux4g-radius-s ux4g-border ux4g-border-success ux4g-feedback-alert">
                    ...
                    <div class="ux4g-alert-content ux4g-d-flex ux4g-flex-column ux4g-stack-gap-3xs">
                        ...
                        <span class="ux4g-alert-message ux4g-text-success ux4g-body-s-default">Estimated wait time: 1-2 mins</span>
                    </div>
                </div>
                ...
                <div class="ux4g-form-action-footer ux4g-d-flex ux4g-flex-column ux4g-stack-gap-xs">
                    <button class="ux4g-btn ux4g-btn-primary ux4g-btn-md" type="button">Start Chat Session</button>
                    <button class="ux4g-btn ux4g-btn-outline-primary ux4g-btn-md" type="button">Email support instead</button>
                </div>
            </div>
