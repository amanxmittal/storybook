...
export default {
    title: 'UX4G/Components/Input Pan-Card',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Input field for 10-character alphanumeric PAN card number.',
            },
            source: { code: null },
            canvas: {
                sourceState: 'none',
...
const PAN_INPUT_HTML = `
<div class="ux4g-input-container ux4g-input-md ux4g-w-50">
    <label class="ux4g-label-m-strong" for="panInput">PAN Card Input <span class="ux4g-text-warning">*</span></label>
    <div class="ux4g-input">
        <input class="ux4g-input-input" id="panInput" placeholder="ABCDE1234F" type="text"
    ...
    <div class="ux4g-input-helper" style="display: none;">
        ...
        <span class="ux4g-input-helper-text">Please enter a valid 10-character PAN number.</span>
    </div>
</div>
`;
        ...
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen" id="intro-container">
            <section class="ux4g-bg-primary-strong ux4g-text-white ux4g-py-2xl">
                <div class="ux4g-container">
                    ...
                    <div class="ux4g-max-w-800">
                        <span class="ux4g-label-l-medium ux4g-d-block ux4g-mb-xs ux4g-opacity-90">Components</span>
                        <h1 class="ux4g-display-s-strong ux4g-mb-m ux4g-text-white">Input Pan-Card</h1>
                        <p class="ux4g-body-l-default ux4g-opacity-90 ux4g-max-w-700">
                            Input field for 10-character alphanumeric PAN card number using the UX4G design system.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div class="ux4g-d-flex ux4g-flex-col ux4g-gap-l">
                        <div class="ux4g-border ux4g-border-neutral-emphasis ux4g-bg-white ux4g-radius-l ux4g-p-xl">
                            <div class="ux4g-d-flex ux4g-jc-between ux4g-ai-center ux4g-mb-l">
                                <div>
                                    <h2 class="ux4g-heading-m-strong ux4g-text-neutral-primary">Input Pan-Card Showcase</h2>
                                    <p class="ux4g-body-m-default ux4g-text-neutral-secondary ux4g-mt-xs">Source-backed examples covering standard PAN card input sizing and supporting actions.</p>
                                </div>
                            </div>
                            ${PAN_INPUT_HTML}
                        </div>
...
export const PanCardInput = {
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Input Pan-Card', 'Input field for 10-character alphanumeric PAN card number.')}
            <div class="ux4g-p-m">
                ${renderDemoCodeBlock('pan-input', 'PAN Card Input', 'PAN card input field.', PAN_INPUT_HTML, false, PAN_INPUT_HTML)}
            </div>
        </div>
    `,
    parameters: {
