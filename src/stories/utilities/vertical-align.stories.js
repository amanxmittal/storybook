/**
 * VerticalAlign.stories.js
 * 
 * Vertical alignment utility classes for the UX4G Design System.
 */

import { formatCode } from '../utils/formatCode.js';

export default {
    title: 'UX4G/Utilities/Vertical Align',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
                component: 'Change the alignment of elements with the vertical-align utilities. Only affects inline, inline-block, inline-table, and table cell elements.',
            },
            story: {
                inline: false,
            },
...
const getReactCode = (html) => {
    ...
    return `import React from 'react';\n\nconst VerticalAlignDemo = () => (\n  <>\n${formattedJsx}\n  </>\n);\n\nexport default VerticalAlignDemo;`;
};
...
const INTRODUCTION_CONTENT = `
    <div class="ux4g-bg-neutral-soft ux4g-min-h-screen ux4g-w-screen" id="intro-container">
        ${getHeroHeader('Vertical Align Utilities Reference', 'A complete reference of all vertical alignment utility classes.')}
       ...
       <section class="ux4g-p-xl">
            <div class="">
                <div id="class-reference">
                    ...
                    <div class=" ux4g-gap-xl ux4g-mb-xl">
                        ...
                        <div class="ux4g-border ux4g-border-neutral-emphasis ux4g-bg-white ux4g-radius-l ux4g-o-hidden">
                            <div class="ux4g-bg-neutral-soft ux4g-py-m ux4g-px-l">
                                <h4 class="ux4g-label-m-strong ux4g-text-neutral-strong">Vertical Align</h4>
                            </div>
                            <div class="ux4g-p-none ux4g-hpx-400 ux4g-o-auto">
                                <table class="ux4g-table ux4g-table-bordered ux4g-m-none">
                                    <tbody>
                                        ${createTableRow('ux4g-va-baseline', 'Baseline')}
                                        ${createTableRow('ux4g-va-top', 'Top')}
                                        ${createTableRow('ux4g-va-middle', 'Middle')}
                                        ${createTableRow('ux4g-va-bottom', 'Bottom')}
                                        ${createTableRow('ux4g-va-text-top', 'Text Top')}
                                        ${createTableRow('ux4g-va-text-bottom', 'Text Bottom')}
                                    </tbody>
                                </table>
                            </div>
                        </div>
...
export const VerticalAlignShowcase = {
    render: () => `
        <div class="ux4g-bg-neutral-soft ux4g-min-h-screen">
            ${getHeroHeader('Vertical Align Showcase', 'A visual demonstration of vertical alignment utilities.')}
            <div class="ux4g-container ux4g-p-l ux4g-py-2xl">
                
                <!-- Vertical Align -->
                ${renderDemoCodeBlock('vertical-align', 'Vertical Align', 'Change the alignment of elements with the ux4g-va-* utilities.', `
                    <div class="ux4g-fs-24 ux4g-bg-neutral ux4g-p-m ux4g-radius-m">
                        <span class="ux4g-va-baseline ux4g-bg-primary-strong ux4g-p-xs  ux4g-fs-14 ">Vertical Align Baseline</span>
                        <span class="ux4g-va-top ux4g-bg-primary-strong ux4g-p-xs  ux4g-fs-14 ">Vertical Align Top</span>
                        <span class="ux4g-va-middle ux4g-bg-primary-strong ux4g-p-xs  ux4g-fs-14 ">Vertical Align Middle</span>
                        <span class="ux4g-va-bottom ux4g-bg-primary-strong ux4g-p-xs  ux4g-fs-14 ">Vertical Align Bottom</span>
                        <span class="ux4g-va-text-top ux4g-bg-primary-strong ux4g-p-xs  ux4g-fs-14 ">Vertical Align Text Top</span>
                        <span class="ux4g-va-text-bottom ux4g-bg-primary-strong ux4g-p-xs  ux4g-fs-14 ">Vertical Align Text Bottom</span>
                    </div>
                `, false, true)}
