...
import { t as require_dist } from "./jsdoc-type-pratt-parser.js";
...
function V({ startLine: e = 0, fence: t = "```", spacing: r = "compact", markers: n = f, tokenizers: s = [
	...
	let i = N({
		startLine: e,
		markers: n
	}), p = J({ fence: t }), a = R({ tokenizers: s }), c = A(r);
	return function(u) {
		let m = [];
		for (let ge of K(u)) {
			let E = i(ge);
...
function qe(e, t) {
	...
	for (let n of e.tags) if (!(t !== void 0 && !t.includes(n.tag))) if (n.tag === "ignore") {
		...
		case "argument": {
			let s = Ke(n);
			s != null && (r.params ??= [], r.params.push(s));
			break;
		}
		case "deprecated": {
			let s = Xe(n);
...
o(He, "extractReturns");
var g = (0, import_dist.stringifyRules)(), Qe = g.JsdocTypeObject;
g.JsdocTypeAny = () => "any";
...
function te(e) {
	try {
		return (0, import_dist.parse)(e, "typescript");
	} catch {
		return null;
	}
}
o(te, "extractType");
function re(e) {
	return (0, import_dist.transform)(g, e);
}
...
function ie(e) {
	...
	switch (e.name) {
		case "union": return Ze(e);
		case "signature": return rt(e);
		default: return ot(e);
	}
}
o(ie, "createType");
...
var cn = /* @__PURE__ */ o((e) => {
	let { component: t, argTypes: r, parameters: { docs: n = {} } } = e, { extractArgTypes: s } = n, i = s && t ? s(t) : {};
	return i ? (0, import_preview_api.combineParameters)(i, r) : r;
}, "enhanceArgTypes"), ye = "storybook/docs";
`${ye}`;
var yn = `${ye}/snippet-rendered`, gt = /* @__PURE__ */ ((n) => (n.AUTO = "auto", n.CODE = "code", n.DYNAMIC = "dynamic", n))(gt || {});
//#endregion
export { gt as n, yn as r, cn as t };

//# sourceMappingURL=docs-tools-BynivFlB.js.map