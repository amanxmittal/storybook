...
//#region node_modules/@storybook/addon-outline/dist/preview.mjs
...
var withOutline = (StoryFn, context) => {
	let { globals } = context, isActive = [!0, "true"].includes(globals[PARAM_KEY]), isInDocs = context.viewMode === "docs", outlineStyles = (0, import_preview_api.useMemo)(() => outlineCSS(isInDocs ? "[data-story-block=\"true\"]" : ".sb-show-main"), [context]);
...
var decorators = [withOutline], initialGlobals = { [PARAM_KEY]: !1 };
//#endregion
