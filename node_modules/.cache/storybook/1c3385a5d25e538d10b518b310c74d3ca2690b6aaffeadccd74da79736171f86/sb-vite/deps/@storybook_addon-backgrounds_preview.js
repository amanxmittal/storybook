...
//#region node_modules/@storybook/addon-backgrounds/dist/preview.mjs
...
var { document, window } = import_global.global, isReduceMotionEnabled = () => !!window?.matchMedia("(prefers-reduced-motion: reduce)")?.matches, clearStyles = (selector) => {
...
var decorators = globalThis.FEATURES?.backgroundsStoryGlobals ? [withBackgroundAndGrid] : [withGrid, withBackground], parameters = { [PARAM_KEY]: {
	grid: {
		cellSize: 20,
		opacity: .5,
		cellAmount: 5
	...
	disable: !1,
	...!globalThis.FEATURES?.backgroundsStoryGlobals && { values: Object.values(DEFAULT_BACKGROUNDS) }
} }, modern = { [PARAM_KEY]: {
	value: void 0,
	grid: !1
} }, initialGlobals = globalThis.FEATURES?.backgroundsStoryGlobals ? modern : { [PARAM_KEY]: null };
//#endregion
