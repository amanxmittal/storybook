...
import { S as getControlId, _ as __commonJS, u as MarkupIcon, x as debounce2, y as __toESM$1 } from "./dist-_W1VXIao.js";
import { t as require_react } from "./react.js";
import { S as vr } from "./theming-Byt_3Gg2.js";
import { Form as ZB, TooltipNote as a_, WithTooltip as GM } from "./@storybook_components.js";
import "./@storybook_theming.js";
//#region node_modules/@storybook/blocks/dist/Color-YHDXOIA2.mjs
...
var V = typeof window < "u" ? import_react.useLayoutEffect : import_react.useEffect, $ = function() {
...
var Wrapper = vr.div({
...
}), TooltipContent = vr.div({
	width: 200,
	margin: 5,
	".react-colorful__saturation": { borderRadius: "4px 4px 0 0" },
	".react-colorful__hue": { boxShadow: "inset 0 0 0 1px rgb(0 0 0 / 5%)" },
	".react-colorful__last-control": { borderRadius: "0 0 4px 4px" }
}), Note = vr(a_)(({ theme }) => ({ fontFamily: theme.typography.fonts.base })), Swatches = vr.div({
	display: "grid",
	...
	marginTop: 5,
	width: 200
}), SwatchColor = vr.div(({ theme, active }) => ({
	width: 16,
	height: 16,
...
})), swatchBackground = `url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity=".05"><path d="M8 0h8v8H8zM0 8h8v8H0z"/></svg>')`, Swatch = ({ value, style, ...props }) => {
	let backgroundImage = `linear-gradient(${value}, ${value}), ${swatchBackground}, linear-gradient(#fff, #fff)`;
	return import_react.createElement(SwatchColor, {
		...props,
		style: {
			...style,
			backgroundImage
...
}, Input = vr(ZB.Input)(({ theme, readOnly }) => ({
	width: "100%",
	paddingLeft: 30,
	paddingRight: 30,
	boxSizing: "border-box",
	fontFamily: theme.typography.fonts.base
})), ToggleIcon = vr(MarkupIcon)(({ theme }) => ({
	position: "absolute",
	zIndex: 1,
	top: 6,
	right: 7,
	...
	let { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(initialValue, (0, import_react.useCallback)(debounce2(onChange, 200), [onChange])), { presets, addPreset } = usePresets(presetColors, color, colorSpace), Picker = ColorPicker[colorSpace], readonly = !!argType?.table?.readonly;
	return import_react.createElement(Wrapper, { "aria-readonly": readonly }, import_react.createElement(PickerTooltip, {
		startOpen,
		trigger: readonly ? [null] : void 0,
		closeOnOutsideClick: !0,
		onVisibleChange: () => addPreset(color),
		tooltip: import_react.createElement(TooltipContent, null, import_react.createElement(Picker, {
			color: realValue === "transparent" ? "#000000" : realValue,
			onChange: updateValue,
			onFocus,
			onBlur
		}), presets.length > 0 && import_react.createElement(Swatches, null, presets.map((preset, index) => import_react.createElement(GM, {
			key: `${preset.value}-${index}`,
			hasChrome: !1,
			tooltip: import_react.createElement(Note, { note: preset.keyword || preset.value })
		}, import_react.createElement(Swatch, {
	...
	}), value ? import_react.createElement(ToggleIcon, { onClick: cycleColorSpace }) : null);
}, Color_default = ColorControl;
//#endregion
export { ColorControl, Color_default as default };

//# sourceMappingURL=Color-YHDXOIA2-cV1JDvp5.js.map