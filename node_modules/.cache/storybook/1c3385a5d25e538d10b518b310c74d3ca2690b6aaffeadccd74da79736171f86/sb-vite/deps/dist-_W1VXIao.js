import { i as __require$1, o as __toESM$1 } from "./chunk-olfrzTEO.js";
import { t as require_react } from "./react.js";
//#region node_modules/@storybook/blocks/dist/chunk-2PTXLE6R.mjs
var __create = Object.create;
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __getProtoOf = Object.getPrototypeOf, __hasOwnProp = Object.prototype.hasOwnProperty;
var __require = ((x) => typeof __require$1 < "u" ? __require$1 : typeof Proxy < "u" ? new Proxy(x, { get: (a, b) => (typeof __require$1 < "u" ? __require$1 : a)[b] }) : x)(function(x) {
...
var stringTag = "[object String]", numberTag = "[object Number]", booleanTag = "[object Boolean]", argumentsTag = "[object Arguments]";
function cloneDeep2(obj) {
	...
	switch (Object.prototype.toString.call(obj)) {
		...
		default: return cloneDeep(obj);
	}
}
var getControlId = (value) => `control-${value.replace(/\s+/g, "-")}`, getControlSetterButtonId = (value) => `set-${value.replace(/\s+/g, "-")}`;
//#endregion
//#region node_modules/@storybook/blocks/node_modules/@storybook/icons/dist/index.mjs
var import_react = /* @__PURE__ */ __toESM$1(require_react(), 1);
var ZoomIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
...
var ZoomOutIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var ZoomResetIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var EyeIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var EyeCloseIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var VideoIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var DocumentIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var MarkupIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var AddIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var SubtractIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var LinkIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var ChevronDownIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var ChevronRightIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var ChevronSmallUpIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var ChevronSmallDownIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
var UndoIcon = /* @__PURE__ */ import_react.forwardRef(({ color = "currentColor", size = 14, ...props }, forwardedRef) => {
	return /* @__PURE__ */ import_react.createElement("svg", {
		width: size,
		height: size,
		viewBox: "0 0 14 14",
...
//#endregion
export { getControlSetterButtonId as C, getControlId as S, uniq as T, __commonJS as _, ChevronSmallUpIcon as a, cloneDeep2 as b, EyeIcon as c, SubtractIcon as d, UndoIcon as f, ZoomResetIcon as g, ZoomOutIcon as h, ChevronSmallDownIcon as i, LinkIcon as l, ZoomIcon as m, ChevronDownIcon as n, DocumentIcon as o, VideoIcon as p, ChevronRightIcon as r, EyeCloseIcon as s, AddIcon as t, MarkupIcon as u, __require as v, pickBy as w, debounce2 as x, __toESM as y };

//# sourceMappingURL=dist-_W1VXIao.js.map