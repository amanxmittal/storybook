...
import { t as require_client_logger } from "./client-logger-dnTwmJBX.js";
...
import { d as z$1 } from "./csf-BRQCGJO4.js";
import "./storybook_internal_csf.js";
import { C as getControlSetterButtonId, S as getControlId, T as uniq, _ as __commonJS, a as ChevronSmallUpIcon, b as cloneDeep2, c as EyeIcon, d as SubtractIcon, f as UndoIcon, g as ZoomResetIcon, h as ZoomOutIcon, i as ChevronSmallDownIcon, l as LinkIcon, m as ZoomIcon, n as ChevronDownIcon$1, o as DocumentIcon, p as VideoIcon, r as ChevronRightIcon, s as EyeCloseIcon, t as AddIcon, v as __require, w as pickBy, y as __toESM$1 } from "./dist-_W1VXIao.js";
import { t as require_react } from "./react.js";
import { C as wt, S as vr, a as Fr, f as _e$1, i as Et, n as $u, u as Wu } from "./theming-Byt_3Gg2.js";
import { ActionBar as mu, Button as qo, Code as Au, EmptyTabContent as cp, ErrorFormatter as kB, FlexBar as is, Form as ZB, H2 as Tu, H3 as Iu, IconButton as Vl, Link as Ju, Loader as xP, ResetWrapper as Np, SyntaxHighlighter as Zg, TabsState as fp, WithTooltipPure as XM, Zoom as DB, codeCommon as _t, components as Xte, getStoryHref as AP, nameSpaceClassNames as te$1, withReset as N$1 } from "./@storybook_components.js";
import "./@storybook_theming.js";
import { n as gt, r as yn } from "./docs-tools-BynivFlB.js";
//#region node_modules/.cache/sb-vite-plugin-externals/storybook/internal/channels.js
var require_channels = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = __STORYBOOK_MODULE_CHANNELS__;
}));
//#endregion
//#region node_modules/@storybook/blocks/dist/index.mjs
		...
		return function e2(t2, n2, r2) {
			function s2(o3, u2) {
				if (!n2[o3]) {
					if (!t2[o3]) {
						...
						var f3 = /* @__PURE__ */ new Error("Cannot find module '" + o3 + "'");
			...
			2: [function(_dereq_, module3, exports3) {
				...
				Similar.prototype.get = function(key2) {
					...
					var index;
					return this.lastItem && this.isEqual(this.lastItem.key, key2) ? (this.lastItem.val = val, this) : (index = this.indexOf(key2), index >= 0 ? (this.lastItem = this.list[index], this.list[index].val = val, this) : (this.lastItem = {
						key: key2,
						val
					...
					var index;
					return this.lastItem && this.isEqual(this.lastItem.key, key2) ? !0 : (index = this.indexOf(key2), index >= 0 ? (this.lastItem = this.list[index], !0) : !1);
...
var require_default_options = __commonJS({ "../../node_modules/tocbot/src/js/default-options.js"(exports, module) {
	module.exports = {
		tocSelector: ".js-toc",
...
var require_build_html = __commonJS({ "../../node_modules/tocbot/src/js/build-html.js"(exports, module) {
	module.exports = function(options2) {
		var forEach = [].forEach, some = [].some, body = document.body, tocElement, currentlyHighlighting = !0, SPACE_CHAR = " ";
		...
		function updateFixedSidebarClass() {
			if (options2.scrollContainer && document.querySelector(options2.scrollContainer)) var top = document.querySelector(options2.scrollContainer).scrollTop;
		...
		function updateToc(headingsArray) {
			...
			if (currentlyHighlighting && tocElement !== null && headings.length > 0) {
				some.call(headings, function(heading, i2) {
					if (getHeadingTopPos(heading) > top + options2.headingsOffset + 10) return topHeader = headings[i2 === 0 ? i2 : i2 - 1], !0;
					else if (i2 === headings.length - 1) return topHeader = headings[headings.length - 1], !0;
				});
		...
		function disableTocAnimation(event) {
			...
			typeof target.className != "string" || target.className.indexOf(options2.linkClass) === -1 || (currentlyHighlighting = !1);
		}
...
var require_parse_content = __commonJS({ "../../node_modules/tocbot/src/js/parse-content.js"(exports, module) {
	module.exports = function(options2) {
		var reduce = [].reduce;
		...
		function addNode(node, nest) {
			for (var obj = getHeadingObject(node), level = obj.headingLevel, array2 = nest, lastItem = getLastItem(array2), counter = level - (lastItem ? lastItem.headingLevel : 0); counter > 0 && (lastItem = getLastItem(array2), !(lastItem && level === lastItem.headingLevel));) lastItem && lastItem.children !== void 0 && (array2 = lastItem.children), counter--;
			return level >= options2.collapseDepth && (obj.isCollapsed = !0), array2.push(obj), array2;
		}
...
var require_update_toc_scroll = __commonJS({ "../../node_modules/tocbot/src/js/update-toc-scroll.js"(exports, module) {
	module.exports = function(options2) {
...
var require_scroll_smooth = __commonJS({ "../../node_modules/tocbot/src/js/scroll-smooth/index.js"(exports) {
	...
	function initSmoothScrolling(options2) {
		...
		function delegatedLinkHijacking() {
			...
			function onClick(e2) {
				!isInPageLink(e2.target) || e2.target.className.indexOf("no-smooth-scroll") > -1 || e2.target.href.charAt(e2.target.href.length - 2) === "#" && e2.target.href.charAt(e2.target.href.length - 1) === "!" || e2.target.className.indexOf(options2.linkClass) === -1 || jump(e2.target.hash, {
					duration,
					offset,
					callback: function() {
...
var require_js = __commonJS({ "../../node_modules/tocbot/src/js/index.js"(exports, module) {
	(function(root3, factory) {
		...
		return tocbot2.destroy = function() {
			...
			tocElement !== null && (options2.skipRendering || tocElement && (tocElement.innerHTML = ""), options2.scrollContainer && document.querySelector(options2.scrollContainer) ? (document.querySelector(options2.scrollContainer).removeEventListener("scroll", this._scrollListener, !1), document.querySelector(options2.scrollContainer).removeEventListener("resize", this._scrollListener, !1), buildHtml && document.querySelector(options2.scrollContainer).removeEventListener("click", this._clickListener, !1)) : (document.removeEventListener("scroll", this._scrollListener, !1), document.removeEventListener("resize", this._scrollListener, !1), buildHtml && document.removeEventListener("click", this._clickListener, !1)));
			...
			if (supports) {
				...
				if (contentElement !== null) {
					...
					if (tocElement !== null && (headingsArray = parseContent.selectHeadings(contentElement, options2.headingSelector), headingsArray !== null)) {
						var nestedHeadings = parseContent.nestHeadingsArray(headingsArray).nest;
						...
						}, options2.throttleTimeout), this._scrollListener(), options2.scrollContainer && document.querySelector(options2.scrollContainer) ? (document.querySelector(options2.scrollContainer).addEventListener("scroll", this._scrollListener, !1), document.querySelector(options2.scrollContainer).addEventListener("resize", this._scrollListener, !1)) : (document.addEventListener("scroll", this._scrollListener, !1), document.addEventListener("resize", this._scrollListener, !1));
						var timeout = null;
						...
						}, options2.throttleTimeout), options2.scrollContainer && document.querySelector(options2.scrollContainer) ? document.querySelector(options2.scrollContainer).addEventListener("click", this._clickListener, !1) : document.addEventListener("click", this._clickListener, !1), this;
					}
				}
			}
...
function _wrapNativeSuper(t2) {
	...
	return _wrapNativeSuper = function(t3) {
		...
		return Wrapper12.prototype = Object.create(t3.prototype, { constructor: {
			value: Wrapper12,
			enumerable: !1,
			writable: !0,
			configurable: !0
...
})), EmptyBlock = (props) => import_react.createElement(Wrapper, {
	...props,
	className: "docblock-emptyblock sb-unstyled"
});
var StyledSyntaxHighlighter = vr(Zg)(({ theme }) => ({
...
var SourceSkeletonWrapper = vr.div(({ theme }) => ({
...
})), SourceSkeletonPlaceholder = vr.div(({ theme }) => ({
	animation: `${theme.animation.glow} 1.5s ease-in-out infinite`,
	background: theme.appBorderColor,
	height: 17,
	marginTop: 1,
	width: "60%",
	[`&:first-child${Wu}`]: { margin: 0 }
})), SourceSkeleton = () => import_react.createElement(SourceSkeletonWrapper, null, import_react.createElement(SourceSkeletonPlaceholder, null), import_react.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }), import_react.createElement(SourceSkeletonPlaceholder, { style: { width: "30%" } }), import_react.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } })), Source = ({ isLoading, error, language, code, dark, format: format3 = !1, ...rest }) => {
	let { typography } = wt();
	...
	let overrideTheme = dark ? _e$1.dark : _e$1.light;
	return import_react.createElement(Et, { theme: Fr({
		...overrideTheme,
		fontCode: typography.fonts.mono,
		fontBase: typography.fonts.base
	}) }, syntaxHighlighter);
};
var toGlobalSelector = (element) => `& :where(${element}:not(.sb-anchor, .sb-unstyled, .sb-unstyled ${element}))`, breakpoint = 600, Title = vr.h1(N$1, ({ theme }) => ({
	...
	gap: "3rem",
	[`@media (min-width: ${breakpoint}px)`]: {}
})), DocsPageWrapper = ({ children, toc }) => import_react.createElement(DocsWrapper, { className: "sbdocs sbdocs-wrapper" }, import_react.createElement(DocsContent, { className: "sbdocs sbdocs-content" }, children), toc);
...
var { window: globalWindow } = globalThis, IFrame = class extends import_react.Component {
	constructor() {
		super(...arguments);
		this.iframe = null;
	}
...
var { PREVIEW_URL } = globalThis, BASE_URL = PREVIEW_URL || "iframe.html", storyBlockIdFromId = ({ story, primary }) => `story--${story.id}${primary ? "--primary" : ""}`, InlineStory = (props) => {
	...
	id: `iframe--${story.id}`,
	title: story.name,
	src: AP(BASE_URL, story.id, { viewMode: "story" }),
	allowFullScreen: !0,
	scale,
	style: {
		width: "100%",
...
}))), ErrorMessage = vr.strong(({ theme }) => ({ color: theme.color.orange })), Story = (props) => {
	let { inline, story } = props;
	return inline && !props.autoplay && story.usesMount ? import_react.createElement(ErrorMessage, null, "This story mounts inside of play. Set", " ", import_react.createElement("a", { href: "https://storybook.js.org/docs/api/doc-blocks/doc-block-story#autoplay" }, "autoplay"), " ", "to true to view this story.") : import_react.createElement("div", {
...
}, StorySkeleton = () => import_react.createElement(xP, null);
var Bar = vr(is)({
	position: "absolute",
	left: 0,
	right: 0,
	...
	animation: `${theme.animation.glow} 1.5s ease-in-out infinite`
})), Toolbar = ({ isLoading, storyId, baseUrl, zoom, resetZoom, ...rest }) => import_react.createElement(Bar, { ...rest }, import_react.createElement(Wrapper2, { key: "left" }, isLoading ? [
	1,
	2,
	3
].map((key2) => import_react.createElement(IconPlaceholder, { key: key2 })) : import_react.createElement(import_react.Fragment, null, import_react.createElement(Vl, {
	key: "zoomin",
	onClick: (e2) => {
		e2.preventDefault(), zoom(.8);
	},
	title: "Zoom in"
}, import_react.createElement(ZoomIcon, null)), import_react.createElement(Vl, {
	key: "zoomout",
	onClick: (e2) => {
		e2.preventDefault(), zoom(1.25);
	},
	title: "Zoom out"
}, import_react.createElement(ZoomOutIcon, null)), import_react.createElement(Vl, {
	key: "zoomreset",
	onClick: (e2) => {
		e2.preventDefault(), resetZoom();
	},
	title: "Reset zoom"
}, import_react.createElement(ZoomResetIcon, null)))));
var ChildrenContainer = vr.div(({ isColumn, columns, layout }) => ({
	...
	alignContent: "center",
	alignItems: "center"
} : {}, ({ columns }) => columns && columns > 1 ? { ".innerZoomElementWrapper > *": { minWidth: `calc(100% / ${columns} - 20px)` } } : {}), StyledSource = vr(Source)(({ theme }) => ({
	margin: 0,
...
})), PreviewContainer = vr.div(({ theme, withSource, isExpanded }) => ({
	position: "relative",
	overflow: "hidden",
	margin: "25px 0 40px",
	...
	"h3 + &": { marginTop: "16px" }
}), ({ withToolbar }) => withToolbar && { paddingTop: 40 }), getSource = (withSource, expanded, setExpanded) => {
	switch (!0) {
...
var PositionedToolbar = vr(Toolbar)({
	position: "absolute",
	top: 0,
	left: 0,
	right: 0,
	...
	overflow: "hidden",
	position: "relative"
}), Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = !1, isExpanded = !1, additionalActions, className, layout = "padded", ...props }) => {
	let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat([
		"sbdocs",
		"sbdocs-preview",
		"sb-unstyled"
	]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
	...
	return import_react.createElement(PreviewContainer, {
		withSource,
		withToolbar,
		...props,
		...
		baseUrl: "./iframe.html"
	}), import_react.createElement(ZoomContext.Provider, { value: { scale } }, import_react.createElement(Relative, {
		className: "docs-story",
		onCopyCapture: withSource && onCopyCapture
	}, import_react.createElement(ChildrenContainer, {
		isColumn: isColumn || !Array.isArray(children),
		columns,
		layout
	}, import_react.createElement(DB.Element, { scale }, Array.isArray(children) ? children.map((child, i2) => import_react.createElement("div", { key: i2 }, child)) : import_react.createElement("div", null, children))), import_react.createElement(mu, { actionItems }))), withSource && expanded && source2);
};
vr(Preview)(() => ({ ".docs-story": {
	paddingTop: 32,
	paddingBottom: 40
} }));
function t() {
...
`) !== -1 || d2 && c2;
					...
					r2.list = !0, p2 ? (r2.inline = !1, h2 = s2.replace(le, `
...
var Se = new RegExp(`^\\[((?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*)\\]\\(\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*\\)`), Ce = /^!\[(.*?)\]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/, $e = [
	p,
	g,
	y,
	w,
...
function Le(e2, t2, n2, i2) {
	let l2 = n2.inTable;
	n2.inTable = !0;
	let a2 = e2.trim().split(/( *(?:`[^`]*`|\\\||\|) *)/).reduce((e3, l3) => (l3.trim() === "|" ? e3.push(i2 ? { type: r.tableSeparator } : {
		type: r.text,
		text: l3
	}) : l3 !== "" && e3.push.apply(e3, t2(l3, n2)), e3), []);
	n2.inTable = l2;
	let o2 = [[]];
...
function Ne(e2, t2, n2) {
	let r2 = n2.inline || !1, i2 = n2.simple || !1;
...
function Ze(n2 = "", i2 = {}) {
	...
	function W2(e2) {
		e2 = e2.replace($, "");
		let t2 = !1;
		i2.forceInline ? t2 = !0 : i2.forceBlock || (t2 = _.test(e2) === !1);
...
`, { inline: t2 }));
	...
	i2.overrides = i2.overrides || {}, i2.sanitizer = i2.sanitizer || Ue, i2.slugify = i2.slugify || we, i2.namedCodesToUnicode = i2.namedCodesToUnicode ? t({}, a, i2.namedCodesToUnicode) : a, i2.createElement = i2.createElement || import_react.createElement;
	let q2 = [], Q2 = {}, V2 = {
		[r.blockQuote]: {
			match: Me(p),
			order: 1,
			...
			render(e2, t2, n3) {
				let l2 = { key: n3.key };
				return e2.alert && (l2.className = "markdown-alert-" + i2.slugify(e2.alert.toLowerCase(), we), e2.children.unshift({
					attrs: {},
					children: [{
						type: r.text,
						text: e2.alert
					...
					type: r.htmlBlock,
					tag: "header"
				})), d2("blockquote", l2, t2(e2.children, n3));
			}
		},
		[r.breakLine]: {
			match: Re(h),
		...
		[r.codeBlock]: {
			...
			render: (e2, n3, r2) => d2("pre", { key: r2.key }, d2("code", t({}, e2.attrs, { className: e2.lang ? `lang-${e2.lang}` : "" }), e2.text))
		},
		[r.codeFenced]: {
			match: Me(g),
			order: 0,
		...
		[r.footnoteReference]: {
			...
			order: 1,
			parse: (e2) => ({
				target: `#${i2.slugify(e2[1], we)}`,
				text: e2[1]
			}),
			render: (e2, t2, n3) => d2("a", {
				key: n3.key,
		...
		[r.gfmTask]: {
			match: Oe(E),
			order: 1,
			parse: (e2) => ({ completed: e2[1].toLowerCase() === "x" }),
			render: (e2, t2, n3) => d2("input", {
		...
		[r.heading]: {
			match: Me(i2.enforceAtxHeadings ? z : w),
			order: 1,
			parse: (e2, t2, n3) => ({
				children: Ne(t2, e2[2], n3),
				id: i2.slugify(e2[2], we),
				level: e2[1].length
			}),
			render: (e2, t2, n3) => d2(`h${e2.level}`, {
				id: e2.id,
				key: n3.key
			}, t2(e2.children, n3))
		},
		...
		[r.htmlBlock]: {
			...
			parse(e2, t2, n3) {
				...
				var c2;
				let s2 = e2[1].toLowerCase(), d3 = o.indexOf(s2) !== -1, p2 = (d3 ? s2 : e2[1]).trim(), u2 = {
					attrs: Z2(p2, e2[2]),
					noInnerParse: d3,
					tag: p2
				};
				return n3.inAnchor = n3.inAnchor || s2 === "a", d3 ? u2.text = e2[3] : u2.children = a2(t2, l2, n3), n3.inAnchor = !1, u2;
			},
			render: (e2, n3, r2) => d2(e2.tag, t({ key: r2.key }, e2.attrs), e2.text || (e2.children ? n3(e2.children, r2) : ""))
		},
		[r.htmlSelfClosing]: {
			match: Re(M),
			order: 1,
		...
		[r.linkBareUrlDetector]: {
			match: (e2, t2) => t2.inAnchor || i2.disableAutoLink ? null : Oe(I)(e2, t2),
			order: 0,
			parse: (e2) => ({
				children: [{
					text: e2[1],
...
`
		...
		[r.refImage]: {
			...
			render: (e2, t2, n3) => Q2[e2.ref] ? d2("img", {
				key: n3.key,
				alt: e2.alt,
		...
		[r.refLink]: {
			...
			render: (e2, t2, n3) => Q2[e2.ref] ? d2("a", {
				key: n3.key,
				href: i2.sanitizer(Q2[e2.ref].target, "a", "href"),
				title: Q2[e2.ref].title
			}, t2(e2.children, n3)) : d2("span", { key: n3.key }, e2.fallbackChildren)
		},
		[r.table]: {
			match: Me(j),
			order: 1,
		...
		[r.text]: {
			match: Re(te),
			order: 4,
			parse: (e2) => ({ text: e2[0].replace(T, (e3, t2) => i2.namedCodesToUnicode[t2] ? i2.namedCodesToUnicode[t2] : e3) }),
			render: (e2) => e2.text
		},
		[r.textBolded]: {
			match: Be(X),
			...
			render: (e2, t2, n3) => d2("strong", { key: n3.key }, t2(e2.children, n3))
		},
		[r.textEmphasized]: {
			match: Be(J),
			order: 3,
	...
	i2.disableParsingRawHTML === !0 && (delete V2[r.htmlBlock], delete V2[r.htmlSelfClosing]);
	let ie2 = function(e2) {
...
`).replace(C, "").replace(G, "    ");
	...
	return q2.length ? d2("div", null, oe2, d2("footer", { key: "footer" }, q2.map(function(e2) {
		return d2("div", {
			id: i2.slugify(e2.identifier, we),
			key: e2.identifier
		}, e2.identifier, le2(ie2(e2.footnote, { inline: !0 })));
	}))) : oe2;
}
var index_modern_default = (t2) => {
	...
	return import_react.cloneElement(Ze(r2, i2), l2);
};
var Label = vr.label(({ theme }) => ({
	lineHeight: "18px",
	alignItems: "center",
	marginBottom: 8,
	display: "inline-block",
...
})), parse = (value3) => value3 === "true", BooleanControl = ({ name: name2, value: value3, onChange, onBlur, onFocus, argType }) => {
	let onSetFalse = (0, import_react.useCallback)(() => onChange(!1), [onChange]), readonly = !!argType?.table?.readonly;
	if (value3 === void 0) return import_react.createElement(qo, {
		variant: "outline",
		size: "medium",
...
var parseDate = (value3) => {
...
}, FormInput = vr(ZB.Input)(({ readOnly }) => ({ opacity: readOnly ? .5 : 1 })), FlexSpaced = vr.div(({ theme }) => ({
	flex: 1,
	display: "flex",
	input: {
		marginLeft: 10,
...
})), DateControl = ({ name: name2, value: value3, onChange, onFocus, onBlur, argType }) => {
	...
	(0, import_react.useEffect)(() => {
		valid !== !1 && (dateRef && dateRef.current && (dateRef.current.value = value3 ? formatDate(value3) : ""), timeRef && timeRef.current && (timeRef.current.value = value3 ? formatTime(value3) : ""));
	}, [value3]);
	let onDateChange = (e2) => {
	...
	return import_react.createElement(FlexSpaced, null, import_react.createElement(FormInput, {
		type: "date",
		max: "9999-12-31",
		ref: dateRef,
		id: `${controlId}-date`,
		...
		onFocus,
		onBlur
	}), import_react.createElement(FormInput, {
		type: "time",
		id: `${controlId}-time`,
		name: `${controlId}-time`,
		ref: timeRef,
...
var Wrapper3 = vr.label({ display: "flex" }), parse2 = (value3) => {
	let result2 = parseFloat(value3);
	return Number.isNaN(result2) ? void 0 : result2;
}, format2 = (value3) => value3 != null ? String(value3) : "", FormInput2 = vr(ZB.Input)(({ readOnly }) => ({ opacity: readOnly ? .5 : 1 })), NumberControl = ({ name: name2, value: value3, onChange, min, max, step, onBlur, onFocus, argType }) => {
	let [inputValue, setInputValue] = (0, import_react.useState)(typeof value3 == "number" ? value3 : ""), [forceVisible, setForceVisible] = (0, import_react.useState)(!1), [parseError, setParseError] = (0, import_react.useState)(null), readonly = !!argType?.table?.readonly, handleChange = (0, import_react.useCallback)((event) => {
		setInputValue(event.target.value);
		let result2 = parseFloat(event.target.value);
		Number.isNaN(result2) ? setParseError(/* @__PURE__ */ new Error(`'${event.target.value}' is not a number`)) : (onChange(result2), setParseError(null));
	...
	}, [value3]), value3 === void 0 ? import_react.createElement(qo, {
		variant: "outline",
		size: "medium",
		id: getControlSetterButtonId(name2),
		onClick: onForceVisible,
		disabled: readonly
	}, "Set number") : import_react.createElement(Wrapper3, null, import_react.createElement(FormInput2, {
		ref: htmlElRef,
...
}, selectedKeys = (value3, options2) => value3 && options2 ? Object.entries(options2).filter((entry) => value3.includes(entry[1])).map((entry) => entry[0]) : [], selectedValues = (keys, options2) => keys && options2 && keys.map((key2) => options2[key2]);
var Wrapper4 = vr.div(({ isInline }) => isInline ? {
	display: "flex",
	flexWrap: "wrap",
...
} : { label: { display: "flex" } }, (props) => {
	if (props["aria-readonly"] === "true") return { input: { cursor: "not-allowed" } };
}), Text = vr.span({ "[aria-readonly=true] &": { opacity: .5 } }), Label2 = vr.label({
	lineHeight: "20px",
	alignItems: "center",
	marginBottom: 8,
	"&:last-child": { marginBottom: 0 },
...
}), CheckboxControl = ({ name: name2, options: options2, value: value3, onChange, isInline, argType }) => {
	if (!options2) return import_client_logger.logger.warn(`Checkbox with no options: ${name2}`), import_react.createElement(import_react.Fragment, null, "-");
	let [selected, setSelected] = (0, import_react.useState)(selectedKeys(value3, options2)), readonly = !!argType?.table?.readonly, handleChange = (e2) => {
	...
	return import_react.createElement(Wrapper4, {
		...
		return import_react.createElement(Label2, {
			...
			value: key2,
			onChange: handleChange,
			checked: selected?.includes(key2)
		}), import_react.createElement(Text, null, key2));
	}));
};
var Wrapper5 = vr.div(({ isInline }) => isInline ? {
	display: "flex",
	flexWrap: "wrap",
	alignItems: "flex-start",
	label: {
	...
	if (props["aria-readonly"] === "true") return { input: { cursor: "not-allowed" } };
}), Text2 = vr.span({ "[aria-readonly=true] &": { opacity: .5 } }), Label3 = vr.label({
	lineHeight: "20px",
	alignItems: "center",
	marginBottom: 8,
	"&:last-child": { marginBottom: 0 },
...
}), RadioControl = ({ name: name2, options: options2, value: value3, onChange, isInline, argType }) => {
	if (!options2) return import_client_logger.logger.warn(`Radio with no options: ${name2}`), import_react.createElement(import_react.Fragment, null, "-");
	let selection = selectedKey(value3, options2), controlId = getControlId(name2), readonly = !!argType?.table?.readonly;
	return import_react.createElement(Wrapper5, {
		"aria-readonly": readonly,
		isInline
	}, Object.keys(options2).map((key2, index) => {
		let id = `${controlId}-${index}`;
		...
		}), import_react.createElement(Text2, null, key2));
	}));
};
var OptionsSelect = vr.select({
	appearance: "none",
	border: "0 none",
	boxSizing: "inherit",
	display: " block",
...
})), NO_SELECTION = "Choose option...", SingleSelect = ({ name: name2, value: value3, options: options2, onChange, argType }) => {
	let handleChange = (e2) => {
	...
	return import_react.createElement(SelectWrapper, null, import_react.createElement(ChevronSmallDownIcon, null), import_react.createElement(OptionsSelect, {
		disabled: readonly,
		id: controlId,
		value: selection,
		onChange: handleChange
		...
		key: "no-selection",
		disabled: !0
	}, NO_SELECTION), Object.keys(options2).map((key2) => import_react.createElement("option", {
		key: key2,
		value: key2
	}, key2))));
}, MultiSelect = ({ name: name2, value: value3, options: options2, onChange, argType }) => {
	let handleChange = (e2) => {
		onChange(selectedValues(Array.from(e2.currentTarget.options).filter((option) => option.selected).map((option) => option.value), options2));
	}, selection = selectedKeys(value3, options2), controlId = getControlId(name2), readonly = !!argType?.table?.readonly;
	return import_react.createElement(SelectWrapper, null, import_react.createElement(OptionsSelect, {
		disabled: readonly,
		id: controlId,
		multiple: !0,
		value: selection,
		onChange: handleChange
	}, Object.keys(options2).map((key2) => import_react.createElement("option", {
		key: key2,
		value: key2
	}, key2))));
}, SelectControl = (props) => {
	let { name: name2, options: options2 } = props;
	return options2 ? props.isMulti ? import_react.createElement(MultiSelect, { ...props }) : import_react.createElement(SingleSelect, { ...props }) : (import_client_logger.logger.warn(`Select with no options: ${name2}`), import_react.createElement(import_react.Fragment, null, "-"));
};
var normalizeOptions = (options2, labels) => Array.isArray(options2) ? options2.reduce((acc, item) => (acc[labels?.[item] || String(item)] = item, acc), {}) : options2, Controls = {
...
var JsonAddValue = class extends import_react.Component {
	...
	onSubmit() {
		...
		result2.newValue = onSubmitValueParser(!1, keyPath, deep, result2.key, inputRefValue.value), handleAdd(result2);
	}
	refInputKey(node) {
	...
	render() {
		let { handleCancel, onlyValue, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep } = this.props, addButtonElementLayout = (0, import_react.cloneElement)(addButtonElement, { onClick: this.onSubmit }), cancelButtonElementLayout = (0, import_react.cloneElement)(cancelButtonElement, { onClick: handleCancel }), inputElementValueLayout = (0, import_react.cloneElement)(inputElementGenerator(VALUE, keyPath, deep), {
			placeholder: "Value",
		...
		return import_react.createElement("span", { className: "rejt-add-value-node" }, inputElementKeyLayout, inputElementValueLayout, cancelButtonElementLayout, addButtonElementLayout);
	}
};
...
var JsonArray = class extends import_react.Component {
	...
	handleAddValueAdd({ newValue }) {
		...
		beforeAddAction(data.length, keyPath, deep, newValue).then(() => {
			...
			let { onUpdate, onDeltaUpdate } = this.props;
			onUpdate(keyPath[keyPath.length - 1], newData), onDeltaUpdate({
				type: ADD_DELTA_TYPE,
				keyPath,
				deep,
	...
	renderCollapsed() {
		let { name: name2, data, keyPath, deep } = this.state, { handleRemove, readOnly, getStyle, dataType, minusMenuElement } = this.props, { minus, collapsed } = getStyle(name2, data, keyPath, deep, dataType), isReadOnly = readOnly(name2, data, keyPath, deep, dataType), removeItemButton = (0, import_react.cloneElement)(minusMenuElement, {
			onClick: handleRemove,
			className: "rejt-minus-menu",
			style: minus
		});
		return import_react.createElement("span", { className: "rejt-collapsed" }, import_react.createElement("span", {
	...
	renderNotCollapsed() {
		...
		return import_react.createElement("span", { className: "rejt-not-collapsed" }, import_react.createElement("span", {
			className: "rejt-not-collapsed-delimiter",
			style: delimiter
		}, "["), !addFormVisible && addItemButton, import_react.createElement("ul", {
			className: "rejt-not-collapsed-list",
			style: ul
		}, data.map((item, index) => import_react.createElement(JsonNode, {
			key: index,
			name: index.toString(),
			data: item,
			keyPath,
			...
			logger: logger4,
			onSubmitValueParser
		}))), !isReadOnly && addFormVisible && import_react.createElement("div", {
	...
	render() {
		...
		return import_react.createElement("div", { className: "rejt-array-node" }, import_react.createElement("span", { onClick: this.handleCollapseMode }, import_react.createElement("span", {
			className: "rejt-name",
			style: style.name
		}, name2, " :", " ")), value3);
	}
...
var JsonFunctionValue = class extends import_react.Component {
	...
	handleEdit() {
		...
		if (!inputRef) return;
		let newValue = onSubmitValueParser(!0, keyPath, deep, name2, inputRef.value);
		handleUpdateValue({
			value: newValue,
			key: name2
		}).then(() => {
	...
	render() {
		...
		if (editEnabled && !resultOnlyResult) {
			...
			result2 = import_react.createElement("span", {
				className: "rejt-edit-form",
				style: style.editForm
			}, textareaElementLayout, " ", cancelButtonElementLayout, editButtonElementLayout), minusElement = null;
		} else {
			result2 = import_react.createElement("span", {
...
JsonFunctionValue.defaultProps = {
	...
	deep: 0,
	handleUpdateValue: () => {},
	editButtonElement: import_react.createElement("button", null, "e"),
	cancelButtonElement: import_react.createElement("button", null, "c"),
	minusMenuElement: import_react.createElement("span", null, " - ")
};
...
var JsonObject = class extends import_react.Component {
	...
	renderCollapsed() {
		let { name: name2, keyPath, deep, data } = this.state, { handleRemove, readOnly, dataType, getStyle, minusMenuElement } = this.props, { minus, collapsed } = getStyle(name2, data, keyPath, deep, dataType), keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name2, data, keyPath, deep, dataType), removeItemButton = (0, import_react.cloneElement)(minusMenuElement, {
			onClick: handleRemove,
			className: "rejt-minus-menu",
			style: minus
		});
	...
	renderNotCollapsed() {
		let { name: name2, data, keyPath, deep, nextDeep, addFormVisible } = this.state, { isCollapsed, handleRemove, onDeltaUpdate, readOnly, getStyle, dataType, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser } = this.props, { minus, plus, addForm, ul, delimiter } = getStyle(name2, data, keyPath, deep, dataType), keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name2, data, keyPath, deep, dataType), addItemButton = (0, import_react.cloneElement)(plusMenuElement, {
			...
			className: "rejt-minus-menu",
			style: minus
		}), list = keyList.map((key2) => import_react.createElement(JsonNode, {
			key: key2,
			name: key2,
			data: data[key2],
			keyPath,
		...
		return import_react.createElement("span", { className: "rejt-not-collapsed" }, import_react.createElement("span", {
			className: "rejt-not-collapsed-delimiter",
			style: delimiter
		}, "{"), !isReadOnly && addItemButton, import_react.createElement("ul", {
			className: "rejt-not-collapsed-list",
			style: ul
		}, list), !isReadOnly && addFormVisible && import_react.createElement("div", {
			className: "rejt-add-form",
			style: addForm
		}, import_react.createElement(JsonAddValue, {
			handleAdd: this.handleAddValueAdd,
	...
	render() {
		...
		return import_react.createElement("div", { className: "rejt-object-node" }, import_react.createElement("span", { onClick: this.handleCollapseMode }, import_react.createElement("span", {
			className: "rejt-name",
			style: style.name
		}, name2, " :", " ")), value3);
	}
...
var JsonValue = class extends import_react.Component {
	...
	render() {
		let { name: name2, value: value3, editEnabled, keyPath, deep } = this.state, { handleRemove, originalValue, readOnly, dataType, getStyle, editButtonElement, cancelButtonElement, inputElementGenerator, minusMenuElement, keyPath: comeFromKeyPath } = this.props, style = getStyle(name2, originalValue, keyPath, deep, dataType), isReadOnly = readOnly(name2, originalValue, keyPath, deep, dataType), isEditing = editEnabled && !isReadOnly, inputElement = inputElementGenerator(VALUE, comeFromKeyPath, deep, name2, originalValue, dataType), editButtonElementLayout = (0, import_react.cloneElement)(editButtonElement, { onClick: this.handleEdit }), cancelButtonElementLayout = (0, import_react.cloneElement)(cancelButtonElement, { onClick: this.handleCancelEdit }), inputElementLayout = (0, import_react.cloneElement)(inputElement, {
			ref: this.refInput,
		...
		return import_react.createElement("li", {
			...
			className: "rejt-name",
			style: style.name
		}, name2, " : "), isEditing ? import_react.createElement("span", {
			className: "rejt-edit-form",
			style: style.editForm
		}, inputElementLayout, " ", cancelButtonElementLayout, editButtonElementLayout) : import_react.createElement("span", {
			className: "rejt-value",
			style: style.value,
			onClick: isReadOnly ? null : this.handleEditMode
		}, String(value3)), !isReadOnly && !isEditing && minusMenuLayout);
	}
};
...
JsonTree.defaultProps = {
	...
	logger: { error: () => {} },
	onSubmitValueParser: (isEditMode, keyPath, deep, name2, rawValue) => parse3(rawValue),
	inputElement: () => import_react.createElement("input", null),
	textareaElement: () => import_react.createElement("textarea", null),
	fallback: null
};
var { window: globalWindow2 } = globalThis, Wrapper6 = vr.div(({ theme }) => ({
	position: "relative",
	display: "flex",
	"&[aria-readonly=\"true\"]": { opacity: .5 },
	".rejt-tree": {
		marginLeft: "1rem",
		fontSize: "13px"
	},
	".rejt-value-node, .rejt-object-node > .rejt-collapsed, .rejt-array-node > .rejt-collapsed, .rejt-object-node > .rejt-not-collapsed, .rejt-array-node > .rejt-not-collapsed": { "& > svg": {
		opacity: 0,
...
})), ButtonInline = vr.button(({ theme, primary }) => ({
	border: 0,
	height: 20,
	margin: 1,
	borderRadius: 4,
...
})), ActionAddIcon = vr(AddIcon)(({ theme, disabled }) => ({
	display: "inline-block",
	...
	"svg + &": { marginLeft: 0 }
})), ActionSubstractIcon = vr(SubtractIcon)(({ theme, disabled }) => ({
	display: "inline-block",
	verticalAlign: "middle",
	width: 15,
	height: 15,
	...
	"svg + &": { marginLeft: 0 }
})), Input = vr.input(({ theme, placeholder }) => ({
	outline: 0,
	...
	if ((0, import_react.useEffect)(() => {
		forceVisible && htmlElRef.current && htmlElRef.current.select();
	}, [forceVisible]), !hasData) return import_react.createElement(qo, {
		disabled: readonly,
		id: getControlSetterButtonId(name2),
		onClick: onForceVisible
	}, "Set object");
	let rawJSONForm = import_react.createElement(RawInput, {
		...
		id: getControlId(name2),
		name: name2,
		defaultValue: value3 === null ? "" : JSON.stringify(value3, null, 2),
		onBlur: (event) => updateRaw(event.target.value),
		placeholder: "Edit JSON string...",
		autoFocus: forceVisible,
		valid: parseError ? "error" : null,
		readOnly: readonly
	}), isObjectOrArray = Array.isArray(value3) || typeof value3 == "object" && value3?.constructor === Object;
	return import_react.createElement(Wrapper6, { "aria-readonly": readonly }, isObjectOrArray && import_react.createElement(RawButton, { onClick: (e2) => {
		e2.preventDefault(), setShowRaw((v2) => !v2);
	} }, showRaw ? import_react.createElement(EyeCloseIcon, null) : import_react.createElement(EyeIcon, null), import_react.createElement("span", null, "RAW")), showRaw ? rawJSONForm : import_react.createElement(JsonTree, {
		...
		editButtonElement: import_react.createElement(ButtonInline, { type: "submit" }, "Save"),
		addButtonElement: import_react.createElement(ButtonInline, {
			type: "submit",
			primary: !0
		}, "Save"),
		plusMenuElement: import_react.createElement(ActionAddIcon, null),
		minusMenuElement: import_react.createElement(ActionSubstractIcon, null),
		inputElement: (_2, __, ___, key2) => key2 ? import_react.createElement(Input, {
			onFocus: selectValue,
...
var RangeInput = vr.input(({ theme, min, max, value: value3, disabled }) => ({
	"&": {
		width: "100%",
	...
	"&:focus": {
		outline: "none",
		"&::-webkit-slider-runnable-track": { borderColor: rgba(theme.color.secondary, .4) },
		"&::-webkit-slider-thumb": {
	...
	"[aria-readonly=true] &": { opacity: .5 }
}), RangeCurrentAndMaxLabel = vr(RangeLabel)(({ numberOFDecimalsPlaces, max }) => ({
...
var RangeControl = ({ name: name2, value: value3, onChange, min = 0, max = 100, step = 1, onBlur, onFocus, argType }) => {
	...
	return import_react.createElement(RangeWrapper, { "aria-readonly": readonly }, import_react.createElement(RangeLabel, null, min), import_react.createElement(RangeInput, {
		id: getControlId(name2),
		type: "range",
		disabled: readonly,
		onChange: handleChange,
		...
		max
	}, hasValue ? value3.toFixed(numberOFDecimalsPlaces) : "--", " / ", max));
};
var Wrapper7 = vr.label({ display: "flex" }), MaxLength = vr.div(({ isMaxed }) => ({
	marginLeft: "0.75rem",
	paddingTop: "0.35rem",
	color: isMaxed ? "red" : void 0
})), TextControl = ({ name: name2, value: value3, onChange, onFocus, onBlur, maxLength, argType }) => {
	let handleChange = (event) => {
	...
	return import_react.createElement(Wrapper7, null, import_react.createElement(ZB.Textarea, {
		id: getControlId(name2),
		maxLength,
		onChange: handleChange,
		disabled: readonly,
		...
		name: name2,
		value: isValid ? value3 : "",
		onFocus,
		onBlur
	}), maxLength && import_react.createElement(MaxLength, { isMaxed: value3?.length === maxLength }, value3?.length ?? 0, " / ", maxLength));
};
...
var FilesControl = ({ onChange, name: name2, accept = "image/*", value: value3, argType }) => {
	...
	function handleFileChange(e2) {
		...
		onChange(Array.from(e2.target.files).map((file) => URL.createObjectURL(file))), revokeOldUrls(value3);
	}
	return (0, import_react.useEffect)(() => {
		value3 == null && inputElement.current && (inputElement.current.value = null);
	}, [value3, name2]), import_react.createElement(FileInput, {
		ref: inputElement,
		id: getControlId(name2),
		type: "file",
		name: name2,
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-YHDXOIA2-cV1JDvp5.js")), ColorControl = (props) => import_react.createElement(import_react.Suspense, { fallback: import_react.createElement("div", null) }, import_react.createElement(LazyColorControl, { ...props }));
var Controls2 = {
	array: ObjectControl,
	...
	let { key: key2, control } = row, [isFocused, setFocused] = (0, import_react.useState)(!1), [boxedValue, setBoxedValue] = (0, import_react.useState)({ value: arg });
	(0, import_react.useEffect)(() => {
		isFocused || setBoxedValue({ value: arg });
	}, [isFocused, arg]);
	let onChange = (0, import_react.useCallback)((argVal) => (setBoxedValue({ value: argVal }), updateArgs({ [key2]: argVal }), argVal), [updateArgs, key2]), onBlur = (0, import_react.useCallback)(() => setFocused(!1), []), onFocus = (0, import_react.useCallback)(() => setFocused(!0), []);
	if (!control || control.disable) {
		let canBeSetup = control?.disable !== !0 && row?.type?.name !== "function";
		return isHovered && canBeSetup ? import_react.createElement(Ju, {
...
var import_memoizerific = __toESM$1(require_memoizerific()), ITEMS_BEFORE_EXPANSION = 8, Summary = vr.div(({ isExpanded }) => ({
	display: "flex",
	...
	marginBottom: "-4px",
	minWidth: 100
})), Text3 = vr.span(_t, ({ theme, simple = !1 }) => ({
	flex: "0 0 auto",
	fontFamily: theme.typography.fonts.mono,
	fontSize: theme.typography.size.s1,
...
})), ExpandButton = vr.button(({ theme }) => ({
	fontFamily: theme.typography.fonts.mono,
	color: theme.color.secondary,
	marginBottom: "4px",
	background: "none",
	border: "none"
})), Expandable = vr.div(_t, ({ theme }) => ({
	fontFamily: theme.typography.fonts.mono,
	color: theme.color.secondary,
	fontSize: theme.typography.size.s1,
	margin: 0,
...
})), ChevronUpIcon = vr(ChevronSmallUpIcon)({ marginLeft: 4 }), ChevronDownIcon = vr(ChevronSmallDownIcon)({ marginLeft: 4 }), EmptyArg = () => import_react.createElement("span", null, "-"), ArgText = ({ text, simple }) => import_react.createElement(Text3, { simple }, text), calculateDetailWidth = (0, import_memoizerific.default)(1e3)((detail) => {
	let lines = detail.split(/\r?\n/);
	return `${Math.max(...lines.map((x2) => x2.length))}ch`;
}), getSummaryItems = (summary) => {
	if (!summary) return [summary];
	return uniq(summary.split("|").map((value3) => value3.trim()));
}, renderSummaryItems = (summaryItems, isExpanded = !0) => {
	let items = summaryItems;
	return isExpanded || (items = summaryItems.slice(0, ITEMS_BEFORE_EXPANSION)), items.map((item) => import_react.createElement(ArgText, {
		key: item,
		text: item === "" ? "\"\"" : item
	}));
}, ArgSummary = ({ value: value3, initialExpandedArgs }) => {
	let { summary, detail } = value3, [isOpen, setIsOpen] = (0, import_react.useState)(!1), [isExpanded, setIsExpanded] = (0, import_react.useState)(initialExpandedArgs || !1);
	...
	if (detail == null) {
		...
		return itemsCount > ITEMS_BEFORE_EXPANSION ? import_react.createElement(Summary, { isExpanded }, renderSummaryItems(summaryItems, isExpanded), import_react.createElement(ExpandButton, { onClick: () => setIsExpanded(!isExpanded) }, isExpanded ? "Show less..." : `Show ${itemsCount - ITEMS_BEFORE_EXPANSION} more...`)) : import_react.createElement(Summary, null, renderSummaryItems(summaryItems));
	}
	return import_react.createElement(XM, {
		...
		tooltip: import_react.createElement(Detail, { width: calculateDetailWidth(detail) }, import_react.createElement(Zg, {
			language: "jsx",
			format: !1
		}, detail))
...
}, ArgValue = ({ value: value3, initialExpandedArgs }) => value3 == null ? import_react.createElement(EmptyArg, null) : import_react.createElement(ArgSummary, {
	value: value3,
	initialExpandedArgs
});
var Name = vr.span({ fontWeight: "bold" }), Required = vr.span(({ theme }) => ({
	color: theme.color.negative,
	fontFamily: theme.typography.fonts.mono,
	cursor: "help"
})), Description = vr.div(({ theme }) => ({
	"&&": {
		p: { margin: "0 0 10px 0" },
...
})), Type = vr.div(({ theme, hasDescription }) => ({
...
})), TypeWithJsDoc = vr.div(({ theme, hasDescription }) => ({
	color: theme.base === "light" ? curriedTransparentize$1(.1, theme.color.defaultText) : curriedTransparentize$1(.2, theme.color.defaultText),
	marginTop: hasDescription ? 12 : 0,
	marginBottom: 12
})), StyledTd = vr.td(({ theme, expandable }) => ({ paddingLeft: expandable ? "40px !important" : "20px !important" })), toSummary = (value3) => value3 && { summary: typeof value3 == "string" ? value3 : value3.name }, ArgRow = (props) => {
	let [isHovered, setIsHovered] = (0, import_react.useState)(!1), { row, updateArgs, compact, expandable, initialExpandedArgs } = props, { name: name2, description } = row, table = row.table || {}, type = table.type || toSummary(row.type), defaultValue = table.defaultValue || row.defaultValue, required = row.type?.required, hasDescription = description != null && description !== "";
	return import_react.createElement("tr", {
		onMouseEnter: () => setIsHovered(!0),
		onMouseLeave: () => setIsHovered(!1)
	}, import_react.createElement(StyledTd, { expandable }, import_react.createElement(Name, null, name2), required ? import_react.createElement(Required, { title: "Required" }, "*") : null), compact ? null : import_react.createElement("td", null, hasDescription && import_react.createElement(Description, null, import_react.createElement(index_modern_default, null, description)), table.jsDocTags != null ? import_react.createElement(import_react.Fragment, null, import_react.createElement(TypeWithJsDoc, { hasDescription }, import_react.createElement(ArgValue, {
		value: type,
		initialExpandedArgs
		...
		value: type,
		initialExpandedArgs
	}))), compact ? null : import_react.createElement("td", null, import_react.createElement(ArgValue, {
		value: defaultValue,
		initialExpandedArgs
...
var Wrapper8 = vr.div(({ inAddonPanel, theme }) => ({
	...
	return (0, import_react.useEffect)(() => {
	...
	}, []), isLoading ? null : import_react.createElement(Wrapper8, { inAddonPanel }, import_react.createElement(cp, {
		...
		footer: import_react.createElement(Links, null, inAddonPanel && import_react.createElement(import_react.Fragment, null, import_react.createElement(Ju, {
			href: "https://youtu.be/0gOfS6K0x0E",
			target: "_blank",
			withArrow: !0
		}, import_react.createElement(VideoIcon, null), " Watch 5m video"), import_react.createElement(Divider, null), import_react.createElement(Ju, {
			href: "https://storybook.js.org/docs/essentials/controls",
			target: "_blank",
			withArrow: !0
		}, import_react.createElement(DocumentIcon, null), " Read docs")), !inAddonPanel && import_react.createElement(Ju, {
			href: "https://storybook.js.org/docs/essentials/controls",
			target: "_blank",
			withArrow: !0
...
var ExpanderIconDown = vr(ChevronDownIcon$1)(({ theme }) => ({
	marginRight: 8,
	marginLeft: -10,
	marginTop: -2,
	height: 12,
	...
	border: "none",
	display: "inline-block"
})), ExpanderIconRight = vr(ChevronRightIcon)(({ theme }) => ({
	marginRight: 8,
	marginLeft: -10,
	marginTop: -2,
	height: 12,
...
var Row = vr.div(({ theme }) => ({
	display: "flex",
	gap: 16,
	borderBottom: `1px solid ${theme.appBorderColor}`,
	"&:last-child": { borderBottom: 0 }
})), Column = vr.div(({ numColumn }) => ({
	display: "flex",
	flexDirection: "column",
	flex: numColumn || 1,
	gap: 5,
	padding: "12px 20px"
})), SkeletonText = vr.div(({ theme, width, height }) => ({
	animation: `${theme.animation.glow} 1.5s ease-in-out infinite`,
	background: theme.appBorderColor,
	width: width || "100%",
	height: height || 16,
	...
	2,
	2
], Skeleton = () => import_react.createElement(import_react.Fragment, null, import_react.createElement(Row, null, import_react.createElement(Column, { numColumn: columnWidth[0] }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { numColumn: columnWidth[1] }, import_react.createElement(SkeletonText, { width: "30%" })), import_react.createElement(Column, { numColumn: columnWidth[2] }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { numColumn: columnWidth[3] }, import_react.createElement(SkeletonText, { width: "60%" }))), import_react.createElement(Row, null, import_react.createElement(Column, { numColumn: columnWidth[0] }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { numColumn: columnWidth[1] }, import_react.createElement(SkeletonText, { width: "80%" }), import_react.createElement(SkeletonText, { width: "30%" })), import_react.createElement(Column, { numColumn: columnWidth[2] }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { numColumn: columnWidth[3] }, import_react.createElement(SkeletonText, { width: "60%" }))), import_react.createElement(Row, null, import_react.createElement(Column, { numColumn: columnWidth[0] }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { numColumn: columnWidth[1] }, import_react.createElement(SkeletonText, { width: "80%" }), import_react.createElement(SkeletonText, { width: "30%" })), import_react.createElement(Column, { numColumn: columnWidth[2] }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { numColumn: columnWidth[3] }, import_react.createElement(SkeletonText, { width: "60%" }))), import_react.createElement(Row, null, import_react.createElement(Column, { numColumn: columnWidth[0] }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { numColumn: columnWidth[1] }, import_react.createElement(SkeletonText, { width: "80%" }), import_react.createElement(SkeletonText, { width: "30%" })), import_react.createElement(Column, { numColumn: columnWidth[2] }, import_react.createElement(SkeletonText, { width: "60%" })), import_react.createElement(Column, { numColumn: columnWidth[3] }, import_react.createElement(SkeletonText, { width: "60%" }))));
...
} })), StyledIconButton = vr(Vl)(({ theme }) => ({ margin: "-4px -12px -4px 0" })), ControlHeadingWrapper = vr.span({
	display: "flex",
...
var sortFns = {
	...
	if ("error" in props) {
		let { error } = props;
		return import_react.createElement(EmptyBlock, null, error, "\xA0", import_react.createElement(Ju, {
	...
	return import_react.createElement(Np, null, import_react.createElement(TableWrapper, {
		compact,
		inAddonPanel,
		className: "docblock-argstable sb-unstyled"
	}, import_react.createElement("thead", { className: "docblock-argstable-head" }, import_react.createElement("tr", null, import_react.createElement("th", null, import_react.createElement("span", null, "Name")), compact ? null : import_react.createElement("th", null, import_react.createElement("span", null, "Description")), compact ? null : import_react.createElement("th", null, import_react.createElement("span", null, "Default")), updateArgs ? import_react.createElement("th", null, import_react.createElement(ControlHeadingWrapper, null, "Control", " ", !isLoading && resetArgs && import_react.createElement(StyledIconButton, {
		onClick: () => resetArgs(),
		title: "Reset controls"
	}, import_react.createElement(UndoIcon, { "aria-hidden": !0 })))) : null)), import_react.createElement("tbody", { className: "docblock-argstable-body" }, groups.ungrouped.map((row) => import_react.createElement(ArgRow, {
		key: row.key,
		row,
...
var TabbedArgsTable = ({ tabs, ...props }) => {
	...
	return entries.length === 1 ? import_react.createElement(ArgsTable, {
		...entries[0][1],
		...props
	}) : import_react.createElement(fp, null, entries.map((entry, index) => {
		...
		return import_react.createElement(Component4, {
			...
			id,
			title: label
		}, ({ active }) => active ? import_react.createElement(ArgsTable, {
...
}), Wrapper9 = vr.div(N$1, ({ theme }) => ({
	...getBlockBackgroundStyle(theme),
	margin: "25px 0 40px",
	padding: "30px 20px"
})), Typeset = ({ fontFamily, fontSizes, fontWeight, sampleText, ...props }) => import_react.createElement(Wrapper9, {
	...props,
...
var ItemTitle = vr.div(({ theme }) => ({
	fontWeight: theme.typography.weight.bold,
	color: theme.color.defaultText
})), ItemSubtitle = vr.div(({ theme }) => ({ color: theme.base === "light" ? curriedTransparentize$1(.2, theme.color.defaultText) : curriedTransparentize$1(.6, theme.color.defaultText) })), ItemDescription = vr.div({
	flex: "0 0 30%",
	lineHeight: "20px",
	marginTop: 5
}), SwatchLabel = vr.div(({ theme }) => ({
	flex: 1,
	textAlign: "center",
	fontFamily: theme.typography.fonts.mono,
	fontSize: theme.typography.size.s1,
	...
	display: "flex",
	alignItems: "flex-start"
}), ListName = vr.div({ flex: "0 0 30%" }), ListSwatches = vr.div({ flex: 1 }), ListHeading = vr.div(({ theme }) => ({
	display: "flex",
	flexDirection: "row",
	alignItems: "center",
	paddingBottom: 20,
...
var ItemLabel = vr.div(({ theme }) => ({
	fontFamily: theme.typography.fonts.base,
	fontSize: theme.typography.size.s2,
	color: theme.color.defaultText,
	marginLeft: 10,
	lineHeight: 1.2
})), ItemSpecimen = vr.div(({ theme }) => ({
	...getBlockBackgroundStyle(theme),
	overflow: "hidden",
	height: 40,
	width: 40,
	...
	display: "flex",
	flexFlow: "row wrap"
}), IconItem = ({ name: name2, children }) => import_react.createElement(Item2, null, import_react.createElement(ItemSpecimen, null, children), import_react.createElement(ItemLabel, null, name2)), IconGallery = ({ children, ...props }) => import_react.createElement(Np, null, import_react.createElement(List2, {
	...props,
...
var ArgTypes = (props) => {
	...
	let mainComponentName = getComponentName(component), subcomponentTabs = Object.fromEntries(Object.entries(subcomponents).map(([key2, comp]) => [key2, {
...
function extractEventHiddenProperties(event) {
	let rebuildEvent = eventProperties.filter((value3) => event[value3] !== void 0).reduce((acc, value3) => ({
		...acc,
		[value3]: event[value3]
	}), {});
...
var import_memoizerific2 = __toESM$1(require_memoizerific(), 1), require_shams = __commonJS2({ "node_modules/has-symbols/shams.js"(exports, module) {
...
} }), require_has_symbols = __commonJS2({ "node_modules/has-symbols/index.js"(exports, module) {
	var origSymbol = typeof Symbol < "u" && Symbol, hasSymbolSham = require_shams();
	module.exports = function() {
		return typeof origSymbol != "function" || typeof Symbol != "function" || typeof origSymbol("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : hasSymbolSham();
	};
} }), require_implementation = __commonJS2({ "node_modules/function-bind/implementation.js"(exports, module) {
...
} }), require_function_bind = __commonJS2({ "node_modules/function-bind/index.js"(exports, module) {
	var implementation = require_implementation();
	module.exports = Function.prototype.bind || implementation;
} }), require_src = __commonJS2({ "node_modules/has/src/index.js"(exports, module) {
	module.exports = require_function_bind().call(Function.call, Object.prototype.hasOwnProperty);
} }), require_get_intrinsic = __commonJS2({ "node_modules/get-intrinsic/index.js"(exports, module) {
	...
	module.exports = function(name2, allowMissing) {
		...
		var parts = stringToPath2(name2), intrinsicBaseName = parts.length > 0 ? parts[0] : "", intrinsic = getBaseIntrinsic("%" + intrinsicBaseName + "%", allowMissing), intrinsicRealName = intrinsic.name, value22 = intrinsic.value, skipFurtherCaching = !1, alias = intrinsic.alias;
		...
		for (var i2 = 1, isOwn = !0; i2 < parts.length; i2 += 1) {
			...
			if ((part === "constructor" || !isOwn) && (skipFurtherCaching = !0), intrinsicBaseName += "." + part, intrinsicRealName = "%" + intrinsicBaseName + "%", hasOwn(INTRINSICS, intrinsicRealName)) value22 = INTRINSICS[intrinsicRealName];
...
} }), require_call_bind = __commonJS2({ "node_modules/call-bind/index.js"(exports, module) {
	...
	module.exports = function(originalFunction) {
		...
		if ($gOPD && $defineProperty) $gOPD(func, "length").configurable && $defineProperty(func, "length", { value: 1 + $max(0, originalFunction.length - (arguments.length - 1)) });
		return func;
	};
...
} }), require_callBound = __commonJS2({ "node_modules/call-bind/callBound.js"(exports, module) {
...
} }), require_shams2 = __commonJS2({ "node_modules/has-tostringtag/shams.js"(exports, module) {
	var hasSymbols = require_shams();
	module.exports = function() {
		return hasSymbols() && !!Symbol.toStringTag;
	};
} }), require_is_regex = __commonJS2({ "node_modules/is-regex/index.js"(exports, module) {
	...
	module.exports = hasToStringTag ? function(value22) {
		if (!value22 || typeof value22 != "object") return !1;
		...
		return !value22 || typeof value22 != "object" && typeof value22 != "function" ? !1 : $toString(value22) === regexClass;
	};
} }), require_is_function = __commonJS2({ "node_modules/is-function/index.js"(exports, module) {
...
} }), require_is_symbol = __commonJS2({ "node_modules/is-symbol/index.js"(exports, module) {
	var toStr = Object.prototype.toString;
	require_has_symbols()() ? (symToStr = Symbol.prototype.toString, symStringRegex = /^Symbol\(.*\)$/, isSymbolObject = function(value22) {
		return typeof value22.valueOf() != "symbol" ? !1 : symStringRegex.test(symToStr.call(value22));
	}, module.exports = function(value22) {
		if (typeof value22 == "symbol") return !0;
		if (toStr.call(value22) !== "[object Symbol]") return !1;
		try {
...
function baseIsNative(value22) {
	if (!isObject_default(value22) || isMasked_default(value22)) return !1;
	return (isFunction_default(value22) ? reIsNative : reIsHostCtor).test(toSource_default(value22));
}
...
var memoize_default = memoize3, MAX_MEMOIZE_SIZE = 500;
...
var isObject3 = isObject, removeCodeComments = (code) => {
	let inQuoteChar = null, inBlockComment = !1, inLineComment = !1, inRegexLiteral = !1, newCode = "";
	if (code.indexOf("//") >= 0 || code.indexOf("/*") >= 0) for (let i2 = 0; i2 < code.length; i2 += 1) !inQuoteChar && !inBlockComment && !inLineComment && !inRegexLiteral ? code[i2] === "\"" || code[i2] === "'" || code[i2] === "`" ? inQuoteChar = code[i2] : code[i2] === "/" && code[i2 + 1] === "*" ? inBlockComment = !0 : code[i2] === "/" && code[i2 + 1] === "/" ? inLineComment = !0 : code[i2] === "/" && code[i2 + 1] !== "/" && (inRegexLiteral = !0) : (inQuoteChar && (code[i2] === inQuoteChar && code[i2 - 1] !== "\\" || code[i2] === `
...
` && (inLineComment = !1)), !inBlockComment && !inLineComment && (newCode += code[i2]);
	else newCode = code;
	return newCode;
}, cleanCode = (0, import_memoizerific2.default)(1e4)((code) => removeCodeComments(code).replace(/\n\s*/g, "").trim()), convertShorthandMethods = function(key2, stringified) {
...
function convertUnconventionalData(data) {
	...
	let result2 = data, wasMutated = !1;
	return typeof Event < "u" && data instanceof Event && (result2 = extractEventHiddenProperties(result2), wasMutated = !0), result2 = Object.keys(result2).reduce((acc, key2) => {
		try {
...
var replacer = function(options2) {
	...
	return function(key2, value22) {
		try {
			if (key2 === "") return keys = [], objects = new Map([[value22, "[]"]]), map = /* @__PURE__ */ new Map(), stack = [], value22;
			...
			if (typeof value22 == "number") return value22 === -Infinity ? "_-Infinity_" : value22 === Infinity ? "_Infinity_" : Number.isNaN(value22) ? "_NaN_" : value22;
			...
			if ((0, import_is_function.default)(value22)) {
				...
				return stringified.match(/(\[native code\]|WEBPACK_IMPORTED_MODULE|__webpack_exports__|__webpack_require__)/) ? `_function_${name2}|${(() => {}).toString()}` : `_function_${name2}|${cleanCode(convertShorthandMethods(key2, stringified))}`;
			}
			...
			if (value22 instanceof Error && options2.allowError) return {
...
function argsHash(args2) {
	return stringify(args2, { allowFunction: !1 });
}
var SourceContext = (0, import_react.createContext)({ sources: {} }), UNKNOWN_ARGS_HASH = "--unknown--", SourceContainer = ({ children, channel }) => {
	...
	return (0, import_react.useEffect)(() => {
		let handleSnippetRendered = (idOrEvent, inputSource = null, inputFormat = !1) => {
			let { id, args: args2 = void 0, source: source2, format: format3 } = typeof idOrEvent == "string" ? {
				id: idOrEvent,
				source: inputSource,
				format: inputFormat
			} : idOrEvent, hash = args2 ? argsHash(args2) : UNKNOWN_ARGS_HASH;
			setSources((current) => ({
				...current,
				[id]: {
					...current[id],
...
var getStorySource = (storyId, args2, sourceContext) => {
	...
	return sourceMap?.[argsHash(args2)] || sourceMap?.["--unknown--"] || { code: "" };
	...
	let sourceParameters = story?.parameters?.docs?.source || {}, { code } = props, format3 = props.format ?? sourceParameters.format, language = props.language ?? sourceParameters.language ?? "jsx", dark = props.dark ?? sourceParameters.dark ?? !1;
	...
	return format3 = source2.format ?? story.parameters.docs?.source?.format ?? !1, {
		code: getSnippet({
...
var getStoryId2 = (props, context) => {
	...
	let context = (0, import_react.useContext)(DocsContext), story = useStory(getStoryId2(props, context), context);
...
var Controls3 = (props) => {
	...
	if (!(!!subcomponents && Object.keys(subcomponents).length > 0)) return Object.keys(filteredArgTypes).length > 0 || Object.keys(args2).length > 0 ? import_react.createElement(ArgsTable, {
		rows: filteredArgTypes,
		sort,
		args: args2,
		globals,
...
var { document: document2 } = globalThis, assertIsFn = (val) => {
	...
	if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g))) return import_react.createElement(Au, null, children);
...
var A2 = Xte.a, AnchorInPage = ({ hash, children }) => {
	...
	return import_react.createElement(Component4, { ...te$1(withoutAs, as) });
...
var tocbot = __toESM$1(require_js());
var Wrapper10 = vr.div(({ theme }) => ({
	width: "10rem",
	"@media (max-width: 768px)": { display: "none" }
})), Content = vr.div(({ theme }) => ({
	position: "fixed",
	bottom: 0,
	top: 0,
	width: "10rem",
	...
	textTransform: "uppercase",
	marginBottom: 10
})), OptionalTitle = ({ title }) => title === null ? null : typeof title == "string" ? import_react.createElement(Heading, null, title) : title, TableOfContents = ({ title, disable, headingSelector, contentsSelector, ignoreSelector, unsafeTocbotOptions, channel }) => ((0, import_react.useEffect)(() => {
	if (disable) return () => {};
	let configuration = {
	...
	headingSelector,
	unsafeTocbotOptions
]), import_react.createElement(import_react.Fragment, null, import_react.createElement(Wrapper10, null, disable ? null : import_react.createElement(Content, null, import_react.createElement(OptionalTitle, { title: title || null }), import_react.createElement("div", { className: "toc-wrapper" })))));
var { document: document3, window: globalWindow3 } = globalThis, DocsContainer = ({ context, theme, children }) => {
	...
	}), import_react.createElement(DocsContext.Provider, { value: context }, import_react.createElement(SourceContainer, { channel: context.channel }, import_react.createElement(Et, { theme: $u(theme) }, import_react.createElement(DocsPageWrapper, { toc: toc ? import_react.createElement(TableOfContents, {
...
var own = Object.hasOwnProperty, BananaSlug = class {
	...
	slug(value3, maintainCase) {
		let self2 = this, result2 = slug(value3, maintainCase === !0), originalSlug = result2;
...
var slugs = new BananaSlug(), Heading2 = ({ children, disableAnchor, ...props }) => {
	if (disableAnchor || typeof children != "string") return import_react.createElement(Tu, null, children);
...
var Subheading = ({ children, disableAnchor }) => {
	if (disableAnchor || typeof children != "string") return import_react.createElement(Iu, null, children);
	let tagID = slugs.slug(children.toLowerCase());
	return import_react.createElement(HeaderMdx, {
		as: "h3",
		id: tagID
...
var DocsStory = ({ of, expanded = !0, withToolbar: withToolbarProp = !1, __forceInitialArgs = !1, __primary = !1 }) => {
	let { story } = useOf(of || "story", ["story"]), withToolbar = story.parameters.docs?.canvas?.withToolbar ?? withToolbarProp;
	return import_react.createElement(Anchor, { storyId: story.id }, expanded && import_react.createElement(import_react.Fragment, null, import_react.createElement(Subheading, null, story.name), import_react.createElement(DescriptionContainer, { of })), import_react.createElement(Canvas, {
		of,
		withToolbar,
		story: {
			__forceInitialArgs,
...
var StyledHeading = vr(Heading2)(({ theme }) => ({
	fontSize: `${theme.typography.size.s2 - 1}px`,
	fontWeight: theme.typography.weight.bold,
	lineHeight: "16px",
	letterSpacing: "0.35em",
	...
	return filter && (stories = stories.filter((story) => filter(story, getStoryContext(story)))), stories.some((story) => story.tags?.includes("autodocs")) && (stories = stories.filter((story) => story.tags?.includes("autodocs") && !story.usesMount)), includePrimary || (stories = stories.slice(1)), !stories || stories.length === 0 ? null : import_react.createElement(import_react.Fragment, null, typeof title == "string" ? import_react.createElement(StyledHeading, null, title) : title, stories.map((story) => story && import_react.createElement(DocsStory, {
		key: story.id,
...
var DocsPage = () => {
	...
	return import_react.createElement(import_react.Fragment, null, import_react.createElement(Title2, null), import_react.createElement(Subtitle2, null), import_react.createElement(DescriptionContainer, { of: "meta" }), isSingleStory ? import_react.createElement(DescriptionContainer, { of: "story" }) : null, import_react.createElement(Primary, null), import_react.createElement(Controls3, null), isSingleStory ? null : import_react.createElement(Stories, null));
};
function Docs({ context, docsParameter }) {
	let Container = docsParameter.container || DocsContainer, Page = docsParameter.page || DocsPage;
	return import_react.createElement(Container, {
		context,
...
var preview, ExternalDocsContainer = ({ projectAnnotations, children }) => (preview || (preview = new ExternalPreview(projectAnnotations)), import_react.createElement(DocsContext.Provider, { value: preview.docsContext() }, import_react.createElement(Et, { theme: $u(_e$1.light) }, children)));
var Meta = ({ of }) => {
	let context = (0, import_react.useContext)(DocsContext);
...
var Unstyled = (props) => import_react.createElement("div", {
	...props,
	className: "sb-unstyled"
});
var Wrapper11 = ({ children }) => import_react.createElement("div", { style: { fontFamily: "sans-serif" } }, children);
var PRIMARY_STORY = "^";
//#endregion
