//#region node_modules/@storybook/addon-a11y/dist/matchers-7Z3WT2CE.mjs
...
var { stdout: stdoutColor, stderr: stderrColor } = browser_default, GENERATOR = Symbol("GENERATOR"), STYLER = Symbol("STYLER"), IS_EMPTY = Symbol("IS_EMPTY"), levelMapping = [
	...
	"ansi256",
	"ansi16m"
], styles2 = Object.create(null), applyOptions = (object, options = {}) => {
...
${indentationNext}`);
	...
	var getColorsHighlight = (options) => DEFAULT_THEME_KEYS.reduce((colors, key) => {
		...
		close: "",
		open: ""
	}, colors), Object.create(null)), getPrintFunctionName = (options) => {
...
//# sourceMappingURL=matchers-7Z3WT2CE-BWo4KKZt.js.map